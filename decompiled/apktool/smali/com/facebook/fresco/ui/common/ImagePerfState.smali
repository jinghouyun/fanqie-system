...
.method public final snapshot()Lcom/facebook/fresco/ui/common/ImagePerfData;
    ...
    .line 165
    iget v2, v0, Lcom/facebook/fresco/ui/common/ImagePerfState;->onScreenWidthPx:I
    ...
    .line 173
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getCallingClassNameOnVisible()Ljava/lang/String;

    move-result-object v33

    .line 174
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getRootContextNameOnVisible()Ljava/lang/String;

    move-result-object v34

    .line 175
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getContextChainArrayOnVisible()[Ljava/lang/String;

    move-result-object v35

    .line 176
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getContextChainExtrasOnVisible()Ljava/lang/String;

    move-result-object v36

    .line 177
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getContentIdOnVisible()Ljava/lang/String;

    move-result-object v37

    .line 178
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getSurfaceOnVisible()Ljava/lang/String;

    move-result-object v38

    .line 179
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getSubSurfaceOnVisible()Ljava/lang/String;

    move-result-object v39

    .line 180
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getMsSinceLastNavigationOnVisible()Ljava/lang/Long;

    move-result-object v40

    .line 181
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getStartupStatusOnVisible()Ljava/lang/String;

    move-result-object v41

    .line 182
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getIntermediateImageSetTimes()Ljava/util/List;

    move-result-object v42

    check-cast v42, Ljava/lang/Iterable;

    invoke-static/range {v42 .. v42}, Lkotlin/collections/CollectionsKt;->toList(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v42

    .line 183
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getNewIntermediateImageSetPointAvailable()Z

    move-result v43

    .line 184
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getErrorMessageOnFailure()Ljava/lang/String;

    move-result-object v44

    .line 185
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getErrorStacktraceStringOnFailure()Ljava/lang/String;

    move-result-object v45

    .line 186
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getErrorCodeOnFailure()Ljava/lang/Integer;

    move-result-object v46

    .line 187
    invoke-virtual {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;->getDensityDpiOnSuccess()Ljava/lang/Integer;
