...
.method private captureAnimation(Lio/dcloud/nineoldandroids/animation/Animator;I)Z
    ...
    .line 6
    :cond_0
    iget-boolean v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mAnimationCapture:Z
    ...
    .line 16
    :cond_2
    invoke-interface {v1}, Lio/dcloud/common/DHInterface/IFrameView;->obtainWebAppRootView()Lio/dcloud/common/DHInterface/IWebAppRootView;
    ...
    .line 17
    iget-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;
    ...
    iget-object v8, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;
    ...
    .line 19
    iput-object v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;
    ...
    iput-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;

    .line 26
    sget-object v8, Landroid/widget/ImageView$ScaleType;->FIT_XY:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {v0, v8}, Lio/dcloud/common/adapter/ui/DHImageView;->setScaleType(Landroid/widget/ImageView$ScaleType;)V
    ...
    const-string v8, "C\u9875\u9762\u662f\u5426\u542f\u7528\u622a\u56fe\u52a8\u753b\u65b9\u6848:"

    invoke-direct {v0, v8}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-boolean v8, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mAnimationCapture:Z

    if-eqz v8, :cond_6

    sget-boolean v8, Lio/dcloud/common/util/BaseInfo;->sAnimationCaptureC:Z
    ...
    iget-object v8, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mAnimOptions:Lio/dcloud/common/adapter/util/AnimOptions;

    iget-object v8, v8, Lio/dcloud/common/adapter/util/AnimOptions;->mAnimType:Ljava/lang/String;
    ...
    .line 34
    iget-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mNativeView:Lio/dcloud/common/DHInterface/INativeView;
    ...
    .line 37
    iput-object v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mNativeView:Lio/dcloud/common/DHInterface/INativeView;
    ...
    invoke-virtual {v0, v7}, Lio/dcloud/common/adapter/ui/DHImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    .line 40
    iget-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;

    iget-object v11, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mNativeView:Lio/dcloud/common/DHInterface/INativeView;

    invoke-virtual {v0, v1, v11}, Lio/dcloud/common/adapter/ui/DHImageView;->addNativeView(Lio/dcloud/common/DHInterface/IFrameView;Lio/dcloud/common/DHInterface/INativeView;)V
    ...
    .line 45
    iget-object v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mLoadingSnapshot:Landroid/graphics/Bitmap;
    ...
    .line 47
    :cond_9
    iget-object v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mSnapshot:Landroid/graphics/Bitmap;
    ...
    iget-boolean v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->isChildOfFrameView:Z
    ...
    iget v12, v12, Lio/dcloud/common/adapter/util/ViewRect;->height:I

    invoke-direct {v0, v2, v2, v7, v12}, Landroid/graphics/Rect;-><init>(IIII)V

    .line 52
    const-string v7, "ARGB"

    invoke-static {v3, v6, v6, v0, v7}, Lio/dcloud/common/adapter/util/PlatformUtil;->captureView(Landroid/view/View;ZZLandroid/graphics/Rect;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v8, v9}, Lio/dcloud/common/adapter/util/Logger;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 80
    sget v8, Lio/dcloud/common/util/BaseInfo;->sTimeoutCapture:I
    ...
    .line 82
    sget v8, Lio/dcloud/common/util/BaseInfo;->sTimeOutMax:I
    ...
    invoke-static {v7}, Lio/dcloud/common/adapter/util/PlatformUtil;->isWhiteBitmap(Landroid/graphics/Bitmap;)Z
    ...
    iget-boolean v8, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->isChildOfFrameView:Z
    ...
    iget v9, v9, Lio/dcloud/common/adapter/util/ViewRect;->top:I

    add-int/2addr v8, v9

    invoke-virtual {v1}, Lio/dcloud/common/adapter/ui/AdaFrameItem;->getParentFrameItem()Lio/dcloud/common/adapter/ui/AdaContainerFrameItem;
    ...
    iget-boolean v9, v9, Lio/dcloud/common/adapter/util/ViewRect;->isStatusbar:Z
    ...
    invoke-virtual {v8, v2, v9, v2, v2}, Landroid/view/View;->setPadding(IIII)V
    ...
    invoke-direct {v1, v4, v0, v7}, Lio/dcloud/common/adapter/ui/AdaFrameView;->addCaptureImageView(Landroid/view/ViewGroup;Lio/dcloud/common/adapter/ui/DHImageView;Landroid/graphics/Bitmap;)V
    ...
    iget-object v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mViewOptions:Lio/dcloud/common/adapter/util/ViewOptions;

    iget v7, v7, Lio/dcloud/common/adapter/util/ViewRect;->left:I

    int-to-float v7, v7

    invoke-static {v0, v7}, Lio/dcloud/nineoldandroids/view/ViewHelper;->setX(Landroid/view/View;F)V

    .line 106
    iget-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mViewOptions:Lio/dcloud/common/adapter/util/ViewOptions;

    iget v0, v0, Lio/dcloud/common/adapter/util/ViewRect;->top:I

    .line 107
    iget-boolean v7, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->isChildOfFrameView:Z
    ...
    iget-boolean v7, v7, Lio/dcloud/common/adapter/util/ViewRect;->isStatusbar:Z
    ...
    .line 110
    :cond_18
    iget-object v2, v1, Lio/dcloud/common/adapter/ui/AdaFrameView;->mPageCImageView:Lio/dcloud/common/adapter/ui/DHImageView;
    ...
    .line 112
    iget-object v0, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mAnimOptions:Lio/dcloud/common/adapter/util/AnimOptions;
    ...
    invoke-virtual {v5, v0}, Lio/dcloud/nineoldandroids/animation/Animator;->setTarget(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v0}, Lio/dcloud/nineoldandroids/animation/Animator;->addListener(Lio/dcloud/nineoldandroids/animation/Animator$AnimatorListener;)V

    .line 184
    invoke-virtual {v5}, Lio/dcloud/nineoldandroids/animation/Animator;->start()V
    ...
    .line 186
    new-instance v4, Lio/dcloud/common/adapter/ui/AdaFrameView$2;

    invoke-direct {v4, v1, v3, v2}, Lio/dcloud/common/adapter/ui/AdaFrameView$2;-><init>(Lio/dcloud/common/adapter/ui/AdaFrameView;Landroid/view/ViewGroup;I)V
    ...
    .line 249
    iget-object v2, v1, Lio/dcloud/common/adapter/ui/AdaFrameItem;->mAnimOptions:Lio/dcloud/common/adapter/util/AnimOptions;

    iget-object v2, v2, Lio/dcloud/common/adapter/util/AnimOptions;->mAnimator:Landroid/view/animation/Animation;
