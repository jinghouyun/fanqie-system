...
.method public static getCurrentLocal(Landroid/content/Context;Z)Ljava/util/Locale;
    ...
    invoke-static {v0}, Lcom/taobao/weex/WXSDKInstance$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    invoke-static {p1}, Lcom/taobao/weex/WXSDKInstance$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    .line 7
    invoke-static {v0, p0}, Landroidx/core/graphics/ColorKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;I)Ljava/util/Locale;
...
.method public static updateSystemLanguage(Landroid/content/Context;)V
    ...
    .line 19
    :cond_4
    invoke-static {}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m$3()V
    ...
    invoke-static {v3}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m([Ljava/util/Locale;)Landroid/os/LocaleList;

    move-result-object v0

    .line 20
    invoke-static {v0}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;)V

    .line 21
    invoke-static {v2, v0}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
...
.method public static wrapContextConfigurationAfterO(Landroid/content/Context;Ljava/lang/String;Z)Landroid/content/Context;
    ...
    .line 9
    invoke-static {p1}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;)V

    .line 10
    invoke-static {v2, p1}, Lio/dcloud/p/g4$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
