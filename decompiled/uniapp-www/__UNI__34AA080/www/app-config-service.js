...
(function() {
  ...
  const __uniRoutes = [{
    ...
    "path": "pages/duoduosou/duoduosou",
    "meta": {
      "navigationBar": {
        "titleText": "多多盘",
        "style": "custom",
  ...
  }].map(uniRoute => (uniRoute.meta.route = uniRoute.path, __uniConfig.pages.push(uniRoute.path), uniRoute.path =
    '/' + uniRoute.path, uniRoute));
