...
(() => {
  ...
  var S = (e, a, s, o) => {
    if (a && typeof a == "object" || typeof a == "function")
      for (let l of D(a)) !v.call(e, l) && l !== s && g(e, l, {
        get: () => a[l],
        enumerable: !(o = _(a, l)) || o.enumerable
      });
    return e
  };
  var B = (e, a, s) => (s = e != null ? E(w(e)) : {}, S(a || !e || !e.__esModule ? g(s, "default", {
    value: e,
    enumerable: !0
  }) : s, e));
  var b = y((N, m) => {
      ...
      methods: {
        initLocale() {
          ...
          let a = {
            ...
            o = s[1];
          o && (s[1] = a[o] || o), s.length = s.length > 2 ? 2 : s.length, this.locale = s.join("-")
        },
        localize(e) {
          let a = this.locale,
            s = a.split("-")[0],
    ...
    p = {
      ...
      methods: {
        initMessage() {
          ...
          this.__from = e, this.__runtime = s, this.__page = plus.webview.currentWebview().id, this.__useGlobalEvent =
            l, this.data = JSON.parse(JSON.stringify(o)), plus.key.addEventListener("backbutton", () => {
        ...
        postMessage(e = {}, a = !1) {
          let s = JSON.parse(JSON.stringify({
            ...
            o = this.__from;
          if (this.__runtime === "v8") this.__useGlobalEvent ? plus.webview.postMessageToUniNView(s, o) :
  ...
  var k = {
    ...
    A = {
      ...
      barCode: [t.EAN13, t.EAN8, t.UPCA, t.UPCE, t.CODABAR, t.CODE128, t.CODE39, t.CODE93, t.ITF, t.RSS14, t
        .RSSEXPANDED
      ],
    ...
    M = {
      ...
      onLoad() {
        ...
        let s = [];
        Array.isArray(a) && a.length && a.forEach(o => {
            let l = A[o];
            l && (s = s.concat(l))
          }), s.length || (s = s.concat(A.qrCode).concat(A.barCode).concat(A.datamatrix).concat(A.pdf417)), this
          .filters = s, this.onMessage(o => {
            this.gallery()
          })
      },
      onUnload() {
      ...
      methods: {
        ...
        scan(e) {
          ...
          }, this.filters, this.autoDecodeCharSet)
        },
        cancel() {
        ...
        gallery() {
          plus.gallery.pick(e => {
            ...
            e.code !== (weex.config.env.platform.toLowerCase() === "android" ? 12 : -2) && plus.nativeUI.toast(
              this.localize("fail"))
          }, {
            multiple: !1,
            system: !1,
  ...
  function I(e, a, s, o, l, n) {
    return (0, i.openBlock)(), (0, i.createElementBlock)("scroll-view", {
      ...
      class: "content"
    }, [(0, i.createElementVNode)("barcode", {
      class: "barcode",
      ref: "barcode",
      autostart: "false",
    ...
    }, null, 40, ["backgroud", "frameColor", "scanbarColor", "filters", "autoDecodeCharset", "autoZoom"]), (
      0, i.createElementVNode)("view", {
      class: "set-flash",
      ...
      resize: "stretch"
    }, null, 8, ["src"]), (0, i.createElementVNode)("u-text", {
      class: "image-flash-text"
    }, (0, i.toDisplayString)(e.enabledFlash ? e.localize("flash.off") : e.localize("flash.on")), 1)])])])
  }
  var h = C(M, [
    ["render", I],
    ["styles", [k]]
  ...
  if (u) {
    ...
    o.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...h.styles || []])), o.mount("#root")
  }
})();