...
(() => {
  ...
  var L = (e, t, a, i) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let r of x(t)) !I.call(e, r) && r !== a && b(e, r, {
        get: () => t[r],
        enumerable: !(i = C(t, r)) || i.enumerable
      });
    return e
  };
  var N = (e, t, a) => (a = e != null ? D(M(e)) : {}, L(t || !e || !e.__esModule ? b(a, "default", {
    value: e,
    enumerable: !0
  }) : a, e));
  var A = V((U, v) => {
    ...
    k = {
      ...
      methods: {
        initMessage() {
          ...
          this.__from = e, this.__runtime = a, this.__page = plus.webview.currentWebview().id, this.__useGlobalEvent =
            r, this.data = JSON.parse(JSON.stringify(i)), plus.key.addEventListener("backbutton", () => {
  ...
  function w({
    ...
    return t === "time" ? d(e.getHours()) + ":" + d(e.getMinutes()) : e.getFullYear() + "-" + d(e.getMonth() + 1) +
      "-" + d(e.getDate())
  }
  var O = {
      data() {
  ...
  var T = weex.requireModule("animation"),
    ...
    R = {
      ...
      computed: {
        ...
        textMaxLength() {
          return Math.floor(Math.min(weex.config.env.deviceWidth, weex.config.env.deviceHeight) / (this.fontSize *
            weex.config.env.scale + 1) / this.rangeArray.length)
        },
        maskStyle() {
          return {
      ...
      watch: {
        ...
        valueArray(e) {
          ...
          e.forEach((t, a) => {
            t !== this.oldValueArray[a] && (this.oldValueArray[a] = t, this.mode === l.MULTISELECTOR && this
              .$emit("columnchange", {
                column: a,
                value: t
              }))
        ...
        visible(e) {
          ...
          }, 20) : T.transition(this.$refs.picker, {
            styles: {
          ...
          return e.map(i => {
            ...
            if (a > 0 && r.length > a) {
              ...
              for (let o = 0; o < r.length; o++) {
                ...
                if (u > 127 || u === 94 ? n += 1 : n += .65, n <= a - 1 && (c = o), n >= a) return o === r
                  .length - 1 ? r : r.substr(0, c + 1) + "\u2026"
              }
            }
            return r || " "
          }).join(`
`)
        ...
        _l10nItem(e, t) {
          if (this.mode === l.DATE) {
            ...
            if (this.fields !== h.YEAR && t === (this.fields !== h.MONTH && (a === "es" || a === "fr") ? 1 : 0)) {
              let i;
              switch (a) {
                case "es":
                  i = ["enero", "febrero", "marzo", "abril", "mayo", "junio", "\u200B\u200Bjulio", "agosto",
                    "septiembre", "octubre", "noviembre", "diciembre"
                  ];
                  break;
                case "fr":
                  i = ["janvier", "f\xE9vrier", "mars", "avril", "mai", "juin", "juillet", "ao\xFBt", "septembre",
  ...
  function B(e, t, a, i, r, n) {
    ...
    return (0, s.openBlock)(), (0, s.createElementBlock)("div", {
      class: (0, s.normalizeClass)(["content", {
        dark: e.isDark
      }])
    ...
    }, (0, s.toDisplayString)(e.localize("done")), 5)], 2), a.visible ? ((0, s.openBlock)(), (0, s
      .createBlock)(o, {
      key: 0,
      ...
      default: (0, s.withCtx)(() => [((0, s.openBlock)(!0), (0, s.createElementBlock)(s.Fragment, null,
        (0, s.renderList)(n._l10nColumn(n.rangeArray), (u, y) => ((0, s.openBlock)(), (0, s
          .createBlock)(c, {
          length: u.length,
          key: y
        }, {
          default: (0, s.withCtx)(() => [(0, s.createCommentVNode)(
              " iOS\u6E32\u67D3\u901F\u5EA6\u6709\u95EE\u9898\u4F7F\u7528\u5355\u4E2Atext\u4F18\u5316 "
            ), (0, s.createElementVNode)("u-text", {
              class: "uni-picker-item",
              style: (0, s.normalizeStyle)(n.pickerViewColumnTextStyle)
            }, (0, s.toDisplayString)(n.getTexts(u, y)), 5), (0, s.createCommentVNode)
            (
      ...
      _: 1
    }, 8, ["style", "indicator-style", "mask-top-style", "mask-bottom-style", "value", "onChange"])) : (0, s
      .createCommentVNode)("v-if", !0)], 6)], 2)
  }
  var j = m(R, [
      ["render", B],
      ["styles", [Y]]
    ...
    H = {
      ...
      methods: {
        showPicker(e = {}) {
          let t = e.column;
          for (let a in e) a !== "column" && (typeof t == "number" ? this.$set(this.$data[a], t, e[a]) : this.$data[
            a] = e[a])
        },
        close(e, {
          value: t = -1
  ...
  function J(e, t, a, i, r, n) {
    ...
    return (0, s.openBlock)(), (0, s.createElementBlock)("scroll-view", {
      scrollY: !0,
      showScrollbar: !0,
      enableBackToTop: !0,
      bubble: "true",
    ...
    }, null, 8, ["range", "rangeKey", "value", "mode", "fields", "start", "end", "disabled", "visible",
      "onColumnchange"
    ])])])
  }
  var f = m(H, [
  ...
  if (p) {
    ...
    i.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...f.styles || []])), i.mount("#root")
  }
})();