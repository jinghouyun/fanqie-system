    ...
    class b implements Runnable {
        ...
        public void run() {
            ...
            if (DCloudBaseActivity.this.mDebugDialog == null) {
                DCloudBaseActivity.this.mDebugDialog = new AlertDialog.Builder(DCloudBaseActivity.this).setTitle("").setMessage(this.a).setPositiveButton(R.string.dcloud_debug_reconnection_service, new DialogInterfaceOnClickListenerC0076b()).setNegativeButton(R.string.dcloud_common_cancel, new a()).setCancelable(false).show();
            } else {
