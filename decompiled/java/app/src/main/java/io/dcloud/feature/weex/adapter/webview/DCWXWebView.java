    ...
    private class DCWXChromeClient extends WebChromeClient {
        ...
        public void onResult(int i, int i2, Intent intent) {
            ...
            if (fileChooseDialog2 != null) {
                ...
                if (i2 != 0) {
                    if (i != 1) {
                        if (i == 2 && (fileChooseDialog = this.dialog) != null && (list = fileChooseDialog.uris) != null) {
                            ...
                            while (true) {
                                ...
                                File next = it.next();
                                if (next.exists()) {
                                    uriForFile = FileProvider.getUriForFile(DCWXWebView.this.mContext, DCWXWebView.this.mContext.getPackageName() + ".dc.fileprovider", next);
                                    break;
                                }
                            }
                        } else {
