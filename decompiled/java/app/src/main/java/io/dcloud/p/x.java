...
public class x extends z4 implements y {
    private int v;
    private int w;
    ...
    @Override // io.dcloud.p.z4, io.dcloud.p.u1
    public int a() {
        return super.a();
    }
    ...
    protected void r() {
        if (g() || this.p) {
            ...
            m.a(arrayList);
            c3.a("level load success,total ads:" + arrayList.size());
