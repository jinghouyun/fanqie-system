...
public class PermissionUtil implements IReflectAble {
    ...
    public static int checkSelfPermission(Activity activity, String str, String str2) {
        ...
        return (!caseVersion(activity) || str == null) ? trycatchGetPermission(activity, str, str2) : ActivityCompat.checkSelfPermission(activity, str);
    }
    ...
    public static String convert2SystemPermission(String str) {
        ...
        if (PMS_STORAGE_IMAGE.equalsIgnoreCase(str)) {
            return Build.VERSION.SDK_INT < 33 ? Permission.WRITE_EXTERNAL_STORAGE : Permission.READ_MEDIA_IMAGES;
        }
        ...
        return "SHORTCUT".equalsIgnoreCase(str) ? "android.permission.INSTALL_SHORTCUT" : str;
    }
    ...
    private static void showStreamAppPermissionDialog(final ShowDialogData showDialogData) {
        ...
        if (continueShowStreamAppPermissionDialog(showDialogData)) {
            ...
            DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: io.dcloud.common.adapter.util.PermissionUtil.4
                ...
                public void onClick(DialogInterface dialogInterface, int i3) {
                    ...
                    if (i3 == -1) {
                        ...
                        PermissionUtil.putStreamAppPermission(activity, str, str3, !(checkBox3 == null ? 1 : checkBox3.isChecked()));
                        request.onGranted(str3);
                    } else if (i3 == -2) {
            ...
            dCloudAlertDialogInitDialogTheme.setButton(i, string, onClickListener);
