...
public abstract class y3 {
    ...
    protected void a(int i, final String str, String str2, String str3, JSONArray jSONArray, long j) {
        ...
        if (b()) {
            ...
            x4.a().a(new Runnable() { // from class: io.dcloud.p.y3$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void a(String str, HashMap map) {
        c0.a(a(), r0.d().b().getAppId(), r0.d().b().getAdId(), 60, str, map);
    }

    private void a(final Context context, final int i, final DCBaseAOL dCBaseAOL, final String str, final String str2, final String str3, final String str4) {
        if (i == 40) {
        ...
        x4.a().a(new Runnable() { // from class: io.dcloud.p.y3$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                y3.a(context, dCBaseAOL, i, map, str, str2, str3, str4);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void a(Context context, DCBaseAOL dCBaseAOL, int i, HashMap map, String str, String str2, String str3, String str4) {
    ...
    protected void a(final Activity activity, final DCBaseAOL dCBaseAOL, long j, final String str, final int i) {
        if (dCBaseAOL != null && Const.TYPE_GG.equals(dCBaseAOL.getType())) {
            ...
            c3.a("on ad paid");
            x4.a().a(new Runnable() { // from class: io.dcloud.p.y3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    y3.a(activity, dCBaseAOL, f, str, i);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void a(Activity activity, DCBaseAOL dCBaseAOL, float f, String str, int i) {
