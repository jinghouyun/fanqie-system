...
public class PropertyValuesHolder implements Cloneable {
    ...
    void setupSetterAndGetter(Object obj) {
        ...
        for (Keyframe keyframe2 : this.mKeyframeSet.mKeyframes) {
            if (!keyframe2.hasValue()) {
                ...
                try {
                    keyframe2.setValue(this.mGetter.invoke(obj, null));
    ...
    public PropertyValuesHolder m432clone() {
        try {
            PropertyValuesHolder propertyValuesHolder = (PropertyValuesHolder) super.clone();
            propertyValuesHolder.mPropertyName = this.mPropertyName;
            propertyValuesHolder.mProperty = this.mProperty;
            propertyValuesHolder.mKeyframeSet = this.mKeyframeSet.m431clone();
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public IntPropertyValuesHolder m432clone() {
            IntPropertyValuesHolder intPropertyValuesHolder = (IntPropertyValuesHolder) super.m432clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // io.dcloud.nineoldandroids.animation.PropertyValuesHolder
        /* JADX INFO: renamed from: clone */
        public FloatPropertyValuesHolder m432clone() {
            FloatPropertyValuesHolder floatPropertyValuesHolder = (FloatPropertyValuesHolder) super.m432clone();
