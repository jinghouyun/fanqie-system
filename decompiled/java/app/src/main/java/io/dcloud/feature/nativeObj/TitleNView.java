...
public class TitleNView extends NativeView implements ITitleNView {
    ...
    private View createButton(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, IWebview iWebview, String str9, String str10, boolean z, String str11, boolean z2, String str12, String str13) {
        ...
        int iConvertToScreenInt2 = PdrUtil.convertToScreenInt(str14, this.mInnerWidth, 0, this.mCreateScale);
    ...
    private void initTitleNViewLayout() {
        ...
        if (this.mTitleNViewLayout == null) {
            ...
            if (TextUtils.equals(this.mStyle.optString("position", AbsoluteConst.JSON_VALUE_POSITION_ABSOLUTE), AbsoluteConst.JSON_VALUE_POSITION_ABSOLUTE) || parent == null || !(parent instanceof ViewGroup)) {
                iFrameView = this.mFrameViewParent;
    ...
    public void addLeftButton(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, IWebview iWebview, String str11, String str12, boolean z, String str13, boolean z2, String str14) {
        int iConvertToScreenInt;
        View viewCreateButton = createButton(str, str3, str4, str5, str6, str7, str8, str10, iWebview, str11, str12, z, str13, z2, str14, str9);
        initTitleNViewLayout();
        initLeftButtonLayout();
        if (-1 == this.mLeftButtonLayout.indexOfChild(viewCreateButton)) {
            int iConvertToScreenInt2 = this.mInnerHeight - PdrUtil.convertToScreenInt("12px", this.mAppScreenWidth, 0, this.mCreateScale);
            int iConvertToScreenInt3 = PdrUtil.convertToScreenInt(str14, this.mAppScreenWidth, -1, this.mCreateScale);
            int iConvertToScreenInt4 = PdrUtil.convertToScreenInt(str9, this.mAppScreenWidth, -1, this.mCreateScale);
            String str15 = "5px";
            if (iConvertToScreenInt3 > 0 && iConvertToScreenInt4 > iConvertToScreenInt3) {
                iConvertToScreenInt = -2;
            } else if (PdrUtil.isEmpty(str9)) {
                iConvertToScreenInt = iConvertToScreenInt2;
            } else if (str9.equals("auto")) {
                iConvertToScreenInt = -2;
            } else {
                iConvertToScreenInt = PdrUtil.convertToScreenInt(str9, this.mAppScreenWidth, iConvertToScreenInt2, this.mCreateScale);
                str15 = "0px";
            }
            int iConvertToScreenInt5 = PdrUtil.convertToScreenInt(str15, this.mAppScreenWidth, 0, this.mCreateScale);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(iConvertToScreenInt, iConvertToScreenInt2);
            layoutParams.leftMargin = iConvertToScreenInt5;
            this.mLeftButtonLayout.addView(viewCreateButton, layoutParams);
            if (!PdrUtil.isEmpty(str9) && str9.equals("auto") && z2) {
                viewCreateButton.setPadding(iConvertToScreenInt5, viewCreateButton.getPaddingTop(), iConvertToScreenInt5, viewCreateButton.getPaddingBottom());
            }
        }
        caculateTitleMargin();
    }
    ...
    public void addRightButton(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, IWebview iWebview, String str11, String str12, boolean z, String str13, boolean z2, String str14) {
        ...
        View viewCreateButton = createButton(str, str3, str4, str5, str6, str7, str8, str10, iWebview, str11, str12, z, str13, z2, str14, str9);
        if (-1 == this.mRightButtonLayout.indexOfChild(viewCreateButton)) {
            int iConvertToScreenInt2 = this.mInnerHeight - PdrUtil.convertToScreenInt("12px", this.mAppScreenWidth, 0, this.mCreateScale);
            int iConvertToScreenInt3 = PdrUtil.convertToScreenInt(str14, this.mAppScreenWidth, -1, this.mCreateScale);
            int iConvertToScreenInt4 = PdrUtil.convertToScreenInt(str9, this.mAppScreenWidth, -1, this.mCreateScale);
            String str15 = "5px";
            ...
            int iConvertToScreenInt5 = PdrUtil.convertToScreenInt(str15, this.mAppScreenWidth, 0, this.mCreateScale);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(iConvertToScreenInt, iConvertToScreenInt2);
            layoutParams.rightMargin = iConvertToScreenInt5;
            this.mRightButtonLayout.addView(viewCreateButton, 0, layoutParams);
            if (!PdrUtil.isEmpty(str9) && str9.equals("auto") && z2) {
                viewCreateButton.setPadding(iConvertToScreenInt5, viewCreateButton.getPaddingTop(), iConvertToScreenInt5, viewCreateButton.getPaddingBottom());
            }
        }
        ...
        if (obj instanceof View) {
            ...
            if (viewGroup.getChildCount() >= 1) {
                ...
                if (PdrUtil.isEmpty(str3) || PdrUtil.isEmpty(str4)) {
                    ...
                    try {
                        iStringToColor3 = Color.parseColor(str3);
                    } catch (Exception unused) {
                        iStringToColor3 = PdrUtil.stringToColor(str3);
                    }
                    try {
                        iStringToColor = Color.parseColor(str4);
                    } catch (Exception unused2) {
                    ...
                    textView.setTextColor(createColorStateList(iStringToColor3, iStringToColor));
                    i2 = iStringToColor3;
                }
                if (!PdrUtil.isEmpty(str5)) {
                ...
                if (!PdrUtil.isEmpty(str10) && str15.equals("transparent")) {
                    try {
                        iStringToColor2 = Color.parseColor(str10);
                    } catch (Exception unused3) {
                        iStringToColor2 = PdrUtil.stringToColor(str10);
                    }
                    ...
                    if (z) {
                        NativeViewBackButtonDrawable nativeViewBackButtonDrawable = (NativeViewBackButtonDrawable) background;
                        if (iStringToColor2 != nativeViewBackButtonDrawable.getDrawableColor()) {
                            nativeViewBackButtonDrawable.setDrawableColor(iStringToColor2);
                        }
                    }
                }
                ...
                if (viewGroup.getChildCount() >= 2 && !PdrUtil.isEmpty(str13)) {
                    ...
                    TextView textViewAddSelect = addSelect(viewGroup, textView, 0);
                    if (-1 != i2 && -1 != i3) {
                        i3 = iStringToColor;
                        textViewAddSelect.setTextColor(createColorStateList(i2, i3));
                    }
                }
                if (str9 != null) {
                ...
                if (PdrUtil.isEmpty(str14) || !str14.equals("auto") || PdrUtil.isEmpty(str13) || !Boolean.parseBoolean(str13)) {
                    ...
                    int iConvertToScreenInt = PdrUtil.convertToScreenInt("5px", this.mAppScreenWidth, 0, this.mCreateScale);
                    viewGroup.setPadding(iConvertToScreenInt, textView.getPaddingTop(), iConvertToScreenInt, textView.getPaddingBottom());
                }
                if (!PdrUtil.isEmpty(str16) || !PdrUtil.isEmpty(str14)) {
                    int iConvertToScreenInt2 = PdrUtil.convertToScreenInt(str16, this.mAppScreenWidth, 0, this.mCreateScale);
                    int iConvertToScreenInt3 = PdrUtil.convertToScreenInt(PdrUtil.isEmpty(str14) ? str17 : str14, this.mAppScreenWidth, 0, this.mCreateScale);
                    if (iConvertToScreenInt2 > 0) {
                        textView.setEllipsize(TextUtils.TruncateAt.END);
                        textView.setMaxWidth(iConvertToScreenInt2);
                    }
                    ViewGroup.LayoutParams layoutParams = viewGroup.getLayoutParams();
                    int iConvertToScreenInt4 = layoutParams.width;
                    if (iConvertToScreenInt2 > 0 && iConvertToScreenInt3 > iConvertToScreenInt2) {
                        iConvertToScreenInt4 = -2;
                    } else if (!PdrUtil.isEmpty(str14)) {
                        if (str14.equals("auto")) {
                            iConvertToScreenInt4 = -2;
                        } else {
                            iConvertToScreenInt4 = PdrUtil.convertToScreenInt(str14, this.mAppScreenWidth, layoutParams.height, this.mCreateScale);
                        }
                    }
                    layoutParams.width = iConvertToScreenInt4;
    ...
    private class BadgeLinearLayout extends LinearLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.isDrawRedDot && PdrUtil.isEmpty(this.badgeStr)) {
                ...
                canvas.drawCircle(f - f2, rect.top + f2, f2, this.redDotPaint);
            }
        }
    ...
    private class BadgeRelateiveLayout extends LinearLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.badgeStr.length() > 0) {
                ...
                float fAbs = (this.canvasRect.right - Math.abs(rect2.width())) - this.circle8PX;
                Rect rect3 = this.canvasRect;
                int i = rect3.top;
                RectF rectF = new RectF(fAbs, i, rect3.right, i + Math.abs(rect2.height()) + this.circle4PX);
