...
/* JADX INFO: compiled from: Number.kt */
...
public final class NumberKt {
    ...
    public static final boolean numberEqualsImpl(Number a, Number b) {
        ...
        if (z) {
            if (z8) {
                return ((float) a.doubleValue()) == b.floatValue();
            }
            return a.doubleValue() == b.doubleValue();
        }
        if (z7) {
            if (z2) {
                return a.floatValue() == ((float) b.doubleValue());
            }
            return a.floatValue() == b.floatValue();
        }
        if (z5) {
    ...
    public static final Number parseIntInternal(String string, Number number) {
        ...
        double d = 0.0d;
        for (IndexedValue<Character> indexedValue : StringsKt.withIndex(strSubstring$default)) {
            int iIndexOf$default = StringsKt.indexOf$default((CharSequence) strSubstring2, indexedValue.getValue().charValue(), 0, false, 6, (java.lang.Object) null);
            ...
            d = (d * ((double) iIntValue)) + ((double) iIndexOf$default);
        }
        if (d < 2.147483647E9d) {
    ...
    public static final int compareTo(Number number, Number other) {
        ...
        if (number instanceof Byte) {
            ...
            if (other instanceof Integer) {
                return Intrinsics.compare((int) bByteValue, other.intValue());
            }
            if (other instanceof Byte) {
                return Intrinsics.compare((int) bByteValue, (int) other.byteValue());
            }
            if (other instanceof Short) {
                return Intrinsics.compare((int) bByteValue, (int) other.shortValue());
            }
            if (other instanceof Long) {
                return Intrinsics.compare(bByteValue, other.longValue());
            }
            return other instanceof Float ? Float.compare(bByteValue, other.floatValue()) : Double.compare(bByteValue, other.doubleValue());
        }
        if (number instanceof Short) {
            short sShortValue = number.shortValue();
            if (other instanceof Integer) {
                return Intrinsics.compare((int) sShortValue, other.intValue());
            }
            if (other instanceof Byte) {
                return Intrinsics.compare((int) sShortValue, (int) other.byteValue());
            }
            if (other instanceof Short) {
                return Intrinsics.compare((int) sShortValue, (int) other.shortValue());
            }
            if (other instanceof Long) {
                return Intrinsics.compare(sShortValue, other.longValue());
            }
            return other instanceof Float ? Float.compare(sShortValue, other.floatValue()) : Double.compare(sShortValue, other.doubleValue());
        }
        if (number instanceof Integer) {
            int iIntValue = number.intValue();
            if (other instanceof Integer) {
                return Intrinsics.compare(iIntValue, other.intValue());
            }
            if (other instanceof Byte) {
                return Intrinsics.compare(iIntValue, (int) other.byteValue());
            }
            if (other instanceof Short) {
                return Intrinsics.compare(iIntValue, (int) other.shortValue());
            }
            if (other instanceof Long) {
                return Intrinsics.compare(iIntValue, other.longValue());
            }
            return other instanceof Float ? Float.compare(iIntValue, other.floatValue()) : Double.compare(iIntValue, other.doubleValue());
        }
        if (number instanceof Long) {
            long jLongValue = number.longValue();
            if (other instanceof Integer) {
                return Intrinsics.compare(jLongValue, other.intValue());
            }
            if (other instanceof Byte) {
                return Intrinsics.compare(jLongValue, other.byteValue());
            }
            if (other instanceof Short) {
                return Intrinsics.compare(jLongValue, other.shortValue());
            }
            if (other instanceof Long) {
                return Intrinsics.compare(jLongValue, other.longValue());
            }
            return other instanceof Float ? Float.compare(jLongValue, other.floatValue()) : Double.compare(jLongValue, other.doubleValue());
        }
        if (number instanceof Float) {
            float fFloatValue = number.floatValue();
            if (other instanceof Integer) {
                return Float.compare(fFloatValue, other.intValue());
            }
            if (other instanceof Byte) {
                return Float.compare(fFloatValue, other.byteValue());
            }
            if (other instanceof Short) {
                return Float.compare(fFloatValue, other.shortValue());
            }
            if (other instanceof Long) {
                return Float.compare(fFloatValue, other.longValue());
            }
            return other instanceof Float ? Float.compare(fFloatValue, other.floatValue()) : Double.compare(fFloatValue, other.doubleValue());
        }
        double dDoubleValue = number.doubleValue();
        if (other instanceof Integer) {
            return Double.compare(dDoubleValue, other.intValue());
        }
        if (other instanceof Byte) {
            return Double.compare(dDoubleValue, other.byteValue());
        }
        if (other instanceof Short) {
            return Double.compare(dDoubleValue, other.shortValue());
        }
        if (other instanceof Long) {
            return Double.compare(dDoubleValue, other.longValue());
        }
        return other instanceof Float ? Double.compare(dDoubleValue, other.floatValue()) : Double.compare(dDoubleValue, other.doubleValue());
    }
        ...
        if ((number instanceof Byte) || (number instanceof Short) || (number instanceof Integer)) {
            ...
            if ((other instanceof Integer) || (other instanceof Byte) || (other instanceof Short)) {
                try {
                    ...
                    return Long.valueOf(((long) iIntValue) + other.longValue());
                }
            }
            if (other instanceof Long) {
                try {
                    return Long.valueOf(UByte$$ExternalSyntheticBackport0.m595m(iIntValue, other.longValue()));
                } catch (ArithmeticException unused2) {
                    return Double.valueOf(((double) iIntValue) + other.longValue());
                }
            }
            numberValueOf = other instanceof Float ? Float.valueOf(iIntValue + other.floatValue()) : Double.valueOf(((double) iIntValue) + other.doubleValue());
        } else if (number instanceof Long) {
            long jLongValue = number.longValue();
            if ((other instanceof Integer) || (other instanceof Byte) || (other instanceof Short) || (other instanceof Long)) {
                try {
                    return Long.valueOf(UByte$$ExternalSyntheticBackport0.m595m(jLongValue, other.longValue()));
            ...
            if (other instanceof Integer) {
                ...
                numberValueOf = other instanceof Float ? Float.valueOf(fFloatValue + other.floatValue()) : Double.valueOf(((double) fFloatValue) + other.doubleValue());
            }
        } else {
            double dDoubleValue = number.doubleValue();
            if (other instanceof Integer) {
                ...
                if (other instanceof Short) {
                    ...
                    dFloatValue = other.longValue();
                } else {
                    dFloatValue = other instanceof Float ? other.floatValue() : other.doubleValue();
                }
                numberValueOf = Double.valueOf(dDoubleValue + dFloatValue);
            }
            dFloatValue = iShortValue;
            numberValueOf = Double.valueOf(dDoubleValue + dFloatValue);
        }
    ...
    public static final Number rem(Number number, Number other) {
        ...
        if (number instanceof Byte) {
            ...
            if (other instanceof Integer) {
                ...
                numberValueOf = Long.valueOf(((long) bByteValue) % other.longValue());
            } else {
                numberValueOf = other instanceof Float ? Float.valueOf(bByteValue % other.floatValue()) : Double.valueOf(((double) bByteValue) % other.doubleValue());
            }
            ...
            if (other instanceof Integer) {
                ...
                numberValueOf = Long.valueOf(((long) sShortValue) % other.longValue());
            } else {
                numberValueOf = other instanceof Float ? Float.valueOf(sShortValue % other.floatValue()) : Double.valueOf(((double) sShortValue) % other.doubleValue());
            }
            ...
            if (other instanceof Integer) {
                ...
                numberValueOf = Long.valueOf(((long) iIntValue) % other.longValue());
            } else {
                numberValueOf = other instanceof Float ? Float.valueOf(iIntValue % other.floatValue()) : Double.valueOf(((double) iIntValue) % other.doubleValue());
            }
        } else if (number instanceof Long) {
            long jLongValue = number.longValue();
            if (other instanceof Integer) {
                numberValueOf = Long.valueOf(jLongValue % ((long) other.intValue()));
            } else if (other instanceof Byte) {
                numberValueOf = Long.valueOf(jLongValue % ((long) other.byteValue()));
            } else if (other instanceof Short) {
                numberValueOf = Long.valueOf(jLongValue % ((long) other.shortValue()));
            } else if (other instanceof Long) {
    ...
    public static final Number inc(Number number) {
        ...
        return number instanceof Float ? Float.valueOf(number.floatValue() + 1.0f) : Double.valueOf(number.doubleValue() + 1.0d);
    }
    ...
    public static final Number unaryPlus(Number number) {
        ...
        return number instanceof Float ? Float.valueOf(number.floatValue()) : Double.valueOf(number.doubleValue());
    }
    ...
    public static final Number ushr(Number number, Number next) {
        ...
        if (iIntValue < 0) {
            return Long.valueOf(((long) iIntValue) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
        }
