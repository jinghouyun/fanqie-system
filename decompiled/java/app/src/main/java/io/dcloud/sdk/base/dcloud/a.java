...
abstract class a extends ADHandler {
    ...
    /* JADX INFO: renamed from: io.dcloud.sdk.base.dcloud.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
    class C0073a implements v1 {
        final /* synthetic */ ADHandler.e a;
        final /* synthetic */ Context b;
        final /* synthetic */ String c;

        C0073a(ADHandler.e eVar, Context context, String str) {
            this.a = eVar;
            this.b = context;
            this.c = str;
        }
    ...
    class d implements Runnable {
        ...
        d(boolean z, int i, String str, String str2, boolean z2, int i2, v1 v1Var) {
            this.a = z;
            this.b = i;
            this.c = str;
            this.d = str2;
        ...
        public void run() {
            ...
            if (i == 0) {
                try {
                    bArrA = l3.a(this.c, map, true);
                } catch (Exception unused) {
                }
            } else if (i == 1) {
                bArrA = l3.a(this.c, this.d, map);
            }
    ...
    static void d(Context context, ADHandler.e eVar, String str) {
        ...
        if (iOptInt == 1) {
            ...
            if (AbsoluteConst.SPNAME_DOWNLOAD.equals(strOptString)) {
                a(jSONArrayOptJSONArray, eVar.c(), new C0073a(eVar, context, str), "clktrackers");
                return;
            } else {
    ...
    private static void a(Context context, ADHandler.e eVar, JSONArray jSONArray, String str, String str2) {
        x4.a().a(new c(jSONArray, eVar, context));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void b(String str, String str2, int i, int i2, boolean z, v1 v1Var, String str3, boolean z2) {
        int i3 = i2 - 1;
        b("handleTrackers_wanka template = " + (z ? 1 : 0) + "; t_count=" + i3 + "; tagMsg " + str3 + ";  url=" + str);
        x4.a().a(new d(z2, i, str, str2, z, i3, v1Var));
    }

    private static void a(JSONArray jSONArray, JSONObject jSONObject, String str) {
        a(jSONArray, jSONObject, (v1) null, str);
    }

    private static void a(JSONArray jSONArray, JSONObject jSONObject, v1 v1Var, String str) {
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            b(ADHandler.a(jSONObjectOptJSONObject.optString("url"), jSONObject), jSONObjectOptJSONObject.optString(UriUtil.LOCAL_CONTENT_SCHEME), jSONObjectOptJSONObject.optInt("http_method"), 2, iOptInt == 1, v1Var, str, z);
        }
    }
}
