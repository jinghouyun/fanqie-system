...
public final class BaseInfo {
    ...
    public static final String sBaseVersion = "1.9.9.82650";
        ...
        public static final boolean compareVersion(String str, String str2) {
            ...
            try {
                ...
                for (int i3 = 0; i3 < length; i3++) {
                    if (i3 >= length2 || (i = Integer.parseInt(strArrSplit[i3])) > (i2 = Integer.parseInt(strArrSplit2[i3]))) {
                        return true;
                    }
                    if (i < i2) {
                        return false;
    ...
    public static void parseControl() {
        ...
        SyncDebug = z;
        ISDEBUG = z || Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_DEBUG, AbsoluteConst.FALSE));
    ...
    /* JADX WARN: Code duplicated, block: B:107:0x0231 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:17:0x0045  */
    /* JADX WARN: Code duplicated, block: B:20:0x0074 A[Catch: Exception -> 0x0040, TRY_ENTER, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
    /* JADX WARN: Code duplicated, block: B:22:0x007c A[Catch: Exception -> 0x0040, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
    /* JADX WARN: Code duplicated, block: B:23:0x0083 A[Catch: Exception -> 0x0040, TRY_LEAVE, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
    /* JADX WARN: Code duplicated, block: B:25:0x0086 A[Catch: Exception -> 0x01dd, TRY_ENTER, TRY_LEAVE, TryCatch #1 {Exception -> 0x01dd, blocks: (B:5:0x0011, B:7:0x0019, B:9:0x0022, B:18:0x0046, B:30:0x0099, B:36:0x00d3, B:40:0x00f3, B:43:0x0106, B:45:0x010e, B:47:0x0114, B:25:0x0086, B:29:0x0095), top: B:113:0x0011 }] */
    /* JADX WARN: Code duplicated, block: B:27:0x0092 A[Catch: Exception -> 0x0040, TRY_ENTER, TRY_LEAVE, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
    /* JADX WARN: Code duplicated, block: B:29:0x0095 A[Catch: Exception -> 0x01dd, TRY_ENTER, TryCatch #1 {Exception -> 0x01dd, blocks: (B:5:0x0011, B:7:0x0019, B:9:0x0022, B:18:0x0046, B:30:0x0099, B:36:0x00d3, B:40:0x00f3, B:43:0x0106, B:45:0x010e, B:47:0x0114, B:25:0x0086, B:29:0x0095), top: B:113:0x0011 }] */
    /* JADX WARN: Code duplicated, block: B:32:0x00bd A[Catch: Exception -> 0x0040, TRY_ENTER, TRY_LEAVE, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
    /* JADX WARN: Code duplicated, block: B:35:0x00c7 A[Catch: Exception -> 0x00d3, TRY_LEAVE, TryCatch #7 {Exception -> 0x00d3, blocks: (B:33:0x00bf, B:35:0x00c7), top: B:125:0x00bf }] */
    /* JADX WARN: Code duplicated, block: B:38:0x00ee  */
    /* JADX WARN: Code duplicated, block: B:42:0x0104 A[Catch: Exception -> 0x0040, TRY_ENTER, TRY_LEAVE, TryCatch #0 {Exception -> 0x0040, blocks: (B:11:0x0031, B:20:0x0074, B:22:0x007c, B:32:0x00bd, B:39:0x00f1, B:42:0x0104, B:23:0x0083, B:27:0x0092), top: B:111:0x0031 }] */
        ...
        if (sParsedControl) {
            ...
            try {
                ...
                if (resInputStream != null) {
                    XmlUtil.DHNode dHNodeXML_Parser = XmlUtil.XML_Parser(resInputStream);
                    IOUtil.close(resInputStream);
                    if (dHNodeXML_Parser != null) {
                        boolean z5 = Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_SyncDebug, AbsoluteConst.FALSE));
                        SyncDebug = z5;
                        if (!z5) {
                            try {
                                if (Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_DEBUG, AbsoluteConst.FALSE))) {
                                    z2 = true;
                                } else {
                                    z2 = false;
                                }
                                ISDEBUG = z2;
                                AuxiliaryInput = Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_AUXILIARYINPUT, AbsoluteConst.FALSE));
                                ISAMU = Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_AMU, AbsoluteConst.FALSE));
                                sGlobalAuthority = XmlUtil.getAttributeValue(dHNodeXML_Parser, IApp.ConfigProperty.CONFIG_AUTHORITY, (String) null);
                                metaValue = AndroidResources.getMetaValue("DCLOUD_STREAMAPP_CHANNEL");
                                if (!PdrUtil.isEmpty(metaValue)) {
                                    ...
                                    attributeValue = XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_CHANNEL, (String) null);
                                    if (!PdrUtil.isEmpty(attributeValue)) {
                                        sChannel = attributeValue;
                                    } else {
                                        sChannel = "";
                                    }
                                }
                                sSplashExitCondition = XmlUtil.getAttributeValue(dHNodeXML_Parser, "back", sSplashExitCondition);
                                s_Is_DCloud_Packaged = Boolean.parseBoolean(XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_NS, AbsoluteConst.FALSE));
                                attributeValue2 = XmlUtil.getAttributeValue(dHNodeXML_Parser, AbsoluteConst.XML_FONT_SCALE, sFontScale);
                                if (!TextUtils.isEmpty(attributeValue2)) {
                                    sFontScale = attributeValue2;
                                    try {
                                ...
                                XmlUtil.DHNode element = XmlUtil.getElement(dHNodeXML_Parser, AbsoluteConst.XML_APPS);
                                i = PdrUtil.parseInt(XmlUtil.getAttributeValue(element, "max"), s_Runing_App_Count_Max);
                                s_Runing_App_Count_Max = i;
                                if (i <= 0) {
                                    s_Runing_App_Count_Max = Integer.MAX_VALUE;
                                }
                                i2 = PdrUtil.parseInt(XmlUtil.getAttributeValue(element, AbsoluteConst.XML_TRIM), s_Runing_App_Count_Trim);
                                s_Runing_App_Count_Trim = i2;
                                if (i2 <= 0) {
                                ...
                                if (elements == null && !SDK.isUniMPSDK()) {
                                    ...
                                    strArr2 = null;
                                    HashMap<String, BaseAppInfo> map = null;
                                    int i3 = 0;
                                    boolean z6 = false;
                                    boolean z7 = true;
                                    while (i3 < size) {
                                        try {
                                            XmlUtil.DHNode dHNode = elements.get(i3);
                                            String attributeValue3 = XmlUtil.getAttributeValue(dHNode, "appid");
                                            if (i3 == 0) {
                                                try {
                                                    strArr2 = new String[]{attributeValue3};
                                                    try {
                                                        if (!SDK.isUniMPSDK()) {
                                                            sDefaultBootApp = attributeValue3;
                                                        }
                                                        updateBaseInfoByApp(attributeValue3, str);
                                                        boolean zCheckCoverLoadApp = DeviceInfo.checkCoverLoadApp();
                                                        sCoverApkRuning = zCheckCoverLoadApp;
                                                        if (isBase(DCLoudApplicationImpl.self().getContext())) {
                                                            zCheckCoverLoadApp &= ISDEBUG ^ z3;
                                                        }
                                                        z7 = zCheckCoverLoadApp;
                                                        loadInstalledAppInfo(context);
                                                        map = mInstalledAppInfoSet;
                                                    } catch (Exception e) {
                                                        e = e;
                                                        z4 = z6;
                                                        z = true;
                                                        ...
                                                        Logger.e("channel:" + sChannel + ";ver:1.9.9.82650;max:" + s_Runing_App_Count_Max + ";trim:" + s_Runing_App_Count_Trim + ";dg:" + ISDEBUG);
                                            ...
                                            try {
                                                ...
                                                if (z7 && map.containsKey(attributeValue3)) {
                                                    BaseAppInfo baseAppInfo2 = map.get(attributeValue3);
                                                    if (!sCoverApkRuning && !baseAppInfo.high(baseAppInfo2)) {
                                                        baseAppInfo.mMoreRecent = false;
                            ...
                            sSupportAddByHand &= ISDEBUG;
                            XmlUtil.DHNode element2 = XmlUtil.getElement(dHNodeXML_Parser, AbsoluteConst.XML_APPS);
                            i = PdrUtil.parseInt(XmlUtil.getAttributeValue(element2, "max"), s_Runing_App_Count_Max);
                            s_Runing_App_Count_Max = i;
                            if (i <= 0) {
                                s_Runing_App_Count_Max = Integer.MAX_VALUE;
                            }
                            i2 = PdrUtil.parseInt(XmlUtil.getAttributeValue(element2, AbsoluteConst.XML_TRIM), s_Runing_App_Count_Trim);
                            s_Runing_App_Count_Trim = i2;
                            if (i2 <= 0) {
                                s_Runing_App_Count_Trim = 0;
                            }
