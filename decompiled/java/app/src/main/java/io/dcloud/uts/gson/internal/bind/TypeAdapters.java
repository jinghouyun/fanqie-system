...
public final class TypeAdapters {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: io.dcloud.uts.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read2(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = AnonymousClass34.$SwitchMap$io$dcloud$uts$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
    ...
    /* JADX INFO: renamed from: io.dcloud.uts.gson.internal.bind.TypeAdapters$34, reason: invalid class name */
