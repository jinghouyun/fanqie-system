...
public class t0 {
    ...
    public t0 a(JSONObject jSONObject, int i) {
        ...
        String strOptString = jSONObject.optString("vadpid", "");
        ...
        if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
            ...
            for (int i2 = 0; i2 < jSONArrayOptJSONArray.length(); i2++) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    ...
                    v4 v4VarA = new v4.b().e(jSONObjectOptJSONObject.optString("sid")).c(jSONObjectOptJSONObject.optInt("cpm", -1)).c(jSONObjectOptJSONObject.optInt("bdt", 0) == 1).f(jSONObjectOptJSONObject.optInt(MediaFormatExtraConstants.KEY_LEVEL, -1)).g(jSONObjectOptJSONObject.optInt(WXComponent.PROP_FS_MATCH_PARENT, -1)).c(jSONObjectOptJSONObject.optString(ContextChain.TAG_PRODUCT)).i(jSONObjectOptJSONObject.optInt("ss", -1)).j(iOptInt4).k(jSONObjectOptJSONObject.optInt(WXComponent.PROP_FS_WRAP_CONTENT, -1)).d(iOptInt3).b(this.b).a(jSONObjectOptJSONObject.optString("mrt")).b(jSONObjectOptJSONObject.optString(AbsoluteConst.XML_PATH)).h(jSONObjectOptJSONObject.optInt("mt", -1)).a(jSONObjectOptJSONObject.optInt("end", 0) == 1).a(jSONObjectOptJSONObject.optJSONObject("params")).a(jSONObjectOptJSONObject.optInt("acpt", 0)).e(this.h).d(strOptString).b(this.b != 5).a();
                    if (!v4VarA.l().equals(Const.TYPE_HW) || i != 3) {
                        this.i.add(v4VarA.l());
                        this.e.add(v4VarA);
                    }
                }
