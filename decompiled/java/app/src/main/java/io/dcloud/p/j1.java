...
public class j1 extends y3 implements AOLLoader.FeedAOLInteractionListener, AOLLoader.NativeAOLInteractionListener, AOLLoader.AppDownloadListener, AOLLoader.VideoAdListener {
    ...
    public j1(DCBaseAOL dCBaseAOL, Activity activity) {
    ...
    public void onClicked() {
        a(this.d, this.b);
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda13
        ...
        g4.a(view, activity, sb.toString());
    }

    @Override // io.dcloud.sdk.core.interfaces.AOLLoader.FeedAOLInteractionListener
    public void onClosed(final String str) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.a(str);
            }
    ...
    public void onDownloadActive(final long j, final long j2, final String str, final String str2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDownloadFailed(final long j, final long j2, final String str, final String str2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDownloadFinished(final long j, final String str, final String str2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDownloadPaused(final long j, final long j2, final String str, final String str2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    @Override // io.dcloud.sdk.core.interfaces.AOLLoader.AppDownloadListener
    public void onIdle() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.e();
            }
    ...
    public void onInstalled(final String str, final String str2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.a(str, str2);
            }
    ...
    public void onProgressUpdate(final long j, final long j2) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.a(j, j2);
            }
    ...
    public void onRenderFail() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.f();
            }
    ...
    public void onRenderSuccess() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.g();
            }
    ...
    public void onShow() {
        b(this.d, this.b);
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.h();
            }
    ...
    public void onVideoAdPaused() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.l();
            }
    ...
    public void onVideoAdResume() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m();
            }
    ...
    public void onVideoAdStartPlay() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.n();
            }
    ...
    public void onVideoError(final int i, final String str) {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.a(i, str);
            }
    ...
    public void onVideoLoad() {
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.j1$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.o();
            }
