...
public class AolSplashUtil {
    ...
    public static String da(String str, String str2) {
        ...
        h4 h4Var = SP.getsOrCreateBundle(ADHandler.AdTag);
        String strA = h4Var.a("cgk") ? h4Var.a("cgk", "") : h4Var.a("uniad", "");
        if (TextUtils.isEmpty(strA)) {
            String metaValue = AndroidResources.getMetaValue(str);
            if (PdrUtil.isEmpty(metaValue) || !metaValue.contains("_")) {
                return metaValue;
            }
            return Arrays.binarySearch(adTypes, metaValue.substring(0, metaValue.indexOf("_"))) != -1 ? metaValue.substring(metaValue.indexOf("_") + 1) : metaValue;
        }
        try {
