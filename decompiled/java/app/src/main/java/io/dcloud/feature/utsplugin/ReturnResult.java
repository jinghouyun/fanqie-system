...
/* JADX INFO: compiled from: ReturnResult.kt */
    ...
    public final JSONObject toJSON() {
        ...
        if (TextUtils.isEmpty(getErrMsg())) {
            if ((getParams() instanceof String) || (getParams() instanceof Number) || (getParams() instanceof Boolean) || (getParams() instanceof JSONObject) || (getParams() instanceof JSONArray) || (getParams() instanceof UTSArray) || getParams() == null) {
                jSONObject2.put("params", getParams());
                return jSONObject;
            }
            jSONObject2.put("params", JSON.parseObject(io.dcloud.uts.JSON.stringify(getParams())));
            return jSONObject;
        }
        jSONObject2.put(IWXUserTrackAdapter.MONITOR_ERROR_MSG, getErrMsg());
        return jSONObject;
    }
}
