...
public class ValueAnimator extends Animator {
    ...
    public ValueAnimator m428clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.m428clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderM432clone = propertyValuesHolderArr[i2].m432clone();
                valueAnimator.mValues[i2] = propertyValuesHolderM432clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderM432clone.getPropertyName(), propertyValuesHolderM432clone);
            }
        }
        return valueAnimator;
    }
