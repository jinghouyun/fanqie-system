...
public abstract class k3 {
    ...
    public static void a(IWebview iWebview, x2 x2Var, Object obj, Field field, boolean z, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        ...
        try {
            a(iWebview, x2Var, field.getType(), field.get(obj), name, z, stringBuffer, stringBuffer2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    static void a(IWebview iWebview, x2 x2Var, Class cls, Object obj, String str, boolean z, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        if (z) {
            stringBuffer.append(JSUtil.QUOTE + str + JSUtil.QUOTE);
            a(iWebview, x2Var, obj, cls, stringBuffer2);
            stringBuffer.append(",");
            stringBuffer2.append(",");
            return;
        }
    ...
    public static void a(IWebview iWebview, x2 x2Var, Object obj, Class cls, StringBuffer stringBuffer) {
        if (obj == null) {
        ...
        if (!cls.equals(String.class) && !cls.equals(Character.class)) {
            ...
            if (iA > -1) {
                ...
                for (int i = 0; i < iA; i++) {
                    ...
                    a(iWebview, x2Var, objA, objA.getClass(), stringBuffer2);
                    stringBuffer2.append(",");
                }
                a(stringBuffer2);
            ...
            stringBuffer.append(JSUtil.QUOTE + JSUtil.toJsResponseText(x2.b(iWebview, obj)) + JSUtil.QUOTE);
            return;
        }
    ...
    public static String a(IWebview iWebview, x2 x2Var, String str) {
        ...
        if (clsA != null) {
            try {
                ...
                for (Field field : clsA.getFields()) {
                    a(iWebview, x2Var, null, field, true, stringBuffer4, stringBuffer5);
                }
                stringBuffer = stringBuffer5;
                try {
                    a(iWebview, x2Var, Class.class, clsA, "class", true, stringBuffer4, stringBuffer);
                    try {
