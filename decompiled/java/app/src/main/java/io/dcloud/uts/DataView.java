...
/* JADX INFO: compiled from: DataView.kt */
...
public final class DataView {
    ...
    public final Number getUint8(Number byteOffset) throws RangeError {
        Intrinsics.checkNotNullParameter(byteOffset, "byteOffset");
        checkRange(byteOffset.intValue());
        byte bM544constructorimpl = UByte.m544constructorimpl(this.byteBuffer.get());
        this.byteBuffer.clear();
        return NumberKt.UTSNumber(Integer.valueOf(bM544constructorimpl & 255));
    }
    ...
    public final Number getUint8(int byteOffset) throws RangeError {
        ...
        byte bM544constructorimpl = UByte.m544constructorimpl(this.byteBuffer.get());
        this.byteBuffer.clear();
        return Integer.valueOf(bM544constructorimpl & 255);
    }
    ...
    public final Number getUint16(Number byteOffset, boolean littleEndian) throws RangeError {
        ...
        checkRange(byteOffset.intValue());
        setOrder(littleEndian);
        short sM809constructorimpl = UShort.m809constructorimpl(this.byteBuffer.getShort());
        this.byteBuffer.clear();
        return NumberKt.UTSNumber(Integer.valueOf(sM809constructorimpl & UShort.MAX_VALUE));
    }
    ...
    public final Number getUint16(int byteOffset, boolean littleEndian) throws RangeError {
        ...
        short sM809constructorimpl = UShort.m809constructorimpl(this.byteBuffer.getShort());
        this.byteBuffer.clear();
        return Integer.valueOf(sM809constructorimpl & UShort.MAX_VALUE);
    }
    ...
    public final Number getUint32(Number byteOffset, boolean littleEndian) throws RangeError {
        ...
        checkRange(byteOffset.intValue());
        setOrder(littleEndian);
        int iM623constructorimpl = UInt.m623constructorimpl(this.byteBuffer.getInt());
        this.byteBuffer.clear();
        return NumberKt.UTSNumber(Long.valueOf(((long) iM623constructorimpl) & InternalZipConstants.ZIP_64_SIZE_LIMIT));
    }
    ...
    public final Number getUint32(int byteOffset, boolean littleEndian) throws RangeError {
        ...
        int iM623constructorimpl = UInt.m623constructorimpl(this.byteBuffer.getInt());
        this.byteBuffer.clear();
        return Long.valueOf(((long) iM623constructorimpl) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    }
