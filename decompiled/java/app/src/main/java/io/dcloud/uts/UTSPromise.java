...
/* JADX INFO: compiled from: UTSPromise.kt */
...
public final class UTSPromise<T> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final <R> Unit _then$lambda$0(Function1<? super R, Unit> function1, Function1<java.lang.Object, Unit> function2) {
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: catch, reason: not valid java name */
    public UTSPromise<T> m506catch() {
    ...
    /* JADX INFO: renamed from: catch, reason: not valid java name */
    public <R> UTSPromise<R> m507catch(Function0<? extends R> onRejected) {
    ...
    /* JADX INFO: renamed from: catch, reason: not valid java name */
    public <R> UTSPromise<R> m508catch(Function1<java.lang.Object, ? extends R> onRejected) {
        Intrinsics.checkNotNullParameter(onRejected, "onRejected");
        return catch_origin(onRejected);
    }
    ...
    public UTSPromise<T> m509finally(final Function<?> callback) {
    ...
    public static final class Companion {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit _resolve$lambda$0(java.lang.Object obj, Function1<? super T, Unit> function1, Function1<java.lang.Object, Unit> function2) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit reject$lambda$1(java.lang.Object obj, Function1<? super Unit, Unit> function1, Function1<java.lang.Object, Unit> function2) {
            UTSPromiseKt.callFunction(function2, UTSArrayKt.utsArrayOf(obj));
            return Unit.INSTANCE;
        }
        ...
        private static final <T> void all_origin$lambda$5$res(final Function1<java.lang.Object, Unit> function1, final UTSArray<java.lang.Object> uTSArray, final Ref.ObjectRef<Number> objectRef, final Function1<? super T, Unit> function2, final Number number, java.lang.Object obj) {
            try {
                if (obj != null) {
                    try {
                        if (obj instanceof UTSPromise) {
                            ((UTSPromise) obj)._then(new Function1() { // from class: io.dcloud.uts.UTSPromise$Companion$$ExternalSyntheticLambda8
                                ...
                                public final java.lang.Object invoke(java.lang.Object obj2) {
                                    return UTSPromise.Companion.all_origin$lambda$5$res$lambda$3(number, function1, uTSArray, objectRef, function2, obj2);
                                }
                            }, function1);
                            return;
                        }
                ...
                uTSArray.set(((Integer) number).intValue(), obj);
                ...
                if (Intrinsics.areEqual((java.lang.Object) objectRef.element, (java.lang.Object) 0)) {
                    UTSPromiseKt.callFunction(function2, UTSArrayKt.utsArrayOf(uTSArray));
                }
            } catch (Throwable th2) {
                th = th2;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit all_origin$lambda$5$res$lambda$3(Number number, Function1<java.lang.Object, Unit> function1, UTSArray<java.lang.Object> uTSArray, Ref.ObjectRef<Number> objectRef, Function1<? super T, Unit> function2, java.lang.Object obj) {
            all_origin$lambda$5$res(function1, uTSArray, objectRef, function2, number, obj);
            return Unit.INSTANCE;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit race_origin$lambda$7(UTSArray<?> uTSArray, Function1<? super T, Unit> function1, Function1<java.lang.Object, Unit> function2) {
            ...
            for (Integer numValueOf = (Number) 0; NumberKt.compareTo(numValueOf, length) < 0; numValueOf = Integer.valueOf(numValueOf.intValue() + 1)) {
                UTSPromise.INSTANCE._resolve(uTSArray.get(numValueOf.intValue()))._then(function1, function2);
            }
            return Unit.INSTANCE;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit any_origin$lambda$11(UTSArray<?> uTSArray, Function1<? super T, Unit> function1, final Function1<java.lang.Object, Unit> function2) {
            if (Intrinsics.areEqual((java.lang.Object) uTSArray.getLength(), (java.lang.Object) 0)) {
                UTSPromiseKt.callFunction(function2, new UTSArray());
                return Unit.INSTANCE;
            }
            ...
            for (Number numberInc = (Number) 0; NumberKt.compareTo(numberInc, uTSArray2.getLength()) < 0; numberInc = NumberKt.inc(numberInc)) {
                try {
                    ...
                    UTSPromise._then$default(companion2._resolve(uTSArray2.get(((Integer) numberInc).intValue())), function1, null, 2, null)._catch(new Function1() { // from class: io.dcloud.uts.UTSPromise$Companion$$ExternalSyntheticLambda6
                        @Override // kotlin.jvm.functions.Function1
                        public final java.lang.Object invoke(java.lang.Object obj) {
                            return UTSPromise.Companion.any_origin$lambda$11$lambda$10$lambda$9(uTSArray3, uTSArray2, function2, obj);
                        }
                    });
                } catch (Throwable th) {
                    UTSPromiseKt.callFunction(function2, UTSArrayKt.utsArrayOf(th));
                }
            }
            return Unit.INSTANCE;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit any_origin$lambda$11$lambda$10$lambda$9(UTSArray<java.lang.Object> uTSArray, UTSArray<java.lang.Object> uTSArray2, Function1<java.lang.Object, Unit> function1, java.lang.Object obj) {
            uTSArray.push(obj);
        ...
        private static final <T> void allSettled_origin$lambda$17$res$15(final UTSArray<java.lang.Object> uTSArray, final Ref.ObjectRef<Number> objectRef, final Function<?> function, final Number number, java.lang.Object obj) {
            ...
            Intrinsics.checkNotNull(number, "null cannot be cast to non-null type kotlin.Int");
            uTSArray.set(((Integer) number).intValue(), new UTSPromiseFulfilledResultImpl(obj));
            objectRef.element = (T) NumberKt.dec(objectRef.element);
            if (Intrinsics.areEqual((java.lang.Object) objectRef.element, (java.lang.Object) 0)) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit allSettled_origin$lambda$17$res$15$lambda$13(Number number, UTSArray<java.lang.Object> uTSArray, Ref.ObjectRef<Number> objectRef, Function<?> function, java.lang.Object obj) {
            allSettled_origin$lambda$17$res$15(uTSArray, objectRef, function, number, obj);
            return Unit.INSTANCE;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit allSettled_origin$lambda$17$res$15$lambda$14(UTSArray<java.lang.Object> uTSArray, Number number, Ref.ObjectRef<Number> objectRef, Function<?> function, java.lang.Object obj) {
            Intrinsics.checkNotNull(number, "null cannot be cast to non-null type kotlin.Int");
            uTSArray.set(((Integer) number).intValue(), new UTSPromiseRejectedResultImpl(obj));
            objectRef.element = (T) NumberKt.dec(objectRef.element);
            if (Intrinsics.areEqual((java.lang.Object) objectRef.element, (java.lang.Object) 0)) {
                UTSPromiseKt.callFunction(function, UTSArrayKt.utsArrayOf(uTSArray));
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit all_origin$lambda$5(UTSArray<?> uTSArray, Function1<? super T, Unit> function1, Function1<java.lang.Object, Unit> function2) {
            ...
            for (Integer numValueOf = (Number) 0; NumberKt.compareTo(numValueOf, uTSArray2.getLength()) < 0; numValueOf = Integer.valueOf(numValueOf.intValue() + 1)) {
                all_origin$lambda$5$res(function2, uTSArray2, objectRef, function1, numValueOf, uTSArray2.get(numValueOf.intValue()));
            }
            return Unit.INSTANCE;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit allSettled_origin$lambda$17(UTSArray<?> uTSArray, Function<?> function, Function<?> function2) {
            UTSArray uTSArray2 = new UTSArray();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit _immediateFn$lambda$18(Function<?> function) {
