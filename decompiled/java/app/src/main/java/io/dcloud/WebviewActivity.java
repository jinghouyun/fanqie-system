...
public class WebviewActivity extends DCloudBaseActivity implements View.OnClickListener {
    ...
    class b extends WebViewClient {
        ...
        class DialogInterfaceOnClickListenerC0021b implements DialogInterface.OnClickListener {
            ...
            DialogInterfaceOnClickListenerC0021b(AlertDialog alertDialog, SslError sslError, SslErrorHandler sslErrorHandler) {
                this.a = alertDialog;
                this.b = sslError;
        ...
        public void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
            if (sslErrorHandler != null) {
                ...
                DialogInterfaceOnClickListenerC0021b dialogInterfaceOnClickListenerC0021b = new DialogInterfaceOnClickListenerC0021b(alertDialogCreate, sslError, sslErrorHandler);
    ...
    class c implements DownloadListener {
        ...
        class a implements View.OnClickListener {
            ...
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DownloadUtil.getInstance(WebviewActivity.this.that).startRequest(WebviewActivity.this.that, this.a, this.b, this.c, this.d, new C0022a());
            }
        }
    ...
    private void a(WebView webView) {
        if (webView != null) {
            ...
            PlatformUtil.invokeMethod(settings, e1.a("f2l4TWBgY3tKZWBpTW9vaX9/KjZhM2Q4OGZhLTRiYTAtNDc5Zi05NDIyLWU1YWFiZTE1ODk3Yjc2", true, 12), clsArr, objArr);
