...
/* JADX INFO: compiled from: UTSArray.kt */
...
public class UTSArray<E> extends ArrayList<E> {
    ...
    public static final class Companion {
        ...
        public static final <T> Unit fromAsync$lambda$0(CoroutineScope coroutineScope, UTSValueIterable<?> uTSValueIterable, Function2<java.lang.Object, ? super Number, ? extends T> function2, Function1<? super UTSArray<T>, Unit> function1, Function1<java.lang.Object, Unit> function3) {
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new UTSArray$Companion$fromAsync$p$1$1(uTSValueIterable, function1, function3, function2, null), 3, null);
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final <T> Unit fromAsyncImpl$lambda$1(CoroutineScope coroutineScope, Iterable<?> iterable, Function2<java.lang.Object, ? super Number, ? extends T> function2, Function1<? super UTSArray<T>, Unit> function1, Function1<java.lang.Object, Unit> function3) {
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new UTSArray$Companion$fromAsyncImpl$p$1$1(iterable, function1, function3, function2, null), 3, null);
            return Unit.INSTANCE;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit fromAsync$lambda$3(CharSequence charSequence, Function2<? super String, ? super Number, String> function2, Function1<? super UTSArray<String>, Unit> function1, Function1<java.lang.Object, Unit> function3) {
    ...
    public final E set(Number index, E element) {
        Intrinsics.checkNotNullParameter(index, "index");
        return set(index.intValue(), element);
    }
}
