...
public abstract class g4 {
    ...
    class d implements PixelCopy.OnPixelCopyFinishedListener {
        ...
        public void onPixelCopyFinished(int i) {
            ...
            g4.b(this.c, this.d + 1, this.e, this.a, this.f);
        }
    }
    ...
    class f implements o {
        ...
        @Override // io.dcloud.p.g4.o
        public void a(Bitmap bitmap, Bitmap bitmap2) {
            g4.b("captureAndSaveAuto", bitmap, bitmap2, this.a, this.b, this.c);
        }
    }
    ...
    class g implements o {
        ...
        @Override // io.dcloud.p.g4.o
        public void a(Bitmap bitmap, Bitmap bitmap2) {
            g4.b("captureTopAndSaveAuto", bitmap, bitmap2, null, this.a, this.b);
        }
    }
    ...
    class h implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            g4.b(this.a, this.b, this.c, this.d);
        }
    }
    ...
    class i implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityDestroyed(Activity activity) {
            if (g4.a == null || g4.a.get() != activity) {
                return;
            }
            WeakReference unused = g4.a = null;
        }
        ...
        public void onActivityResumed(Activity activity) {
            WeakReference unused = g4.a = new WeakReference(activity);
        }
    ...
    class j implements o {
        ...
        public void a(Bitmap bitmap, Bitmap bitmap2) {
            ...
            g4.b(this.c, this.d + 1, this.a, this.e);
        }
    }
            ...
            if (!list2.isEmpty()) {
                try {
                    ...
                    for (int size = list.size() - 1; size >= 0; size--) {
                        ...
                        canvas2.drawBitmap(bitmap4, iArr[0], iArr[1], paint);
                    }
                    bitmap = bitmapCopy;
                } catch (Exception e3) {
                    e3.printStackTrace();
