...
class j3 {
    ...
    public j3(IWebview iWebview, x2 x2Var, Class cls, String str, JSONArray jSONArray) {
        this.c = null;
        this.a = x2Var;
        this.b = cls;
        this.d = str;
        this.c = a(iWebview, x2Var, cls, jSONArray);
    }

    public static Object a(IWebview iWebview, x2 x2Var, Class cls, JSONArray jSONArray) {
        Constructor<?> constructor;
        if (jSONArray == null) {
            return cls.newInstance();
        }
        Object[] objArrA = a(iWebview, x2Var, jSONArray);
    ...
    public static void b(IWebview iWebview, x2 x2Var, Class cls, Object obj, String str, JSONArray jSONArray) {
        Object[] objArrA = a(iWebview, x2Var, jSONArray);
        try {
    ...
    public j3(x2 x2Var, Class cls, String str, Object obj) {
        this.a = x2Var;
        this.b = cls;
        this.d = str;
        this.c = obj;
    ...
    static Object[] b(Class cls) {
        ...
        for (int i2 = 0; i2 < name.length(); i2++) {
            ...
            if (cCharAt == '[') {
                ...
                if (cCharAt != 'S') {
                    if (cCharAt == 'L') {
                        try {
                            cls2 = Class.forName(name.substring(i2 + 1));
                            cls3 = cls2;
                            break;
        ...
        return new Object[]{Integer.valueOf(i), cls3};
    }

    String a(IWebview iWebview, x2 x2Var) {
        StringBuffer stringBuffer = new StringBuffer();
        StringBuffer stringBuffer2 = new StringBuffer();
        for (Field field : this.b.getFields()) {
            k3.a(iWebview, x2Var, this.c, field, false, stringBuffer, stringBuffer2);
        }
    ...
    public static final Object a(IWebview iWebview, x2 x2Var, Class cls, Object obj, String str, JSONArray jSONArray) {
        Object[] objArrA = a(iWebview, x2Var, jSONArray);
        Class[] clsArr = (Class[]) objArrA[0];
        Object[] objArr = (Object[]) objArrA[1];
    ...
    private static final Object a(Object obj, Method method, Object[] objArr, boolean z) throws IllegalAccessException, InvocationTargetException {
        try {
    ...
    static Object a(Object obj, Class cls, int i, a aVar) {
    ...
    static Object[] a(IWebview iWebview, x2 x2Var, Object obj) {
        ...
        if (obj instanceof JSONArray) {
            ...
            for (int i = 0; i < length; i++) {
                Object[] objArrA = a(iWebview, x2Var, jSONArray.opt(i));
            ...
            if (strOptString.equals("object")) {
                j3 j3VarA = x2Var.a(iWebview, String.valueOf(objOpt));
                objArr[0] = j3VarA.b;
                objArr[1] = j3VarA.c;
                return objArr;
            }
            ...
            if (strOptString.equals("number")) {
                ...
                if ("JSBObject".equals(jSONObject.optString("__TYPE__"))) {
                    j3 j3VarA2 = x2Var.a(iWebview, jSONObject.optString(AbsoluteConst.JSON_KEY_UUID));
                    objArr[0] = j3VarA2.b;
                    objArr[1] = j3VarA2.c;
                }
            }
    ...
    protected static Object[] a(IWebview iWebview, x2 x2Var, JSONArray jSONArray) {
        int length;
        Object[] objArr = new Object[2];
        if (jSONArray != null) {
            try {
        ...
        for (int i = 0; i < length; i++) {
            Object[] objArrA = a(iWebview, x2Var, jSONArray.get(i));
