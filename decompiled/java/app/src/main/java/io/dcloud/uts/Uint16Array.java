...
/* JADX INFO: compiled from: Uint16Array.kt */
...
public final class Uint16Array extends TypedArray {
    ...
    public Number getAuto(int index) {
        return Integer.valueOf(UShort.m809constructorimpl(getByteBuffer().getShort(index * getBYTES_PER_ELEMENT().intValue())) & UShort.MAX_VALUE);
    }
    ...
    @Override // io.dcloud.uts.TypedArray
    public Uint16Array subarray(Number begin, Number end) {
        if (begin != null) {
    ...
    /* JADX INFO: renamed from: io.dcloud.uts.Uint16Array$iterator$1, reason: invalid class name */
    /* JADX INFO: compiled from: Uint16Array.kt */
    ...
    public static final class AnonymousClass1 implements Iterator<Number>, KMappedMarker {
        ...
        public Number next() {
            ...
            return Integer.valueOf(UShort.m809constructorimpl(Uint16Array.this.getByteBuffer().getShort()) & UShort.MAX_VALUE);
        }
    }
}
