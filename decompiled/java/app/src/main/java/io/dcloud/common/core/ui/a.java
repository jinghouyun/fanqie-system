...
class a extends AdaContainerFrameItem implements ISysEventListener, IWebAppRootView {
    ...
    class l extends io.dcloud.common.core.ui.k {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.x = (int) (((double) a.this.j.getInt(2)) * 0.8d);
        }
    ...
    class m implements Comparator {
        ...
        public int compare(io.dcloud.common.core.ui.b bVar, io.dcloud.common.core.ui.b bVar2) {
            ...
            if (i == 0) {
                return bVar.lastShowTime > bVar2.lastShowTime ? 1 : -1;
            }
            return i;
        }
    }
    ...
    int e(io.dcloud.common.core.ui.b bVar) {
        ...
        if (i3 != 0) {
            ...
            for (i2 = 0; i2 < childCount; i2++) {
                ...
                if ((childAt instanceof AbsoluteLayout) || (childAt instanceof t4)) {
                    i5++;
                } else {
                    i4++;
                }
    ...
    /* JADX WARN: Code duplicated, block: B:59:0x03a5  */
    /* JADX WARN: Code duplicated, block: B:63:0x03b4  */
    /* JADX WARN: Code duplicated, block: B:65:0x03c2  */
    /* JADX WARN: Code duplicated, block: B:67:0x03c6 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:69:0x03ce  */
    /* JADX WARN: Code duplicated, block: B:74:0x03d1 A[SYNTHETIC] */
    ...
    public boolean onExecute(ISysEventListener.SysEventType sysEventType, Object obj) {
        ...
        String str = "";
        EventActionInfo eventActionInfo2 = null;
        String str2 = null;
        eventActionInfo2 = null;
        switch (C0033a.a[sysEventType.ordinal()]) {
            case 1:
                AppStatus.setAppStatus(this.i, 2);
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, "pause");
                eventActionInfo2 = new EventActionInfo("pause");
                if (this.c != null && !TextUtils.isEmpty(str)) {
                    for (size = this.c.size() - 1; size >= 0; size--) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                            if (!(iWebviewObtainWebView instanceof AdaUniWebView) && eventActionInfo2 != null) {
                                ((AdaUniWebView) iWebviewObtainWebView).fireEvent(eventActionInfo2);
                            } else {
                ...
                break;
            case 2:
                AppStatus.setAppStatus(this.i, 1);
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_RESUME);
                ...
                eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_RESUME);
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                            if (!(iWebviewObtainWebView instanceof AdaUniWebView)) {
                                iWebviewObtainWebView.loadUrl(str);
                            } else {
                                iWebviewObtainWebView.loadUrl(str);
                            }
            ...
            case 3:
                if (PermissionControler.checkPermission(this.i, IFeature.F_DEVICE.toLowerCase(Locale.ENGLISH))) {
                    String str3 = StringUtil.format("plus.device.imsi = ['%s'];", DeviceInfo.getUpdateIMSI());
                    str = (AbsoluteConst.PROTOCOL_JAVASCRIPT + str3) + StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_IMSI_CHANGE);
                    eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_IMSI_CHANGE, str3);
                }
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
            ...
            case 4:
                if (PermissionControler.checkPermission(this.i, IFeature.F_DEVICE.toLowerCase(Locale.ENGLISH))) {
                    String bundleData2 = SP.getBundleData(getContext(), BaseInfo.PDR, "last_notify_net_type");
                    String netWorkType = DeviceInfo.getNetWorkType(getContext());
                    if (!PdrUtil.isEquals(bundleData2, netWorkType)) {
                        Logger.d("NetCheckReceiver", "netchange last_net_type:" + bundleData2 + ";cur_net_type:" + netWorkType);
                        SP.setBundleData(getContext(), BaseInfo.PDR, "last_notify_net_type", netWorkType);
                        String str4 = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_NETCHANGE);
                        String str5 = StringUtil.format("plus.device.imsi = ['%s'];", DeviceInfo.getUpdateIMSI());
                        str = AbsoluteConst.PROTOCOL_JAVASCRIPT + str5 + str4;
                        eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_NETCHANGE, str5);
                        if (this.c != null) {
                            while (size >= 0) {
                                iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                                if (iWebviewObtainWebView != null) {
            ...
            case 5:
                ...
                String strObtainIntentStringExtra = IntentConst.obtainIntentStringExtra(getActivity().getIntent(), IntentConst.UNIMP_RUN_EXTRA_INFO, true);
                if (!PdrUtil.isEmpty(strObtainIntentStringExtra)) {
                    this.j.setConfigProperty(IntentConst.UNIMP_RUN_EXTRA_INFO, strObtainIntentStringExtra);
                }
                String launchType = BaseInfo.getLaunchType(getActivity().getIntent());
                BaseInfo.putLauncherData(this.j.obtainAppId(), launchType);
                String bundleData3 = SP.getBundleData(getContext(), "pdr", this.j.obtainAppId() + AbsoluteConst.LAUNCHTYPE);
                if (TextUtils.isEmpty(bundleData3)) {
                    bundleData3 = "default";
                }
                String str6 = StringUtil.format(AbsoluteConst.JS_RUNTIME_ARGUMENTS, this.j.obtainRuntimeArgs(true));
                String str7 = StringUtil.format(AbsoluteConst.JS_RUNTIME_LAUNCHER, launchType);
                String str8 = StringUtil.format(AbsoluteConst.JS_RUNTIME_ORIGIN, bundleData3);
                str = (AbsoluteConst.PROTOCOL_JAVASCRIPT + StringUtil.format(AbsoluteConst.JS_RUNTIME_BASE, str6) + StringUtil.format(AbsoluteConst.JS_RUNTIME_BASE, str7) + StringUtil.format(AbsoluteConst.JS_RUNTIME_BASE, str8)) + StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_NEW_INTENT);
                eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_NEW_INTENT, AbsoluteConst.JS_RUNTIME_V8_BASE + str6 + str7 + str8);
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
            ...
            case 6:
                ...
                if (SDK.isUniMP) {
                    ...
                    bundleData = SP.getBundleData(getContext(), SP.DARK_MODE_BUNDLE_FORMAT, SP.DARK_MODE_KEY);
                    if (PdrUtil.isEmpty(bundleData)) {
                        bundleData = AndroidResources.getMetaValue("DCLOUD_DARK_MODE");
                    }
                }
                if (PdrUtil.isEquals("auto", bundleData)) {
                    String str9 = DeviceInfo.isSystemNightMode(getContext()).booleanValue() ? DCBlurDraweeView.DARK : DCBlurDraweeView.LIGHT;
                    str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE_PARAMETER_OF_UISTYLE, AbsoluteConst.EVENTS_UISTYLECHANGE, str9);
                    HashMap map = new HashMap();
                    map.put("uistyle", str9);
                    eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_UISTYLECHANGE, map);
                    AppRuntime.switchAllWebViewDarkMode(c());
                    if (this.c != null) {
                        while (size >= 0) {
                            iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                            if (iWebviewObtainWebView != null) {
                ...
                break;
            case 7:
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_KEYBOARD_SHOW);
                eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_KEYBOARD_SHOW);
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                ...
                break;
            case 8:
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_KEYBOARD_HIDE);
                eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_KEYBOARD_HIDE);
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                ...
                break;
            case 9:
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, "background");
                eventActionInfo2 = new EventActionInfo("background");
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
            ...
            case 10:
                ...
                if (this.j.obtainWebAppIntent().getBooleanExtra(IntentConst.IS_WEBAPP_REPLY, false)) {
                    ...
                    str = AbsoluteConst.PROTOCOL_JAVASCRIPT + StringUtil.format(AbsoluteConst.JS_RUNTIME_BASE, str10) + StringUtil.format(AbsoluteConst.JS_RUNTIME_BASE, str11);
                    str2 = str10 + str11;
                }
                str = str + StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE_PARAMETER, AbsoluteConst.EVENTS_WEBAPP_FOREGROUND, launcherData);
                HashMap map2 = new HashMap();
                map2.put("active", launcherData);
                eventActionInfo = new EventActionInfo(AbsoluteConst.EVENTS_WEBAPP_FOREGROUND, str2, map2);
                eventActionInfo2 = eventActionInfo;
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                ...
                break;
            case 11:
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_WEBAPP_TRIMMEMORY);
                eventActionInfo2 = new EventActionInfo(AbsoluteConst.EVENTS_WEBAPP_TRIMMEMORY);
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
                        if (iWebviewObtainWebView != null) {
                ...
                break;
            case 12:
                AppEventForBlurManager.onSplashclosed();
                str = StringUtil.format(AbsoluteConst.EVENTS_DOCUMENT_EXECUTE_TEMPLATE, AbsoluteConst.EVENTS_SPLASH_CLOSED);
                eventActionInfo = new EventActionInfo(AbsoluteConst.EVENTS_SPLASH_CLOSED);
                io.dcloud.p.k.a(this.j.getActivity(), null, "onSplashclosed", null);
                eventActionInfo2 = eventActionInfo;
                if (this.c != null) {
                    while (size >= 0) {
                        iWebviewObtainWebView = ((io.dcloud.common.core.ui.b) this.c.get(size)).obtainWebView();
    ...
    boolean a(Region region, int i2, int i3, int i4, int i5) {
        ...
        if (!zQuickContains) {
            region.op(i2, i3, i6, i7, android.graphics.Region.Op.UNION);
        }
        return zQuickContains;
    }
    ...
    void a(a aVar, int i2) {
        ...
        if (aVar != null && !this.q) {
            ...
            boolean z = iActivityHandler != null ? !iActivityHandler.hasAdService() : true;
