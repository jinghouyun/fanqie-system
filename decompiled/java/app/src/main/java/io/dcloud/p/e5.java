...
public abstract class e5 implements IAppInfo {
    ...
    class a implements MessageHandler.IMessages {
        ...
        public void execute(Object obj) {
            if ("landscape".equals(this.a)) {
                e5.this.a.setRequestedOrientation(6);
                return;
            }
            if ("landscape-primary".equals(this.a)) {
                e5.this.a.setRequestedOrientation(0);
                return;
            }
            if ("landscape-secondary".equals(this.a)) {
                e5.this.a.setRequestedOrientation(8);
                return;
            }
            if ("portrait".equals(this.a)) {
                e5.this.a.setRequestedOrientation(7);
                return;
            }
            if ("portrait-primary".equals(this.a)) {
                e5.this.a.setRequestedOrientation(1);
            } else if ("portrait-secondary".equals(this.a)) {
                e5.this.a.setRequestedOrientation(9);
            } else {
                e5.this.a.setRequestedOrientation(4);
            }
        }
    }
