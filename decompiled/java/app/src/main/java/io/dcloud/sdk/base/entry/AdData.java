...
public class AdData implements Parcelable {
    ...
    class a implements Runnable {
        ...
        public void run() {
            byte[] bArrA = l3.a(AdData.this.src, (HashMap) null, true, new String[1]);
            if (bArrA == null) {
                e eVar = this.b;
                if (eVar != null) {
                    eVar.a(60009, "图片下载失败");
    ...
    class c implements Runnable {
        ...
        public void run() {
            try {
                ...
                map.put(IWebview.USER_AGENT, n4.e(AdData.this.p));
                l3.a(strA, map, true);
    ...
    void b(JSONObject jSONObject) {
        l4.a().a(this.p, this, jSONObject.toString());
    }
    ...
    String a(String str) {
        try {
            String strReplace = str.replace("${User-Agent}", URLEncoder.encode(n4.e(this.p), "utf-8")).replace("${click_id}", "");
    ...
    private void a(List list) {
        ...
        while (it.hasNext()) {
            x4.a().a(new c((TrackerBean) it.next()));
        }
    }
