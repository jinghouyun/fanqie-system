...
class b implements PopupWindow.OnDismissListener, ISysEventListener, EventDispatchManager.ActivityEventDispatchListener {
    ...
    /* JADX INFO: renamed from: io.dcloud.feature.ui.nativeui.b$b, reason: collision with other inner class name */
    /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
    class ViewOnKeyListenerC0048b implements View.OnKeyListener {
        ViewOnKeyListenerC0048b() {
        }
    ...
    private void e() {
        ...
        this.o.setOnKeyListener(new ViewOnKeyListenerC0048b());
    }
    ...
    private void h() {
        ...
        if (PdrUtil.isEquals(this.t, "snow")) {
            drawable = PdrUtil.isEquals(this.s, "black") ? this.a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_BLACK_SNOW) : this.a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_WHITE_SNOW);
        } else {
            drawable = PdrUtil.isEquals(this.s, "black") ? this.a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_BLACK_CIRCLE) : this.a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_WHITE_CIRCLE);
        }
        if (this.E > 0) {
    ...
    private void a(IWebview iWebview, JSONObject jSONObject) {
        ...
        if (!PdrUtil.isEmpty(string)) {
            this.r = !PdrUtil.isEquals(AbsoluteConst.FALSE, string);
        }
        ...
        if (JSONUtil.isNull(jSONObject, "padding")) {
            ...
            if (string4.indexOf(37) >= 0) {
                this.u = PdrUtil.convertToScreenInt(string4, this.y, this.u, scale);
                this.v = PdrUtil.convertToScreenInt(string4, this.z, this.v, scale);
            } else {
                int iConvertToScreenInt = PdrUtil.convertToScreenInt(string4, this.y, this.v, scale);
