        ...
        if (!cls.isInterface()) {
            ...
            while (rawType != Object.class) {
                ...
                while (i < length) {
                    ...
                    boolean zExcludeField2 = this.excludeField(field, false);
                    if (zExcludeField || zExcludeField2) {
                        ...
                        while (i2 < size) {
                            ...
                            BoundField boundFieldCreateBoundField = this.createBoundField(gson, field, str, TypeToken.get(typeResolve), z, zExcludeField2);
