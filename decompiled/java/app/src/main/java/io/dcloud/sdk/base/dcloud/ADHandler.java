...
public abstract class ADHandler {
    ...
    public static void b(final int i, final Context context, final String str, final String str2, final e eVar, final String str3) {
        x4.a().a(new Runnable() { // from class: io.dcloud.sdk.base.dcloud.ADHandler$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
    ...
    static void b(Context context, e eVar, String str) {
        ...
        if (jSONObjectB.has("dplk") && io.dcloud.p.c.d(context, jSONObjectB.optString("dplk"))) {
            ...
            x4.a().a(new b(eVar, context, strOptString, str));
            if ("wanka".equals(eVar.c)) {
    ...
    static e a(Context context, String str, e eVar) {
        eVar.h = str;
        a = new LinkedList();
    ...
    static void b(Context context, JSONObject jSONObject, long j, g gVar) throws JSONException, ParseException, UnsupportedEncodingException {
    ...
    private static void a(Context context, JSONObject jSONObject, String str, String str2, String str3, g gVar) throws JSONException {
