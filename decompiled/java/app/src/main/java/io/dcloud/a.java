...
abstract class a extends io.dcloud.b implements IOnCreateSplashView, IKeyHandler {
    ...
    /* JADX INFO: renamed from: io.dcloud.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
    class RunnableC0023a implements Runnable {
        final /* synthetic */ Bundle a;

        /* JADX INFO: renamed from: io.dcloud.a$a$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        class RunnableC0024a implements Runnable {
            ...
            public void run() {
                ...
                a.this.onRuntimeCreate(runnableC0023a.a);
            }
        }
    ...
    class b implements ICallBack {
        ...
        /* JADX INFO: renamed from: io.dcloud.a$b$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        ...
        public Object onCallBack(int i, Object obj) {
            f4 f4Var = new f4(a.this.that);
            f4Var.b(a.this.getContext().getString(R.string.dcloud_common_tips));
            f4Var.a(a.this.getContext().getString(R.string.dcloud_ua_version_verify_fail_tips));
            f4Var.b(a.this.that.getString(android.R.string.ok), new ViewOnClickListenerC0025a());
            f4Var.show();
            f4Var.b((int) (((double) a.this.getResources().getDisplayMetrics().widthPixels) * 0.9d));
            f4Var.a(17);
            return null;
        }
    }
    ...
    class d implements ICallBack {
        ...
        /* JADX INFO: renamed from: io.dcloud.a$d$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        class C0026a implements ICallBack {
            final /* synthetic */ TextView[] a;

            C0026a(TextView[] textViewArr) {
                this.a = textViewArr;
            }
        ...
        class c implements IWebViewInstallListener {
            ...
            /* JADX INFO: renamed from: io.dcloud.a$d$c$a, reason: collision with other inner class name */
            /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        ...
        public Object onCallBack(int i, Object obj) {
            ...
            a aVar = a.this;
            Dialog dialogA = aVar.a(aVar, new C0026a(textViewArr));
            dialogA.show();
    ...
    class e implements ICallBack {
        ...
        /* JADX INFO: renamed from: io.dcloud.a$e$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        ...
        public Object onCallBack(int i, Object obj) {
            if (i == 0) {
                ...
                if (this.b) {
                    f4 f4Var = new f4(a.this.that);
                    f4Var.b(a.this.getContext().getString(R.string.dcloud_common_tips));
                    f4Var.a(a.this.getContext().getString(R.string.dcloud_x5_download_without_wifi));
                    f4Var.b(a.this.that.getString(R.string.dcloud_common_allow), new ViewOnClickListenerC0028a());
                    f4Var.a(a.this.that.getString(R.string.dcloud_common_no_allow), new b());
                    f4Var.show();
                } else {
    ...
    /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
    class h implements f3.b {
        h() {
        }

        @Override // io.dcloud.p.f3.b
        ...
        public void onDenied(String str) {
            ...
            if (str.equals(PermissionUtil.PMS_STORAGE)) {
                if (a.this.h != null && a.this.h.equals("once")) {
                    ...
                    a aVar = a.this;
                    handler.postDelayed(aVar.n, aVar.j);
                    return;
                }
    ...
    public void checkAndRequestStoragePermission() {
        String[] strArr;
        if (SDK.isUniMPSDK()) {
            new Handler().postDelayed(this.n, this.j);
            return;
        }
        String str = this.h;
        if (str == null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.n = new RunnableC0023a(bundle);
