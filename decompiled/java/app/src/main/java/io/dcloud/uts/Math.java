...
public final class Math {
    ...
    public static final Number clz32(Number x) {
        ...
        int iM623constructorimpl = UInt.m623constructorimpl(x.intValue());
        if (iM623constructorimpl == UInt.m623constructorimpl(0)) {
            return (Number) 32;
        }
        return Integer.valueOf(32 - NumberKt.toString((Number) Long.valueOf(((long) iM623constructorimpl) & InternalZipConstants.ZIP_64_SIZE_LIMIT), (Number) 2).length());
    }
