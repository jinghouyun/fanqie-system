...
/* JADX INFO: compiled from: UniCallbackWrapper.kt */
    ...
    public final java.lang.Object invoke(java.lang.Object... args) {
        ...
        if (this.holderFun != null) {
            ...
            if (method != null) {
                ...
                if (length == 1 && Intrinsics.areEqual("[Ljava.lang.Object;", method.getParameterTypes()[0].getName())) {
                    return method.invoke(this.holderFun, args);
                }
                return (args.length >= length && args.length <= length) ? method.invoke(this.holderFun, Arrays.copyOf(args, args.length)) : "";
            }
        }
