    ...
    public static Point getCR(int i, int i2) {
        ...
        try {
            ...
            try {
                ...
                Point cameraResolution2 = CameraConfigurationManager.getCameraResolution(parameters, new Point(i, i2));
                try {
                    cameraOpen.release();
                    ...
                    if (parameters2 == null) {
                        if (cameraOpen != null) {
                            try {
                                Camera.Parameters parameters3 = cameraOpen.getParameters();
                                parameters = parameters3;
                                cameraResolution = CameraConfigurationManager.getCameraResolution(parameters3, point);
                                cameraOpen.release();
                    ...
                    cameraResolution = CameraConfigurationManager.getCameraResolution(parameters2, point);
                    camera = cameraOpen;
                    if (camera != null) {
                        camera.release();
                    }
