...
/* JADX INFO: compiled from: UTSJSONObject.kt */
...
public class UTSJSONObject implements Iterable<String>, IUTSObject, LogSelfV2, IUTSSourceMap, KMappedMarker {
    ...
    public static final class Companion {
        ...
        /* JADX INFO: renamed from: assign, reason: collision with other method in class */
        public final /* synthetic */ <T> T m503assign(IUTSObject... input) {
            String strFromJson;
            Intrinsics.checkNotNullParameter(input, "input");
            ...
            if (Intrinsics.areEqual("String", java.lang.Object.class.getSimpleName())) {
                ...
                try {
                    ...
                    strFromJson = cacheParseGson.fromJson(jSONString, new TypeToken<T>() { // from class: io.dcloud.uts.UTSJSONObject$Companion$assign$$inlined$parseObjectType$1
                    }.getType());
                } catch (Exception e) {
    ...
    /* JADX INFO: renamed from: __$getOriginalPosition, reason: from getter */
    ...
    private final void initCacheField() throws IllegalAccessException {
    ...
    public UTSJSONObject(java.lang.Object obj) {
        ...
        if (!(obj instanceof JSONObject)) {
            ...
            for (java.util.Map.Entry<String, java.lang.Object> entry2 : ((UTSJSONObject) obj).toMap().entrySet()) {
                getDynamicJSONFields().put(entry2.getKey(), entry2.getValue());
            }
            return;
        }
        for (java.util.Map.Entry entry3 : ((java.util.Map) obj).entrySet()) {
    ...
    public final void forEach(Function1<java.lang.Object, Unit> action) {
        ...
        Iterator<java.util.Map.Entry<String, java.lang.Object>> it = toMap().entrySet().iterator();
        while (it.hasNext()) {
    ...
    public final void fillJSON(java.lang.Object json) {
        ...
        if (json instanceof JSONObject) {
            ...
            for (java.util.Map.Entry<String, java.lang.Object> entry : ((JSONObject) json).entrySet()) {
                Intrinsics.checkNotNullExpressionValue(entry, "next(...)");
                java.util.Map.Entry<String, java.lang.Object> entry2 = entry;
    ...
    public Map<String, java.lang.Object> toMap() throws IllegalAccessException {
    ...
    public java.util.Map<String, java.lang.Object> toLogMap() {
        ...
        if (get__$arrayContent() == null) {
            ...
            for (java.util.Map.Entry<String, java.lang.Object> entry : getDynamicJSONFields().entrySet()) {
    ...
    private final java.lang.Object wrapArrayItem(java.lang.Object item) {
        ...
        if (!(item instanceof JSONObject) && !(item instanceof String) && !(item instanceof Number) && !(item instanceof Boolean) && !(item instanceof Character) && item != null) {
            ...
            if (item instanceof UTSObject) {
                ...
                for (String str : uTSObject) {
                    jSONObject.put(str, wrapArrayItem(uTSObject.get(str)));
                }
                return jSONObject;
            }
        }
    ...
    public com.alibaba.fastjson.JSON toJSONObject() {
        JSONObject jSONObject = new JSONObject();
        for (java.util.Map.Entry<String, java.lang.Object> entry : toMap().entrySet()) {
            jSONObject.put(entry.getKey(), wrapArrayItem(entry.getValue()));
        }
        return jSONObject;
    }
    ...
    public final void mergeOther(UTSJSONObject other) {
        ...
        for (java.util.Map.Entry<String, java.lang.Object> entry : other.toMap().entrySet()) {
    ...
    public UTSArray<?> getArray(String key) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    public UTSArray<?> getArray(String key, UTSArray<?> def) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final /* synthetic */ <T> UTSArray<T> getArray_withType(String key) throws IllegalAccessException {
        String strStringify;
    ...
    public UTSJSONObject getJSON(String key) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        java.lang.Object objResolveKeyPath = resolveKeyPath(key);
    ...
    public UTSJSONObject getJSON(String key, UTSJSONObject def) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(def, "def");
    ...
    public String getString(String key, String def) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(def, "def");
    ...
    public Number getNumber(String key) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        java.lang.Object objResolveKeyPath = resolveKeyPath(key);
    ...
    public Number getNumber(String key, Number def) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(def, "def");
    ...
    public Boolean getBoolean(String key) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
        java.lang.Object objResolveKeyPath = resolveKeyPath(key);
    ...
    public boolean getBoolean(String key, boolean def) throws IllegalAccessException {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    public java.lang.Object resolveKeyPath(String key) throws IllegalAccessException {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final /* synthetic */ <T> UTSArray<T> getArray_withType_def(String key, UTSArray<T> def) throws IllegalAccessException {
        String strStringify;
        java.lang.Object objFromJson;
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(def, "def");
