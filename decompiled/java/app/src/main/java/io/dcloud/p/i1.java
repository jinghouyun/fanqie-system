...
public class i1 extends AbsMgr implements IMgr.FeatureEvent {
    private HashMap a;
    private HashMap b;
    private HashMap c;
    private HashMap d;
    ...
    HashMap d() {
        ...
        HashMap map = this.e;
        HashMap map2 = this.d;
        PdrUtil.loadProperties2HashMap(map2, this.b, this.a, BaseInfo.s_properties);
        Set<String> setKeySet = map2.keySet();
        if (setKeySet != null) {
            map = new HashMap(2);
            this.e = map;
            for (String str : setKeySet) {
                IBoot iBootB = g1.b(this, str);
                if (iBootB == null) {
                    try {
                        iBoot = (IBoot) Class.forName((String) map2.get(str)).newInstance();
                        try {
    ...
    IFeature b(String str, Activity activity) {
        ...
        if (iFeature2 == null) {
            ...
            if (iFeature2 == null) {
                if (str2 != null) {
                    try {
                        IFeature iFeatureA = g1.a(this, str);
                        if (iFeatureA == null) {
    ...
    private String a(IApp iApp, IWebview iWebview) {
        ...
        if (PermissionControler.checkPermission(iApp.obtainAppId(), IFeature.F_RUNTIME) || !iApp.manifestBeParsed()) {
            ...
            if (BaseInfo.ISAMU) {
                str = StringUtil.format(AbsoluteConst.JS_RUNTIME_VERSIONs, iApp.obtainAppVersionName(), "1.9.9.82650", iApp.obtainAppId(), strObtainConfigProperty);
            } else {
                str = StringUtil.format(AbsoluteConst.JS_RUNTIME_VERSIONs, AndroidResources.mApplicationInfo.versionName, "1.9.9.82650", iApp.obtainAppId(), strObtainConfigProperty);
            }
    ...
    private void b() {
        try {
            h1.a(Class.forName("io.dcloud.feature.d").getConstructor(Context.class).newInstance(getContext()));
