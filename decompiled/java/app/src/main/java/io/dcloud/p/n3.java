...
public class n3 implements SensorEventListener {
    String a;
    IWebview b;
    ...
    n3(IWebview iWebview, String str) {
        this.a = str;
        this.b = iWebview;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (type != 1) {
            if (type == 2) {
                ...
                float fRound = Math.round(fArr[0] * 100.0f) / 100.0f;
                float fRound2 = Math.round(sensorEvent.values[1] * 100.0f) / 100.0f;
                float fRound3 = Math.round(sensorEvent.values[2] * 100.0f) / 100.0f;
                this.k = true;
                a(fRound, fRound2, fRound3);
                return;
            }
        }
        if (this.k) {
        ...
        SensorManager.getRotationMatrix(this.j, null, fArr2, fArr3);
