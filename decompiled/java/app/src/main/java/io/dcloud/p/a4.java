    ...
    class a extends ClickableSpan {
        ...
        public void onClick(View view) {
            try {
                ...
                intent.setClass(a4.this.e, WebviewActivity.class);
                intent.putExtra("url", url);
                intent.setData(Uri.parse(url));
                intent.setAction("android.intent.action.VIEW");
                intent.setFlags(268435456);
                intent.putExtra("ANIM", "POP");
                a4.this.e.startActivity(intent, ActivityOptionsCompat.makeCustomAnimation(a4.this.e, R.anim.dcloud_pop_in, R.anim.dcloud_pop_in_out).toBundle());
