...
public class RecordView implements View.OnClickListener, Handler.Callback {
    ...
    private static String getRecordDatas0(Context context, String str, String str2) {
        ...
        return "address_work".equals(str2) ? AssistInputUtil.getWorkAddress(AdaWebview.sCustomeizedInputConnection.mWebview.getContext()) : getRecordDatas(context, str, Utils.convertInt(str2));
    }
