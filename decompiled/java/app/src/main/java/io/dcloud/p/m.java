...
public abstract class m {
    ...
    public static void c(Context context, String str) {
        ...
        e4.a(context, AolSplashUtil.showCountADReward, "_is_gm_channel", str);
    }
    ...
    public static boolean f(Context context) {
        if (a == null) {
            a = Boolean.valueOf("1".equals(e4.a(context, AolSplashUtil.showCountADReward, "_is_gm_channel")));
        }
    ...
    public static String c(Context context) {
        return e4.a(context, AolSplashUtil.showCountADReward, "servertime");
    }

    public static void a(Context context, String str, String str2) {
        JSONObject jSONObject;
        String strA = e4.a(context, AolSplashUtil.showCountADReward, str);
        try {
            ...
            e4.a(context, AolSplashUtil.showCountADReward, str, jSONObject.toString());
    ...
    public static void a(Context context, String str) {
        e4.a(context, AolSplashUtil.showCountADReward, "servertime", str);
    }
    ...
    public static List a(Context context, List list, String str, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        String strOptString;
        int iOptInt;
        c3.a(String.valueOf(str) + "---STA---" + list.toString());
        ...
        c3.a(String.valueOf(str) + "---PRE---" + list.toString());
        if (jSONObject2 != null && jSONObject2.length() > 0 && list.size() > 1) {
            try {
                jSONObject3 = new JSONObject(e4.a(context, AolSplashUtil.showCountADReward, str));
        ...
        c3.a(String.valueOf(str) + "---AFT---" + list.toString());
        return list;
    }
    ...
    private static b a(ArrayList arrayList, int i) {
        double dRandom = Math.random() * ((double) i);
