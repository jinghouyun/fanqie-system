...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet m428clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.m428clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM429clone = node.m429clone();
            map.put(node, nodeM429clone);
            animatorSet.mNodes.add(nodeM429clone);
            animatorSet.mNodeMap.put(nodeM429clone.animation, nodeM429clone);
            ArrayList arrayList = null;
            nodeM429clone.dependencies = null;
            nodeM429clone.tmpDependencies = null;
            nodeM429clone.nodeDependents = null;
            nodeM429clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM429clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m429clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.m428clone();
                return node;
