...
public class u extends k4 {
    ...
    public void w() {
        ...
        this.P = jElapsedRealtime + ((long) i);
        this.S = true;
    }

    @Override // io.dcloud.p.k4
    ...
    @Override // io.dcloud.p.y4, io.dcloud.p.b5, io.dcloud.p.w
    protected void c(List list) {
        super.c(list);
    }

    @Override // io.dcloud.p.k4, io.dcloud.p.i4
    protected int c() {
        if (this.L) {
            return 3;
        }
    ...
    class a extends k4.b {
        ...
        @Override // io.dcloud.p.k4.b, io.dcloud.p.b0.b
        ...
        @Override // io.dcloud.p.k4.b, io.dcloud.p.b0.b, io.dcloud.p.b0.a
    ...
    public /* synthetic */ void c(RelativeLayout relativeLayout, FrameLayout.LayoutParams layoutParams) {
        ...
        if (w2Var instanceof j4) {
            ((j4) w2Var).redBag(relativeLayout, layoutParams);
        }
    }
