    ...
    private void initTextData() {
        ...
        try {
            ...
            if (strOptString10.equals("right")) {
                ...
                this.mFontCX = rectF3.left + (((int) (rectF3.width() - fontlength)) / 2);
                RectF rectF4 = this.mTextRect;
                this.mFontCY = rectF4.top + (((int) (rectF4.height() - fontHeight)) / 2);
            }
    ...
    public void runClearAnimation(final int i, final int i2) {
        postDelayed(new Runnable() { // from class: io.dcloud.common.adapter.ui.FrameBitmapView.1
            ...
            public void run() {
                ...
                FrameBitmapView.this.mCutRectF = new RectF(0.0f, (height / i) * FrameBitmapView.this.mCutIndex, FrameBitmapView.this.mNativeBitmap.getBitmap().getWidth(), height);
                FrameBitmapView.this.invalidate();
                int i3 = FrameBitmapView.this.mCutIndex;
                int i4 = i;
                if (i3 < i4) {
                    FrameBitmapView.this.runClearAnimation(i4, i2);
