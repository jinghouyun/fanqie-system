...
/* JADX INFO: compiled from: UTSAndroid.kt */
...
public final class UTSAndroid {
    ...
    public final /* synthetic */ <T extends UTSJSONObject> T parseObject(UTSJSONObject opts) {
        ...
        for (KProperty1 kProperty1 : KClasses.getMemberProperties(orCreateKotlinClass)) {
            ...
            KProperty1 kProperty2 = (KProperty1) next;
            if (kProperty2 != null) {
                if (Intrinsics.areEqual(kProperty1.getGetter().getReturnType().getClassifier(), Reflection.getOrCreateKotlinClass(UTSCallback.class))) {
                    if (kProperty1 instanceof KMutableProperty1) {
                        ...
                        V vCall = kProperty2.getGetter().call(opts);
                        Intrinsics.checkNotNull(vCall);
                        setter.call(t, new UTSCallback(vCall));
                    }
                } else if (kProperty1 instanceof KMutableProperty1) {
                    ((KMutableProperty1) kProperty1).getSetter().call(t, kProperty2.getGetter().call(opts));
                }
            }
        }
        return t;
    ...
    public final Activity getUniActivity() {
        ...
        return iWebviewFindWebview.getActivity();
    }
    ...
    /* JADX INFO: renamed from: typeof-ExVfyTY, reason: not valid java name */
    public final String m497typeofExVfyTY(UInt value) {
        if (value == null) {
            return "object";
        }
        return "UInt";
    ...
    /* JADX INFO: renamed from: typeof-3swpYEE, reason: not valid java name */
    public final String m495typeof3swpYEE(UByte value) {
        if (value == null) {
            return "object";
        }
        return "UByte";
    ...
    /* JADX INFO: renamed from: typeof-ffyZV3s, reason: not valid java name */
    public final String m498typeofffyZV3s(UShort value) {
        if (value == null) {
            return "object";
        }
        return "UShort";
    ...
    /* JADX INFO: renamed from: typeof-ADd3fzo, reason: not valid java name */
    public final String m496typeofADd3fzo(ULong value) {
        if (value == null) {
            return "object";
        }
        return "ULong";
    ...
    public final int getWindowHeight() {
        ...
        java.lang.Object objDispatchEvent = EntryProxy.getInstnace().getCoreHandler().dispatchEvent(IMgr.MgrType.AppMgr, 28, BaseInfo.sDefaultBootApp);
        Intrinsics.checkNotNull(objDispatchEvent, "null cannot be cast to non-null type io.dcloud.common.DHInterface.IApp");
        int iRoundToInt = MathKt.roundToInt(((IApp) objDispatchEvent).getInt(1) / getScale());
    ...
    public final int getWindowWidth() {
        java.lang.Object objDispatchEvent = EntryProxy.getInstnace().getCoreHandler().dispatchEvent(IMgr.MgrType.AppMgr, 28, BaseInfo.sDefaultBootApp);
        Intrinsics.checkNotNull(objDispatchEvent, "null cannot be cast to non-null type io.dcloud.common.DHInterface.IApp");
        return Math.ceil(Float.valueOf(((IApp) objDispatchEvent).getInt(0) / getScale())).intValue();
    }
    ...
    /* JADX INFO: renamed from: io.dcloud.uts.UTSAndroid$dispatchAsync$1, reason: invalid class name */
    /* JADX INFO: compiled from: UTSAndroid.kt */
    ...
    /* JADX INFO: renamed from: io.dcloud.uts.UTSAndroid$dispatchAsync$2, reason: invalid class name */
    /* JADX INFO: compiled from: UTSAndroid.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 2, 0}, xi = 48)
    ...
    /* JADX INFO: renamed from: io.dcloud.uts.UTSAndroid$dispatchAsync$3, reason: invalid class name */
    /* JADX INFO: compiled from: UTSAndroid.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 2, 0}, xi = 48)
    ...
    private final void initUTSHooksClassArray(Application application) {
        try {
