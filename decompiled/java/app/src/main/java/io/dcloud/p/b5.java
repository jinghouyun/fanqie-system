...
public class b5 extends w implements AOLLoader.VAOLInteractionListener {
    ...
    public static /* synthetic */ void b(w2 w2Var) {
        if (w2Var != null) {
            w2Var.onError(-5021, AOLErrorUtil.getErrorMsg(-5021), null);
        }
    }
    ...
    protected void a(final int i, final String str, final JSONArray jSONArray) {
        ...
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda12
    ...
    protected void c(final List list) {
        this.t = null;
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.d(list);
            }
    ...
    public void onClick() {
        a(a(), this.t);
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m();
            }
        ...
        g4.a(activityA, z, sb.toString());
    }

    @Override // io.dcloud.sdk.core.interfaces.AOLLoader.VAOLInteractionListener
    public void onClose() {
        this.v = false;
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.n();
            }
    ...
    public void onShow() {
        ...
        this.v = true;
        b(a(), this.t);
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.o();
            }
    ...
    public void onShowError(final int i, final String str) {
        this.v = false;
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.d(i, str);
            }
    ...
    public void onSkip() {
        this.v = false;
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.p();
            }
    ...
    public void onVideoPlayEnd() {
        this.v = false;
        MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.q();
            }
    ...
    public /* synthetic */ void d(List list) {
        ...
        w2 w2Var2 = this.s;
        if (w2Var2 != null) {
            w2Var2.onError(-5005, AOLErrorUtil.getErrorMsg(-5005), null);
        }
    }
    ...
    public void b(final AOLLoader.RequestConvertResultListener requestConvertResultListener) {
        ...
        if (dCBaseAOL != null) {
            ...
            MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void a(Activity activity) {
        if (this.u) {
            MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.r();
                }
    ...
    public void a(DCloudAOLSlot dCloudAOLSlot, final w2 w2Var) {
        if (this.v) {
            MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    b5.b(w2Var);
                }
        ...
        if (this.w) {
            MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    b5.a(w2Var);
                }
    ...
    public static /* synthetic */ void a(w2 w2Var) {
        if (w2Var != null) {
            w2Var.onError(-5017, AOLErrorUtil.getErrorMsg(-5017), null);
        }
    }
    ...
    public void a(final AOLLoader.GetConvertResultListener getConvertResultListener) {
        ...
        if (dCBaseAOL != null) {
            ...
            MainHandlerUtil.getMainHandler().post(new Runnable() { // from class: io.dcloud.p.b5$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
