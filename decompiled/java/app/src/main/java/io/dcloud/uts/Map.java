...
public class Map<K, V> extends LinkedHashMap<K, V> implements UTSValueIterable<UTSArray<java.lang.Object>> {
    ...
    public final /* bridge */ Set<java.util.Map.Entry<K, V>> entrySet() {
        return (Set<java.util.Map.Entry<K, V>>) getEntries();
    }

    public /* bridge */ Set<java.util.Map.Entry<java.lang.Object, java.lang.Object>> getEntries() {
