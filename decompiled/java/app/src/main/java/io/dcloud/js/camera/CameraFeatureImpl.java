...
public class CameraFeatureImpl implements IFeature {
    ...
    class b extends PermissionUtil.StreamPermissionRequest {
        ...
        class a implements ISysEventListener {
            ...
            a(String str, io.dcloud.js.camera.a.C0065a c0065a, String str2) {
                this.a = str;
                this.b = c0065a;
                this.c = str2;
            }
                    ...
                    if (iIntValue2 != -1) {
                        ...
                        try {
                            if (this.b.h) {
                                ...
                                dialogA.show();
                                MediaTranscoder.getInstance().transcodeVideo(this.a, this.c, MediaFormatStrategyPresets.createAndroid720pStrategy(2, 1.0d), new C0064a(dialogA));
                            } else {
        ...
        public void onGranted(String str) {
            String str2;
            try {
                io.dcloud.js.camera.a.C0065a c0065aA = io.dcloud.js.camera.a.a(this.a[1], false);
                String strConvert2AbsFullPath = this.b.convert2AbsFullPath(this.c.obtainFullUrl(), c0065aA.a());
                ...
                this.b.registerSysEventListener(new a(str2, c0065aA, strConvert2AbsFullPath), ISysEventListener.SysEventType.onActivityResult);
                Intent intent = new Intent("android.media.action.VIDEO_CAPTURE");
                if (c0065aA.b() != 0) {
                    intent.putExtra("android.intent.extra.durationLimit", c0065aA.b());
                }
    ...
    public String execute(IWebview iWebview, String str, String[] strArr) {
        ...
        if (str.equals("captureImage")) {
            io.dcloud.js.camera.a.C0065a c0065aA = io.dcloud.js.camera.a.a(strArr[1], true);
            String strConvert2AbsFullPath = iAppObtainApp.convert2AbsFullPath(iWebview.obtainFullUrl(), c0065aA.a());
            ...
            a aVar = new a(iAppObtainApp, iWebview, str2, strConvert2AbsFullPath, c0065aA, iAppObtainApp);
            if (this.b) {
                this.c.add(aVar);
                return null;
            }
    ...
    class a extends PermissionUtil.StreamPermissionRequest {
        ...
        final /* synthetic */ String b;
        final /* synthetic */ String c;
        final /* synthetic */ io.dcloud.js.camera.a.C0065a d;
        final /* synthetic */ IApp e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(IApp iApp, IWebview iWebview, String str, String str2, io.dcloud.js.camera.a.C0065a c0065a, IApp iApp2) {
            super(iApp);
            this.a = iWebview;
            this.b = str;
            this.c = str2;
        ...
        public void onGranted(String str) {
            try {
                ...
                this.e.registerSysEventListener(new C0059a(shareImageUri), ISysEventListener.SysEventType.onActivityResult);
        ...
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        class C0059a implements ISysEventListener {
            final /* synthetic */ DCFileUriData a;

            C0059a(DCFileUriData dCFileUriData) {
            ...
            public boolean onExecute(ISysEventListener.SysEventType sysEventType, Object obj) {
                ...
                if (sysEventType == ISysEventListener.SysEventType.onActivityResult && iIntValue == io.dcloud.js.camera.a.e) {
                    if (iIntValue2 == -1) {
                        ThreadPool.self().addThreadTask(new RunnableC0060a());
                    } else {
            ...
            class RunnableC0060a implements Runnable {
                ...
                class c implements ISysEventListener {
                    ...
                    class RunnableC0062a implements Runnable {
                        ...
                        @Override // java.lang.Runnable
                        public void run() {
                            a.this.e.getActivity().runOnUiThread(new RunnableC0063a());
                        }
                    }
                    ...
                    public boolean onExecute(ISysEventListener.SysEventType sysEventType, Object obj) {
                        ...
                        if (sysEventType == ISysEventListener.SysEventType.onActivityResult && iIntValue == io.dcloud.js.camera.a.g) {
                            if (iIntValue2 == -1) {
                                ThreadPool.self().addThreadTask(new RunnableC0062a());
                            } else {
                                String json = DOMException.toJSON(11, "resultCode is wrong");
                                a aVar = a.this;
                                Deprecated_JSUtil.execCallback(aVar.a, aVar.b, json, JSUtil.ERROR, true, false);
                ...
                public static /* synthetic */ void a(io.dcloud.js.camera.a.C0065a c0065a, String str, IApp iApp, final IWebview iWebview, final String str2, final String str3) {
                    if (c0065a.h) {
                    ...
                    iApp.getActivity().runOnUiThread(new Runnable() { // from class: io.dcloud.js.camera.CameraFeatureImpl$a$a$a$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            CameraFeatureImpl.a.C0059a.RunnableC0060a.a(iWebview, str2, str3);
                        }
                    });
                }
                ...
                public void run() {
                    ...
                    String strA;
                    DCFileUriData dCFileUriData = C0059a.this.a;
                    if (dCFileUriData.isReplace) {
                        if (DHFile.copyFile(dCFileUriData.fileReplacePath, dCFileUriData.filePath, true, false) != 1) {
                            a.this.e.getActivity().runOnUiThread(new RunnableC0061a());
                            return;
                        } else {
                            try {
                                DHFile.deleteFile(C0059a.this.a.fileReplacePath);
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                        }
                    ...
                    a aVar = a.this;
                    if (aVar.d.e) {
                        strA = io.dcloud.js.camera.b.a(c0059a.a.filePath);
                        ...
                        strConvert2RelPath = aVar.e.convert2RelPath(c0059a.a.filePath);
                        strA = C0059a.this.a.filePath;
                    }
                    ...
                    if (jSONObject == null || !jSONObject.has("width") || !a.this.d.g.has("height")) {
                        ...
                        a aVar2 = a.this;
                        final io.dcloud.js.camera.a.C0065a c0065a = aVar2.d;
                        ...
                        threadPoolSelf.addThreadTask(new Runnable() { // from class: io.dcloud.js.camera.CameraFeatureImpl$a$a$a$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                CameraFeatureImpl.a.C0059a.RunnableC0060a.a(c0065a, str, iApp, iWebview, str3, str2);
                            }
                        });
                        return;
                    }
                    Media media = new Media(C0059a.this.a.filePath, "", System.currentTimeMillis(), 1, 1L, -1001, new File(C0059a.this.a.filePath).getParent());
