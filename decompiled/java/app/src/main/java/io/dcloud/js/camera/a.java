...
class a {
    ...
    static C0065a a(String str, boolean z) {
        ...
        if (str != null) {
            ...
            c0065a.b = JSONUtil.getString(jSONObject, "resolution");
            ...
            c0065a.c = str2;
            c0065a.a = PdrUtil.getDefaultPrivateDocPath(string, str2);
            c0065a.d = JSONUtil.getInt(jSONObject, "index");
            if (jSONObject != null && jSONObject.has("optimize")) {
                c0065a.e = JSONUtil.getBoolean(jSONObject, "optimize");
            }
            if (jSONObject != null && jSONObject.has("videoMaximumDuration")) {
                c0065a.f = JSONUtil.getInt(jSONObject, "videoMaximumDuration");
            }
            if (jSONObject != null && jSONObject.has("crop")) {
                c0065a.g = jSONObject.optJSONObject("crop");
            }
            if (!z) {
                if (jSONObject != null && jSONObject.has("videoCompress")) {
                    c0065a.h = jSONObject.optBoolean("videoCompress", false);
                }
                ...
                if (strOptString.contains(Constants.Value.ORIGINAL) && strOptString.contains("compressed")) {
                    ...
                    c0065a.h = !strOptString.contains(Constants.Value.ORIGINAL);
                }
            }
        }
        return c0065a;
