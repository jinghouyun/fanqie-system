...
public class ADHandler {
    ...
    private static u3 handler = null;
    ...
    public static void analysisPullData(byte[] bArr, String str, IAolReceiver... iAolReceiverArr) throws JSONException {
        ...
        if (iOptInt != 0) {
            ...
            u3 u3Var2 = handler;
            if (u3Var2 != null) {
                u3Var2.a(-5007, jSONObject.optString("desc"));
                return;
            }
            return;
        }
        if (jSONObject.has("data")) {
            String strDecrypt = AESUtil.decrypt(e1.c(), e1.b(), Base64.decode(jSONObject.optString("data"), 2));
            if (strDecrypt != null) {
                try {
                    try {
        ...
        if ((str.equals("ThirdConfig") || str.equals("Splash")) && (u3Var = handler) != null) {
            u3Var.a(jSONObject);
        }
    }
    ...
    private static void exec5Plus(final List<HostPicker.Host> list, String str, final IAolReceiver[] iAolReceiverArr) {
        String strEncode;
        try {
            strEncode = URLEncoder.encode(Base64.encodeToString(AESUtil.encrypt(e1.c(), e1.b(), ZipUtils.zipString(str)), 2), "utf-8");
    ...
    public static void handleSplashAdEnable(Context context, Boolean bool) {
        u3 u3Var = handler;
        if (u3Var != null) {
            u3Var.a(context, bool.booleanValue() ? "1" : WXInstanceApm.VALUE_ERROR_CODE_DEFAULT);
        }
    }
    ...
    static void postSplashError(Context context, String str, String str2, JSONArray jSONArray) {
        ...
        map.put("pv", str3);
        map.put(ContextChain.TAG_INFRA, Base64.encodeToString(AESUtil.encrypt(e1.c(), e1.b(), ZipUtils.zipString(TelephonyUtil.getIMEI(context, true, true))), 2));
        map.put("md", Build.MODEL);
        map.put("vd", Build.MANUFACTURER);
        map.put(WXConfig.os, Integer.valueOf(Build.VERSION.SDK_INT));
        map.put("vb", PdrUtil.isEmpty("1.9.9.82650") ? "" : "1.9.9.82650");
    ...
    public static void pull(final Context context, String str, boolean z, List<HostPicker.Host> list, IAolReceiver... iAolReceiverArr) {
        ...
        t3.a(context, initConfig, new u3());
        ...
        String strA = SP.getsOrCreateBundle(context, e1.b("IlKgfnao")).a(e1.b("[xdi{`IlMfijdm"), AbsoluteConst.TRUE);
    ...
    static void pullRad(Context context, Map<String, Object> map, final IAolReceiver... iAolReceiverArr) {
        String strEncode;
        if (TextUtils.isEmpty(BaseInfo.sDefaultBootApp)) {
            BaseInfo.parseControl();
        }
        ...
        map2.put("vb", PdrUtil.isEmpty("1.9.9.82650") ? "" : "1.9.9.82650");
        ...
        map2.putAll(map);
        try {
            strEncode = URLEncoder.encode(Base64.encodeToString(AESUtil.encrypt(e1.c(), e1.b(), ZipUtils.zipString(new JSONObject(map2).toString())), 2), "utf-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            strEncode = null;
        }
    ...
    public static void pull(Context context, String str) {
        ArrayList arrayList = new ArrayList();
        for (String str2 : r1.c.keySet()) {
            HostPicker.Host.PriorityEnum priorityEnum = HostPicker.Host.PriorityEnum.BACKUP;
            int iIntValue = ((Integer) r1.c.get(str2)).intValue();
            if (iIntValue != -1) {
                if (iIntValue == 0) {
                    priorityEnum = HostPicker.Host.PriorityEnum.NORMAL;
                } else if (iIntValue == 1) {
    ...
    public static void pull(List<HostPicker.Host> list, final String str, final String str2, final boolean z, final IAolReceiver... iAolReceiverArr) {
        HostPicker.getInstance().pickSuitHost(DCLoudApplicationImpl.self().getContext(), list, str, new HostPicker.HostPickCallback() { // from class: io.dcloud.feature.gg.dcloud.ADHandler.4
            ...
            public void onNoOnePicked() {
                ...
                if (ADHandler.handler != null) {
                    u3 u3Var = ADHandler.handler;
                    String str5 = this.message[0];
                    u3Var.a(-5007, str5 != null ? str5 : "data invalid");
                }
            }
