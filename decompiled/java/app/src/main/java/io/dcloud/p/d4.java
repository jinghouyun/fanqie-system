...
class d4 {
    ...
    class a implements MessageHandler.IMessages {
        ...
        /* JADX INFO: renamed from: io.dcloud.p.d4$a$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: r8-map-id-605b2a5c8742184084f62a640225086eefcd9237ae25847375566b7136421843 */
        class C0069a implements ICallBack {
            C0069a() {
            }
            ...
            switch (str) {
                ...
                case "script":
                    ...
                    if ("restart".equals(str3)) {
                        d4.this.a.processEvent(IMgr.MgrType.AppMgr, 3, "snc:CID");
                    } else if (AbsoluteConst.JSON_KEY_DEBUG_REFRESH.equals(str3)) {
                        d4.this.a.processEvent(IMgr.MgrType.AppMgr, 27, null);
                    } else if ("restartAndRun".equals(str3)) {
                        d4.this.a.getContext().startActivity(Intent.makeRestartActivityTask(d4.this.a.getContext().getPackageManager().getLaunchIntentForPackage(d4.this.a.getContext().getPackageName()).getComponent()));
                ...
                case "update":
                    ...
                    if ("all".equals(str4)) {
                        d4.this.a.processEvent(IMgr.MgrType.WindowMgr, 13, null);
                    } else if ("current".equals(str4)) {
                        d4.this.a.processEvent(IMgr.MgrType.WindowMgr, 12, null);
                    } else {
                        d4.this.a.processEvent(IMgr.MgrType.WindowMgr, 14, str4);
                    }
                    d4.this.b.clear();
                    d4.this.a();
                    break;
