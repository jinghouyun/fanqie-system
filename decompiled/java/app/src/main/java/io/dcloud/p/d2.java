...
public class d2 implements c2 {
    ...
    public c2.a a(float f, float f2) {
        if (!c2.a.a(this.e, -48.0f, f, f2) || c2.a.a(this.e, 48.0f, f, f2)) {
            return null;
        }
        float[] fArrA = c2.a.a(this.e, 0.0f, 0.0f);
        float[] fArr = {f, f2};
        int i = 0;
    ...
    public void a(c2.a aVar, float f, float f2) {
        boolean z = this.v;
