...
public abstract class x3 {
    static HashMap a(Context context) {
        ...
        map.put("emu", d1.i().a(context) ? "1" : WXInstanceApm.VALUE_ERROR_CODE_DEFAULT);
    ...
    private static String b(Context context) {
        ...
        try {
            jSONObject.put("net", n4.c(context));
            jSONObject.put("device", n4.b(context));
