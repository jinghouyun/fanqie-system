...
public class a {
    ...
    class c extends Dialog {
        ...
        public void b() {
            ...
            int color4;
            int color5;
            this.d.setOnClickListener(new ViewOnClickListenerC0038a());
            ...
            if (a.this.g) {
                ...
                if (TextUtils.isEmpty(a.this.c.second.buttonRefuse)) {
                    ...
                    this.e.setOnClickListener(new ViewOnClickListenerC0039c());
                }
            } else {
        ...
        public void d() {
            ...
            if (this.a.getResources().getConfiguration().orientation == 1) {
                ...
                this.c.setMaxHeight((int) (((double) defaultDisplay.getHeight()) * 0.2d));
            }
        }
    ...
    private void a(SpannableStringBuilder spannableStringBuilder, URLSpan uRLSpan, e eVar) {
        spannableStringBuilder.setSpan(new C0037a(eVar, uRLSpan), spannableStringBuilder.getSpanStart(uRLSpan), spannableStringBuilder.getSpanEnd(uRLSpan), spannableStringBuilder.getSpanFlags(uRLSpan));
    }
