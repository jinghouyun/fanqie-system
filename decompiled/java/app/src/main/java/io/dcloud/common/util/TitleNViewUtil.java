...
public class TitleNViewUtil {
    ...
    public static void setButtons(ITitleNView iTitleNView, JSONObject jSONObject, IWebview iWebview) {
        ...
        if (iTitleNView != null && jSONObject.has("buttons")) {
            ...
            if (TextUtils.isEmpty(strOptString4)) {
                strOptString4 = jSONObject.optString("titlecolor");
            }
            String strChangeColorAlpha = changeColorAlpha(strOptString4, 1.0f);
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                while (i < jSONArrayOptJSONArray.length()) {
                    ...
                    String strOptString6 = jSONObjectOptJSONObject.optString(str4, "none");
                    String strOptString7 = jSONObjectOptJSONObject.optString("color");
                    String strOptString8 = jSONObjectOptJSONObject.optString("colorPressed");
                    String strOptString9 = jSONObjectOptJSONObject.optString("width");
                    String strOptString10 = jSONObjectOptJSONObject.optString("background", TRANSPARENT_BUTTON_BACKGROUND_COLOR);
                    if ("transparent".equals(strOptString5)) {
                        strOptString7 = TRANSPARENT_BUTTON_TEXT_COLOR;
                        strOptString8 = changeColorAlpha(TRANSPARENT_BUTTON_TEXT_COLOR, 0.3f);
                    } else if (TextUtils.isEmpty(strOptString7)) {
                        strOptString8 = changeColorAlpha(strChangeColorAlpha, 0.3f);
                        strOptString7 = strChangeColorAlpha;
                    } else if (TextUtils.isEmpty(strOptString8)) {
                        strOptString8 = changeColorAlpha(strOptString7, 0.3f);
                    }
                    if (jSONObjectOptJSONObject.has("__cb__")) {
                        JSONObject jSONObjectOptJSONObject2 = jSONObjectOptJSONObject.optJSONObject("__cb__");
                        strOptString = jSONObjectOptJSONObject2.optString("id");
                        jSONObjectOptJSONObject2.optString("htmlId");
                    } else if (jSONObjectOptJSONObject.has("onClick")) {
                        strOptString = jSONObjectOptJSONObject.optString("onClick");
                    } else {
                        if (jSONObjectOptJSONObject.has("onclick")) {
                            strOptString = jSONObjectOptJSONObject.optString("onclick");
                        } else {
                            str = null;
                        }
                        ...
                        String str5 = strChangeColorAlpha;
                        String str6 = str4;
                        int i2 = i;
                        if ("left".equals(jSONObjectOptJSONObject.optString("float"))) {
                            String strOptString11 = jSONObjectOptJSONObject.optString("text");
                            String strOptString12 = jSONObjectOptJSONObject.optString(AbsoluteConst.JSON_KEY_TITLE);
                            String strOptString13 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_WEIGHT);
                            String strOptString14 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_SIZE);
                            String strOptString15 = jSONObjectOptJSONObject.optString("fontSrc");
                            str3 = str2;
                            boolean zOptBoolean = jSONObjectOptJSONObject.optBoolean("redDot");
                            if (jSONObjectOptJSONObject.has("badgeText")) {
                                strOptString3 = jSONObjectOptJSONObject.optString("badgeText");
                            } else {
                                strOptString3 = null;
                            }
                            iTitleNView.addLeftButton(strOptString11, strOptString12, strOptString7, strOptString8, strOptString13, strOptString14, strOptString15, strOptString6, strOptString9, str, iWebview, str3, strOptString10, zOptBoolean, strOptString3, jSONObjectOptJSONObject.optBoolean("select", false), jSONObjectOptJSONObject.optString(Constants.Name.MAX_WIDTH));
                        } else {
                            str3 = str2;
                            String strOptString16 = jSONObjectOptJSONObject.optString("text");
                            String strOptString17 = jSONObjectOptJSONObject.optString(AbsoluteConst.JSON_KEY_TITLE);
                            String strOptString18 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_WEIGHT);
                            String strOptString19 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_SIZE);
                            String strOptString20 = jSONObjectOptJSONObject.optString("fontSrc");
                            boolean zOptBoolean2 = jSONObjectOptJSONObject.optBoolean("redDot");
                            if (jSONObjectOptJSONObject.has("badgeText")) {
                                strOptString2 = jSONObjectOptJSONObject.optString("badgeText");
                            } else {
                                strOptString2 = null;
                            }
                            iTitleNView.addRightButton(strOptString16, strOptString17, strOptString7, strOptString8, strOptString18, strOptString19, strOptString20, strOptString6, strOptString9, str, iWebview, str3, strOptString10, zOptBoolean2, strOptString2, jSONObjectOptJSONObject.optBoolean("select", false), jSONObjectOptJSONObject.optString(Constants.Name.MAX_WIDTH));
                        }
                        i = i2 + 1;
                        strOptString5 = str3;
                    ...
                    String str7 = strChangeColorAlpha;
                    String str8 = str4;
                    int i3 = i;
                    if ("left".equals(jSONObjectOptJSONObject.optString("float"))) {
                        String strOptString110 = jSONObjectOptJSONObject.optString("text");
                        String strOptString111 = jSONObjectOptJSONObject.optString(AbsoluteConst.JSON_KEY_TITLE);
                        String strOptString112 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_WEIGHT);
                        String strOptString113 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_SIZE);
                        String strOptString114 = jSONObjectOptJSONObject.optString("fontSrc");
                        str3 = str2;
                        boolean zOptBoolean3 = jSONObjectOptJSONObject.optBoolean("redDot");
                        if (jSONObjectOptJSONObject.has("badgeText")) {
                            strOptString3 = jSONObjectOptJSONObject.optString("badgeText");
                        } else {
                            strOptString3 = null;
                        }
                        iTitleNView.addLeftButton(strOptString110, strOptString111, strOptString7, strOptString8, strOptString112, strOptString113, strOptString114, strOptString6, strOptString9, str, iWebview, str3, strOptString10, zOptBoolean3, strOptString3, jSONObjectOptJSONObject.optBoolean("select", false), jSONObjectOptJSONObject.optString(Constants.Name.MAX_WIDTH));
                    } else {
                        str3 = str2;
                        String strOptString115 = jSONObjectOptJSONObject.optString("text");
                        String strOptString116 = jSONObjectOptJSONObject.optString(AbsoluteConst.JSON_KEY_TITLE);
                        String strOptString117 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_WEIGHT);
                        String strOptString118 = jSONObjectOptJSONObject.optString(Constants.Name.FONT_SIZE);
                        String strOptString21 = jSONObjectOptJSONObject.optString("fontSrc");
                        boolean zOptBoolean4 = jSONObjectOptJSONObject.optBoolean("redDot");
                        if (jSONObjectOptJSONObject.has("badgeText")) {
                            strOptString2 = jSONObjectOptJSONObject.optString("badgeText");
                        } else {
                            strOptString2 = null;
                        }
                        iTitleNView.addRightButton(strOptString115, strOptString116, strOptString7, strOptString8, strOptString117, strOptString118, strOptString21, strOptString6, strOptString9, str, iWebview, str3, strOptString10, zOptBoolean4, strOptString2, jSONObjectOptJSONObject.optBoolean("select", false), jSONObjectOptJSONObject.optString(Constants.Name.MAX_WIDTH));
                    }
                    i = i3 + 1;
                    strOptString5 = str3;
                    jSONArrayOptJSONArray = jSONArray2;
                    strChangeColorAlpha = str7;
                    str4 = str8;
                }
            }
        }
    ...
    public static void setTitleNViewButtonStyle(ITitleNView iTitleNView, String str, JSONObject jSONObject, IFrameView iFrameView) {
        ...
        if (jSONObject != null) {
            ...
            String strOptString11 = jSONObject.optString("color");
            String strOptString12 = jSONObject.optString("colorPressed");
            String strOptString13 = jSONObject.optString("width");
            String strOptString14 = jSONObject.optString("background");
            if (!PdrUtil.isEmpty(strOptString11) && PdrUtil.isEmpty(strOptString12)) {
                strOptString12 = changeColorAlpha(strOptString11, 0.3f);
            }
            String str4 = strOptString12;
            if (jSONObject.has("__cb__")) {
                ...
                if (!jSONObject.has("onClick")) {
                    ...
                    jSONObject2 = adaFrameItem.obtainFrameOptions().titleNView;
                    jSONArrayOptJSONArray = jSONObject2.optJSONArray("buttons");
                    if (jSONArrayOptJSONArray != null && i < jSONArrayOptJSONArray.length() && i >= 0 && (jSONObjectOptJSONObject = jSONArrayOptJSONArray.optJSONObject(i)) != null) {
                        strOptString9 = jSONObjectOptJSONObject.optString("width");
                    }
                    str3 = strOptString9;
                    strOptString2 = jSONObject.optString("text");
                    strOptString3 = jSONObject.optString(AbsoluteConst.JSON_KEY_TITLE);
                    strOptString4 = jSONObject.optString(Constants.Name.FONT_WEIGHT);
                    strOptString5 = jSONObject.optString(Constants.Name.FONT_SIZE);
                    strOptString6 = jSONObject.optString("fontSrc");
                    strOptString7 = null;
                    iWebviewObtainWebView = iFrameView.obtainWebView();
                    strOptString8 = jSONObject.optString("redDot");
                    if (jSONObject.has("badgeText")) {
                        strOptString7 = jSONObject.optString("badgeText");
                    }
                    if (iTitleNView.setTitleNViewButtonStyle(i, strOptString2, strOptString3, strOptString11, str4, strOptString4, strOptString5, strOptString6, strOptString10, str2, iWebviewObtainWebView, strOptString14, strOptString8, strOptString7, jSONObject.optString("select"), strOptString13, jSONObject2.optString("type"), jSONObject.optString(Constants.Name.MAX_WIDTH), str3) || jSONArrayOptJSONArray == null || i >= jSONArrayOptJSONArray.length() || i < 0) {
                        return;
                    }
            ...
            str2 = strOptString;
            AdaFrameItem adaFrameItem2 = (AdaFrameItem) iFrameView;
            jSONObject2 = adaFrameItem2.obtainFrameOptions().titleNView;
            jSONArrayOptJSONArray = jSONObject2.optJSONArray("buttons");
            if (jSONArrayOptJSONArray != null) {
                strOptString9 = jSONObjectOptJSONObject.optString("width");
            }
            ...
            if (iTitleNView.setTitleNViewButtonStyle(i, strOptString2, strOptString3, strOptString11, str4, strOptString4, strOptString5, strOptString6, strOptString10, str2, iWebviewObtainWebView, strOptString14, strOptString8, strOptString7, jSONObject.optString("select"), strOptString13, jSONObject2.optString("type"), jSONObject.optString(Constants.Name.MAX_WIDTH), str3)) {
            }
        }
    }
    ...
    public static boolean titleNViewStyleNoTitle(JSONObject jSONObject) {
        ...
        if (jSONObject.has("titleText")) {
            return TextUtils.isEmpty(jSONObject.optString("titleText"));
        }
        return jSONObject.has("titletext") && TextUtils.isEmpty(jSONObject.optString("titletext"));
    }
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x007f A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:27:0x0091 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:29:0x0097 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:31:0x00a5 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:33:0x00b2 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:34:0x00b7  */
    /* JADX WARN: Code duplicated, block: B:38:0x00c5 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:41:0x00d3 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:44:0x00db A[Catch: Exception -> 0x02d7, TRY_LEAVE, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:53:0x00f7 A[Catch: Exception -> 0x02d7, TRY_LEAVE, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:56:0x0109 A[Catch: Exception -> 0x02d7, TRY_ENTER, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:58:0x010f A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:61:0x011a  */
    /* JADX WARN: Code duplicated, block: B:64:0x0139  */
    /* JADX WARN: Code duplicated, block: B:67:0x0140 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    ...
    /* JADX WARN: Code duplicated, block: B:76:0x0170 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:86:0x019a A[PHI: r5
  0x019a: PHI (r5v7 java.lang.String) = (r5v6 java.lang.String), (r5v15 java.lang.String), (r5v6 java.lang.String) binds: [B:75:0x016e, B:82:0x018a, B:79:0x017a] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:89:0x01b2  */
    /* JADX WARN: Code duplicated, block: B:92:0x01b9 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:94:0x01bf A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:96:0x01cd A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:97:0x01d3 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    /* JADX WARN: Code duplicated, block: B:99:0x01d9 A[Catch: Exception -> 0x02d7, TryCatch #1 {Exception -> 0x02d7, blocks: (B:4:0x0010, B:6:0x0033, B:11:0x0044, B:13:0x0052, B:15:0x005b, B:17:0x0065, B:21:0x0071, B:26:0x007f, B:41:0x00d3, B:42:0x00d6, B:44:0x00db, B:51:0x00eb, B:50:0x00e8, B:53:0x00f7, B:56:0x0109, B:58:0x010f, B:60:0x0115, B:62:0x011b, B:65:0x013a, B:67:0x0140, B:69:0x0146, B:74:0x0162, B:76:0x0170, B:78:0x0176, B:80:0x017c, B:82:0x018a, B:83:0x018f, B:85:0x0195, B:87:0x019c, B:90:0x01b3, B:92:0x01b9, B:94:0x01bf, B:96:0x01cd, B:100:0x01dd, B:97:0x01d3, B:99:0x01d9, B:101:0x01e0, B:102:0x01e3, B:104:0x01f5, B:106:0x01fb, B:108:0x0201, B:110:0x0207, B:112:0x0215, B:116:0x0225, B:118:0x022c, B:120:0x023f, B:122:0x024a, B:124:0x0259, B:126:0x0272, B:129:0x0279, B:131:0x027f, B:133:0x0285, B:135:0x0293, B:139:0x02a9, B:143:0x02ba, B:145:0x02c5, B:146:0x02cd, B:142:0x02b6, B:136:0x029c, B:138:0x02a5, B:125:0x0268, B:121:0x0247, B:113:0x021b, B:115:0x0221, B:27:0x0091, B:29:0x0097, B:31:0x00a5, B:33:0x00b2, B:35:0x00b8, B:39:0x00c9, B:38:0x00c5, B:8:0x0039, B:10:0x003f, B:47:0x00e3, B:140:0x02b1), top: B:154:0x0010, inners: #0, #2 }] */
    public static void updateTitleNViewStatus(ITitleNView iTitleNView, IWebview iWebview, float f, JSONObject jSONObject, float f2) {
        ...
        int iChangeColorAlpha;
        String strChangeColorAlpha2;
        int iChangeColorAlpha2;
        float f5;
        String strChangeColorAlpha3;
        String strColor2Color;
        JSONObject jSONObjectOptJSONObject2;
        String strOptString3;
        String strChangeColorAlpha4;
        String strOptString4;
        String strColor2Color2;
        float f6;
        JSONArray jSONArrayOptJSONArray;
        int i;
        ...
        String strOptString5;
        String strOptString6;
        String strColor2Color3;
        String strOptString7;
        int iStringToColor;
        String strOptString8;
        String strChangeColorAlpha5;
        JSONObject jSONObjectOptJSONObject4;
        String strChangeColorAlpha6;
        String strOptString9;
        ...
        if (iTitleNView != null) {
            try {
                String strOptString14 = jSONObject.optString("backgroundColor");
                JSONObject jSONObject2 = new JSONObject(iTitleNView.getStatusBarColor());
                int iOptInt = jSONObject2.optInt("color");
                boolean zOptBoolean = jSONObject2.optBoolean("alpha");
                String strOptString15 = jSONObject.optString("titleColor");
                if (!jSONObject.has("titleColor")) {
                    if (!jSONObject.has("titlecolor")) {
                        str = strOptString15;
                        titleColor = iTitleNView.getTitleColor();
                        jSONObjectOptJSONObject = jSONObject.optJSONObject("splitLine");
                        if (jSONObjectOptJSONObject != null || Constants.Name.UNDEFINED.equals(jSONObjectOptJSONObject)) {
                            strOptString2 = null;
                        } else {
                            strOptString2 = jSONObjectOptJSONObject.optString("color");
                            if (!jSONObjectOptJSONObject.has("color") || "".equals(strOptString2)) {
                                strOptString2 = "#CCCCCC";
                            }
                        }
                        str2 = TextUtils.isEmpty(strOptString2) ? null : strOptString2;
                        if (f == 0.0f) {
                            f3 = f / f2;
                            if (f3 >= 1.0f) {
                                iChangeColorAlpha2 = changeColorAlpha(titleColor, 1.0f);
                                strChangeColorAlpha2 = changeColorAlpha(strOptString2, 1.0f);
                                strChangeColorAlpha = strOptString14;
                            } else {
                                f4 = 255.0f;
                                if (getColorAlpha(strOptString14) / 255.0f > f3) {
                                    strChangeColorAlpha = changeColorAlpha(strOptString14, f3);
                                } else {
                                    strChangeColorAlpha = strOptString14;
                                }
                                if (Color.alpha(iOptInt) / 255.0f <= f3 || zOptBoolean) {
                                    iOptInt = changeColorAlpha(iOptInt, f3);
                                }
                                iChangeColorAlpha = changeColorAlpha(titleColor, f3);
                                strChangeColorAlpha2 = changeColorAlpha(strOptString2, f3);
                            }
                            if (titleColor != iChangeColorAlpha) {
                                iTitleNView.setTitleColor(iChangeColorAlpha);
                            }
                            iTitleNView.setStatusBarColor(iOptInt);
                            if (str2 != null && !str2.equalsIgnoreCase(strChangeColorAlpha2)) {
                                if (jSONObjectOptJSONObject != null) {
                                    try {
                                        jSONObjectOptJSONObject.put("color", strChangeColorAlpha2);
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                }
                                setSplitLine(iTitleNView, iWebview, jSONObjectOptJSONObject, jSONObjectOptJSONObject, false, "");
                            }
                            if (strOptString14 != null) {
                                iTitleNView.setBackgroundColor(strChangeColorAlpha);
                            }
                            if (f == 0.0f) {
                                jSONObjectOptJSONObject6 = jSONObject.optJSONObject("backButton");
                                if (jSONObjectOptJSONObject6 == null && jSONObjectOptJSONObject6.has("background")) {
                                    strOptString13 = jSONObjectOptJSONObject6.optString("background");
                                } else {
                                    strOptString13 = TRANSPARENT_BUTTON_BACKGROUND_COLOR;
                                }
                                iTitleNView.setBackButtonColor(strOptString13, changeColorAlpha(TRANSPARENT_BUTTON_TEXT_COLOR, 1.0f), changeColorAlpha(TRANSPARENT_BUTTON_TEXT_COLOR, 0.3f));
                                ...
                                jSONArrayOptJSONArray3 = jSONObject.optJSONArray("buttons");
                                if (jSONArrayOptJSONArray3 != null) {
                                    for (i3 = 0; i3 < jSONArrayOptJSONArray3.length(); i3++) {
                                        jSONObjectOptJSONObject7 = jSONArrayOptJSONArray3.optJSONObject(i3);
                                        if (jSONObjectOptJSONObject7 != null) {
                                            iTitleNView.setButtonColorByIndex(i3, jSONObjectOptJSONObject7.optString("background", TRANSPARENT_BUTTON_BACKGROUND_COLOR), changeColorAlpha(TRANSPARENT_BUTTON_TEXT_COLOR, 1.0f), changeColorAlpha(TRANSPARENT_BUTTON_TEXT_COLOR, 0.3f));
                                        }
                                    }
                                    return;
                                }
                            ...
                            if (f2 <= f) {
                                strChangeColorAlpha5 = changeColorAlpha(str, 1.0f);
                                jSONObjectOptJSONObject4 = jSONObject.optJSONObject("backButton");
                                strChangeColorAlpha6 = changeColorAlpha(strChangeColorAlpha5, 0.3f);
                                if (jSONObjectOptJSONObject4 == null && (jSONObjectOptJSONObject4.has("color") || jSONObjectOptJSONObject4.has("colorPressed"))) {
                                    strOptString10 = jSONObjectOptJSONObject4.optString("color");
                                    strOptString9 = jSONObjectOptJSONObject4.optString("colorPressed");
                                    if (TextUtils.isEmpty(strOptString10)) {
                                        strChangeColorAlpha6 = changeColorAlpha(strChangeColorAlpha5, 0.3f);
                                        strOptString9 = strChangeColorAlpha6;
                                        strOptString10 = strChangeColorAlpha5;
                                    } else if (TextUtils.isEmpty(strOptString9)) {
                                        strOptString9 = changeColorAlpha(strOptString10, 0.3f);
                                    }
                                } else {
                                    strOptString9 = strChangeColorAlpha6;
                                    strOptString10 = strChangeColorAlpha5;
                                }
                                iTitleNView.setBackButtonColor("#00333333", strOptString10, strOptString9);
                                iTitleNView.setHomeButtonColor("#00333333", changeColorAlpha(strChangeColorAlpha5, 1.0f), changeColorAlpha(strChangeColorAlpha5, 0.3f));
                                jSONArrayOptJSONArray2 = jSONObject.optJSONArray("buttons");
                                if (jSONArrayOptJSONArray2 != null) {
                                    for (i2 = 0; i2 < jSONArrayOptJSONArray2.length(); i2++) {
                                        jSONObjectOptJSONObject5 = jSONArrayOptJSONArray2.optJSONObject(i2);
                                        if (jSONObjectOptJSONObject5 != null) {
                                            strOptString11 = jSONObjectOptJSONObject5.optString("color");
                                            strOptString12 = jSONObjectOptJSONObject5.optString("colorPressed");
                                            if (TextUtils.isEmpty(strOptString11)) {
                                                strOptString12 = changeColorAlpha(strChangeColorAlpha5, 0.3f);
                                                strOptString11 = strChangeColorAlpha5;
                                            } else if (TextUtils.isEmpty(strOptString12)) {
                                                strOptString12 = changeColorAlpha(strOptString11, 0.3f);
                                            }
                                            iTitleNView.setButtonColorByIndex(i2, "#00333333", strOptString11, strOptString12);
                                        }
                                    }
                                    return;
                                }
                            ...
                            f5 = f / f2;
                            strChangeColorAlpha3 = changeColorAlpha(str, 1.0f);
                            strColor2Color = color2Color(TRANSPARENT_BUTTON_TEXT_COLOR, strChangeColorAlpha3, f5);
                            jSONObjectOptJSONObject2 = jSONObject.optJSONObject("backButton");
                            if (jSONObjectOptJSONObject2 == null && jSONObjectOptJSONObject2.has("background")) {
                                strOptString3 = jSONObjectOptJSONObject2.optString("background");
                            } else {
                                strOptString3 = TRANSPARENT_BUTTON_BACKGROUND_COLOR;
                            }
                            strChangeColorAlpha4 = changeColorAlpha(strColor2Color, 0.3f);
                            if (jSONObjectOptJSONObject2 != null) {
                                strOptString8 = jSONObjectOptJSONObject2.optString("color");
                                strOptString4 = jSONObjectOptJSONObject2.optString("colorPressed");
                                if (TextUtils.isEmpty(strOptString8)) {
                                    strOptString4 = changeColorAlpha(strChangeColorAlpha3, 0.3f);
                                    strOptString8 = strChangeColorAlpha3;
                                } else if (TextUtils.isEmpty(strOptString4)) {
                                    strOptString4 = changeColorAlpha(strOptString8, 0.3f);
                                }
                                strColor2Color2 = color2Color(TRANSPARENT_BUTTON_TEXT_COLOR, strOptString8, f5);
                            } else {
                                strOptString4 = strChangeColorAlpha4;
                                strColor2Color2 = strColor2Color;
                            }
                            f6 = 1.0f - f5;
                            if (f6 < Color.alpha(Color.parseColor(strOptString3)) / f4) {
                                iTitleNView.setBackButtonColor(changeColorAlpha(strOptString3, f6), strColor2Color2, strOptString4);
                            } else {
                                iTitleNView.setBackButtonColor(strOptString3, strColor2Color2, strOptString4);
                            }
                            if (f6 < Color.alpha(Color.parseColor(TRANSPARENT_BUTTON_BACKGROUND_COLOR)) / f4) {
                                iTitleNView.setHomeButtonColor(changeColorAlpha(TRANSPARENT_BUTTON_BACKGROUND_COLOR, f6), strColor2Color, changeColorAlpha(strColor2Color, 0.3f));
                            } else {
                                iTitleNView.setHomeButtonColor(TRANSPARENT_BUTTON_BACKGROUND_COLOR, strColor2Color, changeColorAlpha(strColor2Color, 0.3f));
                            }
                            jSONArrayOptJSONArray = jSONObject.optJSONArray("buttons");
                            if (jSONArrayOptJSONArray != null) {
                                for (i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                                    jSONObjectOptJSONObject3 = jSONArrayOptJSONArray.optJSONObject(i);
                                    if (jSONObjectOptJSONObject3 != null) {
                                        strOptString5 = jSONObjectOptJSONObject3.optString("color");
                                        strOptString6 = jSONObjectOptJSONObject3.optString("colorPressed");
                                        if (TextUtils.isEmpty(strOptString5)) {
                                            strOptString6 = changeColorAlpha(strChangeColorAlpha3, 0.3f);
                                            strOptString5 = strChangeColorAlpha3;
                                        } else if (TextUtils.isEmpty(strOptString6)) {
                                            strOptString6 = changeColorAlpha(strOptString5, 0.3f);
                                        }
                                        strColor2Color3 = color2Color(TRANSPARENT_BUTTON_TEXT_COLOR, strOptString5, f5);
                                        strOptString7 = jSONObjectOptJSONObject3.optString("background", TRANSPARENT_BUTTON_BACKGROUND_COLOR);
                                        try {
                                            iStringToColor = Color.parseColor(strOptString7);
                                        } catch (Exception unused) {
                                            iStringToColor = PdrUtil.stringToColor(strOptString7);
                                        }
                                        if (f6 < Color.alpha(iStringToColor) / f4) {
                                            iTitleNView.setButtonColorByIndex(i, changeColorAlpha(strOptString7, f6), strColor2Color3, strOptString6);
                                        } else {
                                            iTitleNView.setButtonColorByIndex(i, strOptString7, strColor2Color3, strOptString6);
                                        }
                                    }
                                }
                            }
                        }
                        String strChangeColorAlpha7 = changeColorAlpha(strOptString14, 0.0f);
                        iOptInt = changeColorAlpha(iOptInt, 0.0f);
                        iChangeColorAlpha2 = changeColorAlpha(titleColor, 0.0f);
                        strChangeColorAlpha2 = changeColorAlpha(strOptString2, 0.0f);
                        strChangeColorAlpha = strChangeColorAlpha7;
                        iChangeColorAlpha = iChangeColorAlpha2;
                        f4 = 255.0f;
                        if (titleColor != iChangeColorAlpha) {
                            iTitleNView.setTitleColor(iChangeColorAlpha);
                        }
                ...
                if (f == 0.0f) {
                    ...
                    if (f3 >= 1.0f) {
                        ...
                        if (Color.alpha(iOptInt) / 255.0f <= f3) {
                            iOptInt = changeColorAlpha(iOptInt, f3);
                        } else {
                            iOptInt = changeColorAlpha(iOptInt, f3);
                        }
                ...
                String strChangeColorAlpha8 = changeColorAlpha(strOptString14, 0.0f);
                iOptInt = changeColorAlpha(iOptInt, 0.0f);
                iChangeColorAlpha2 = changeColorAlpha(titleColor, 0.0f);
                strChangeColorAlpha2 = changeColorAlpha(strOptString2, 0.0f);
                strChangeColorAlpha = strChangeColorAlpha8;
                iChangeColorAlpha = iChangeColorAlpha2;
                f4 = 255.0f;
                if (titleColor != iChangeColorAlpha) {
                    iTitleNView.setTitleColor(iChangeColorAlpha);
