        ...
        public /* synthetic */ void a(Activity activity) {
            ...
            try {
                if (i3 > i2) {
                    ...
                    DCKeyboardManager.this.keyBoardShowRunnable = new RunnableC0032a(i3);
        ...
        if (this.isAdjust && this.mDHAppRoot != null && this.mActivitySoftInputMode.equals(SOFT_INPUT_MODE_ADJUST_RESIZE) && (bVarH = this.mDHAppRoot.h()) != null) {
            ...
            try {
                ...
                if (this.isNativeUpDate) {
                    ...
                    float height2 = iArr[1] + this.mNativeView.getHeight() + this.mNaiveCursorSpacing;
    ...
    public void setHTMLInputRect(IWebview iWebview, String str) {
        try {
            if (this.isAdjust) {
                ...
                int[] iArr = new int[2];
                iFrameViewObtainFrameView.obtainWebView().obtainWindowView().getLocationOnScreen(iArr);
                ...
                float f = PdrUtil.parseFloat(jSONObject2.optString("top"), 0.0f, 0.0f, iWebview.getScale()) + PdrUtil.parseFloat(jSONObject2.optString("height"), 0.0f, 0.0f, iWebview.getScale()) + iArr[1];
                this.mHtmlInputFT = f;
                this.mFocusTop = f;
