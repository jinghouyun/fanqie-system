...
public class UEH {
    ...
    private static void commitBaseUncatchInfo(Context context, StringBuffer stringBuffer) {
        ...
        stringBuffer.append("&vb=1.9.9.82650");
    ...
    private static void commitErrorLog(final String str) {
        ThreadPool.self().addThreadTask(new Runnable() { // from class: io.dcloud.common.adapter.util.UEH.3
            ...
            public void run() {
                ...
                NetTool.httpPost(e1.b(Base64.decode2String("YHx8eHsyJydreiZsa2RnfWwmZm18JmtmJw==")) + "collect/crash", str, map);
            }
        });
    }
