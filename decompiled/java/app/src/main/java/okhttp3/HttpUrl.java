    ...
    public static final class Builder {
        ...
        private Builder addPathSegments(String str, boolean z) {
            ...
            while (true) {
                ...
                String str2 = str;
                boolean z2 = z;
                push(str2, i, iDelimiterOffset, iDelimiterOffset < str.length(), z2);
            ...
            if (iSlashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (bCharAt != 64) {
                        ...
                        if (!z) {
                            int iDelimiterOffset2 = Util.delimiterOffset(str4, i2, iDelimiterOffset, Operators.CONDITION_IF_MIDDLE);
                            ...
                            sb.append("%40");
                            str3 = str;
                            sb.append(HttpUrl.canonicalize(str3, i2, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null));
                ...
                if (i4 < iDelimiterOffset) {
                    ...
                    this.port = port;
                    if (port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i4, iDelimiterOffset) + '\"');
                    }
                } else {
                    this.host = canonicalizeHost(str2, i3, iPortColonOffset);
                ...
                if (this.host == null) {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i3, iPortColonOffset) + '\"');
                }
