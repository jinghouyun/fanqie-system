...
public class RequestPermissionListenerByJsProxy {
    ...
    public static final Unit onRequestByJs$lambda$0(UTSCallback uTSCallback, UTSArray<String> uTSArray) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onConfirmByJs$lambda$1(UTSCallback uTSCallback, UTSArray<String> uTSArray) {
        uTSCallback.invoke(uTSArray);
        return Unit.INSTANCE;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onCompleteByJs$lambda$2(UTSCallback uTSCallback, UTSArray<String> uTSArray) {
        uTSCallback.invoke(uTSArray);
        return Unit.INSTANCE;
    }
