...
public class ExitOptions extends UTSObject {
    ...
    public /* synthetic */ ExitOptions(Function1 function1, Function1 function2, Function1 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : function1, (i & 2) != 0 ? null : function2, (i & 4) != 0 ? null : function3);
    }
    ...
    public ExitOptions(Function1<? super ExitSuccess, Unit> function1, Function1<? super IExitError, Unit> function2, Function1<Object, Unit> function3) {
        this.success = function1;
        this.fail = function2;
