...
public class DiffUtil {
    ...
    private static Snake diffPartial(Callback callback, int i, int i2, int i3, int i4, int[] iArr, int[] iArr2, int i5) {
        ...
        int i13 = (i5 - i12) - 1;
        int i14 = i5 + i12 + 1;
        Arrays.fill(iArr3, i13, i14, 0);
        Arrays.fill(iArr2, i13 + i11, i14 + i11, i8);
        boolean z3 = i11 % 2 != 0;
        int i15 = 0;
        while (i15 <= i12) {
            int i16 = -i15;
            ...
            while (i17 <= i15) {
                if (i17 == i16) {
                    ...
                    if (i17 != i15) {
                        int i18 = i5 + i17;
                        if (iArr3[i18 - 1] < iArr3[i18 + i10]) {
                            i7 = iArr3[i5 + i17 + i10];
                            z2 = false;
                        }
                    }
                    i7 = iArr3[(i5 + i17) - i10] + i10;
                    z2 = true;
                }
                int i19 = i7 - i17;
                while (true) {
                    ...
                    if (!callback.areItemsTheSame(i + i7, i3 + i19)) {
                        break;
                    }
                    i7++;
                    i19++;
                ...
                int i20 = i5 + i17;
                iArr3[i20] = i7;
                if (z3 && i17 >= (i11 - i15) + 1 && i17 <= (i11 + i15) - 1 && i7 >= iArr2[i20]) {
                    Snake snake = new Snake();
                    snake.x = iArr2[i20];
                    snake.y = snake.x - i17;
                    snake.size = iArr3[i20] - iArr2[i20];
                    snake.removal = z2;
                    snake.reverse = false;
                    return snake;
                }
            ...
            for (int i21 = i16; i21 <= i15; i21 += 2) {
                ...
                for (int i24 = i6 - i22; i6 > 0 && i24 > 0 && callback.areItemsTheSame((i + i6) - 1, (i3 + i24) - 1); i24--) {
                    i6--;
                }
                int i25 = i5 + i22;
                iArr2[i25] = i6;
                if (!z3 && i22 >= i16 && i22 <= i15 && iArr[i25] >= i6) {
                    Snake snake2 = new Snake();
                    snake2.x = iArr2[i25];
                    snake2.y = snake2.x - i22;
                    snake2.size = iArr[i25] - iArr2[i25];
                    snake2.removal = z;
                    snake2.reverse = true;
                    return snake2;
                }
