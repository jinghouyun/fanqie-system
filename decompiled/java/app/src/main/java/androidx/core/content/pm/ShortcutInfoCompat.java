...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo.Builder intents = SearchView$$ExternalSyntheticApiModelOutline0.m5m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m6m((Object) it.next())).build());
        }
        return arrayList;
    }
