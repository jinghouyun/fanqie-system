    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m3m(it2.next())));
                }
            }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && SearchView$$ExternalSyntheticApiModelOutline0.m$1(parcelable)) {
                return IconCompat.createFromIcon(SearchView$$ExternalSyntheticApiModelOutline0.m7m((Object) parcelable));
            }
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey("time")) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m3m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m3m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (Build.VERSION.SDK_INT >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(SearchView$$ExternalSyntheticApiModelOutline0.m7m((Object) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m3m(it.next())));
                }
            }
        } else {
