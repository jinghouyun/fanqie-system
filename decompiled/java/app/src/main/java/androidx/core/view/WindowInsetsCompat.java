...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m98m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM98m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM98m = HalfKt$$ExternalSyntheticApiModelOutline0.m99m(windowInsets);
            } else {
                builderM98m = HalfKt$$ExternalSyntheticApiModelOutline0.m98m();
            }
            this.mPlatBuilder = builderM98m;
        }
