...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM1m = SearchView$$ExternalSyntheticApiModelOutline0.m1m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelM1m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM1m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelM1m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM2m = SearchView$$ExternalSyntheticApiModelOutline0.m2m((Object) it.next());
                if (Api26Impl.getId(notificationChannelGroupM2m).equals(str)) {
                    return notificationChannelGroupM2m;
                }
            }
        }
        return null;
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(SearchView$$ExternalSyntheticApiModelOutline0.m1m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM2m = SearchView$$ExternalSyntheticApiModelOutline0.m2m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM2m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM2m, notificationChannels));
                    }
                }
                return arrayList;
            }
