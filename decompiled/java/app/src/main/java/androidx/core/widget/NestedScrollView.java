...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        if (!zCanScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                if (viewFindNextFocus != null && viewFindNextFocus != this && viewFindNextFocus.requestFocus(SJISContextAnalysis.HIRAGANA_HIGHBYTE)) {
                    return true;
                }
            }
            return false;
    ...
    /* JADX WARN: Code duplicated, block: B:44:0x0060  */
    /* JADX WARN: Code duplicated, block: B:47:0x007e  */
    /* JADX WARN: Code duplicated, block: B:50:0x0084 A[ADDED_TO_REGION] */
