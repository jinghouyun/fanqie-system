...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = ColorKt$$ExternalSyntheticApiModelOutline0.m42m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (ColorKt$$ExternalSyntheticApiModelOutline0.m56m((Object) this.mText)) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m43m((Object) this.mText);
        }
        return null;
    }
