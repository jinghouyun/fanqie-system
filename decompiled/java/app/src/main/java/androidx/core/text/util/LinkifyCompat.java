...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            ...
            gatherLinks(arrayList, spannable2, PatternsCompat.AUTOLINK_WEB_URL, new String[]{DeviceInfo.HTTP_PROTOCOL, DeviceInfo.HTTPS_PROTOCOL, "rtsp://"}, Linkify.sUrlMatchFilter, null);
        } else {
            spannable2 = spannable;
        }
        if ((i & 2) != 0) {
