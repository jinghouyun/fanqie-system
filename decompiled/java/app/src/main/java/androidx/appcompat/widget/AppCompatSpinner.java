  ...
  0x004a: PHI (r11v7 android.content.res.TypedArray) = (r11v6 android.content.res.TypedArray), (r11v9 android.content.res.TypedArray) binds: [B:24:0x005b, B:15:0x0048] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && SearchView$$ExternalSyntheticApiModelOutline0.m19m((Object) spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter themedSpinnerAdapterM12m = SearchView$$ExternalSyntheticApiModelOutline0.m12m((Object) spinnerAdapter);
