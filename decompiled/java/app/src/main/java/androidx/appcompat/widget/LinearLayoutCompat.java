...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* JADX WARN: Code duplicated, block: B:154:0x0319  */
    /* JADX WARN: Code duplicated, block: B:64:0x0167 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:66:0x016a  */
    /* JADX WARN: Code duplicated, block: B:68:0x0170 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:204:0x0463  */
    void measureHorizontal(int i, int i2) {
                ...
                if (virtualChildAt.getVisibility() == 8) {
                    ...
                    if (mode == i14 && layoutParams.width == 0 && layoutParams.weight > 0.0f) {
                        ...
                        if (z5) {
                            ...
                            this.mTotalLength = Math.max(i18, i18 + measuredWidth + layoutParams.leftMargin + layoutParams.rightMargin + getNextLocationOffset(view));
                        }
                        if (z) {
                    ...
                    int iMax5 = Math.max(i3, measuredHeight);
                    ...
                    if (virtualChildAt2 == null) {
                        ...
                        if (virtualChildAt2.getVisibility() == 8) {
                            ...
                            if (z5) {
                                ...
                                f2 = f2;
                                int i25 = this.mTotalLength;
                                this.mTotalLength = Math.max(i25, i25 + iMax4 + layoutParams2.leftMargin + layoutParams2.rightMargin + getNextLocationOffset(virtualChildAt2));
                            }
                        }
                        childrenSkipCount2++;
                        f2 = f2;
        ...
        if (z7 || (i26 != 0 && f > 0.0f)) {
            ...
            while (i27 < i4) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (z5) {
                        ...
                        this.mTotalLength = Math.max(i29, virtualChildAt3.getMeasuredWidth() + i29 + layoutParams3.leftMargin + layoutParams3.rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
            ...
            int i33 = iArr3[1];
            iMax7 = (i33 == -1 && iArr3[0] == -1 && iArr3[2] == -1 && iArr3[3] == -1) ? iMax8 : Math.max(iMax8, Math.max(iArr3[3], Math.max(iArr3[0], Math.max(i33, iArr3[2]))) + Math.max(iArr4[3], Math.max(iArr4[0], Math.max(iArr4[1], iArr4[2]))));
