...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z3 = false;
        if ((sAlwaysOverrideConfiguration || i2 != i3) && !zIsActivityManifestHandlingUiMode && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z3 && i4 != i2 && z && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
