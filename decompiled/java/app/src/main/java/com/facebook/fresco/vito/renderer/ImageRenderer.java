...
public final class ImageRenderer {
    ...
    public final Function1<Canvas, Unit> createImageDataModelRenderCommand(ImageDataModel model, Shape shape, Paint paint, Matrix imageTransformation) {
        ...
        if (!(model instanceof BitmapImageDataModel)) {
            if (!(model instanceof ColorIntImageDataModel)) {
                ...
                return shape instanceof RectShape ? new C00991(drawableImageDataModel, imageTransformation, shape, paint) : new AnonymousClass2(drawableImageDataModel, paint, imageTransformation, shape);
            }
            paint.setColor(ColorUtils.INSTANCE.multiplyColorAlpha(((ColorIntImageDataModel) model).getColorInt(), paint.getAlpha()));
            return new C01001(shape, paint);
        }
    ...
    public static /* synthetic */ Function1 createRenderCommand$default(ImageRenderer imageRenderer, DrawableImageDataModel drawableImageDataModel, Shape shape, Paint paint, Matrix matrix, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(shape, "shape");
        Intrinsics.checkNotNullParameter(paint, "paint");
        return shape instanceof RectShape ? new C00991(drawableImageDataModel, matrix, shape, paint) : new AnonymousClass2(drawableImageDataModel, paint, matrix, shape);
    }
    ...
    public static final class C00991 implements Function1<Canvas, Unit> {
        ...
        public C00991(DrawableImageDataModel drawableImageDataModel, Matrix matrix, Shape shape, Paint paint) {
    ...
    /* JADX INFO: compiled from: ImageRenderer.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C01001 implements Function1<Canvas, Unit> {
        final /* synthetic */ Paint $paint;
        final /* synthetic */ Shape $shape;

        public C01001(Shape shape, Paint paint) {
            this.$shape = shape;
            this.$paint = paint;
        }
