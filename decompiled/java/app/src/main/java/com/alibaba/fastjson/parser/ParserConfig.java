...
public class ParserConfig {
    ...
    /* JADX WARN: Code duplicated, block: B:174:0x0318 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:176:0x031c A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:177:0x031e A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:178:0x0320  */
    /* JADX WARN: Code duplicated, block: B:181:0x0329 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:182:0x032b A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:183:0x032d  */
    /* JADX WARN: Code duplicated, block: B:184:0x0332  */
    /* JADX WARN: Code duplicated, block: B:186:0x033a  */
    /* JADX WARN: Code duplicated, block: B:205:0x03a6 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:215:0x03ca A[ADDED_TO_REGION] */
    ...
    public Class<?> checkAutoType(String str, Class<?> cls, int i) {
        ...
        if (this.autoTypeCheckHandlers != null) {
            ...
            while (it.hasNext()) {
                Class<?> clsHandler = it.next().handler(str, cls, i);
                if (clsHandler != null) {
                    return clsHandler;
                }
            }
        ...
        if (this.safeMode || (i & i2) != 0 || (i2 & JSON.DEFAULT_PARSER_FEATURE) != 0) {
            throw new JSONException("safeMode not support autoType : " + str);
        }
        int i3 = Feature.SupportAutoType.mask;
        boolean z3 = (!this.autoTypeSupport && (i & i3) == 0 && (JSON.DEFAULT_PARSER_FEATURE & i3) == 0) ? false : true;
        ...
        if ((jCharAt ^ ((long) strReplace.charAt(strReplace.length() - 1))) * TypeUtils.fnv1a_64_magic_prime == 655701488918567152L) {
            throw new JSONException("autoType is not support. " + str);
        }
        ...
        boolean z4 = Arrays.binarySearch(INTERNAL_WHITELIST_HASHCODES, jFnv1a_65) >= 0;
        if (this.internalDenyHashCodes != null) {
            long j = jCharAt2;
            int i4 = 3;
            while (i4 < strReplace.length()) {
                long j2 = jCharAt2;
                long jCharAt3 = (j ^ ((long) strReplace.charAt(i4))) * TypeUtils.fnv1a_64_magic_prime;
        ...
        if (!z4 && (z3 || z)) {
            long jCharAt4 = j3;
            int i5 = 3;
            while (i5 < strReplace.length()) {
                String str3 = str2;
                jCharAt4 = (((long) strReplace.charAt(i5)) ^ jCharAt4) * TypeUtils.fnv1a_64_magic_prime;
                if (Arrays.binarySearch(this.acceptHashCodes, jCharAt4) >= 0 && (clsLoadClass = TypeUtils.loadClass(str, this.defaultClassLoader, true)) != null) {
                    return clsLoadClass;
                }
                if (Arrays.binarySearch(this.denyHashCodes, jCharAt4) >= 0 && TypeUtils.getClassFromMapping(str) == null && Arrays.binarySearch(this.acceptHashCodes, jFnv1a_65) < 0) {
        ...
        if (cls == null && classFromMapping != null && Throwable.class.isAssignableFrom(classFromMapping) && !z3) {
        ...
        if (!z3) {
            int i6 = 3;
            while (i6 < strReplace.length()) {
                long jCharAt5 = (j3 ^ ((long) strReplace.charAt(i6))) * TypeUtils.fnv1a_64_magic_prime;
                if (Arrays.binarySearch(this.denyHashCodes, jCharAt5) >= 0) {
                    if (str.endsWith("Exception") || str.endsWith("Error")) {
                        return null;
                    }
                    throw new JSONException(str4 + str);
                }
                if (Arrays.binarySearch(this.acceptHashCodes, jCharAt5) >= 0) {
        ...
        try {
            try {
                String str5 = str.replace(Operators.DOT, '/') + ".class";
                ClassLoader classLoader = this.defaultClassLoader;
                if (classLoader != null) {
                    try {
                        resourceAsStream = classLoader.getResourceAsStream(str5);
                        ...
                        if (!z3) {
                            ...
                            classFromMapping = TypeUtils.loadClass(str, this.defaultClassLoader, z2);
                        } else {
                            if (z3) {
                                z2 = true;
                            } else {
                    ...
                    resourceAsStream = ParserConfig.class.getClassLoader().getResourceAsStream(str5);
                }
            ...
            if (classFromMapping == null) {
                ...
                if (classFromMapping != null && z3) {
                    TypeUtils.addMapping(str, classFromMapping);
                }
            } else if (zHasJsonType) {
                if (z3) {
                    TypeUtils.addMapping(str, classFromMapping);
                }
            } else {
                ...
                if (cls != null) {
                    ...
                    if (JavaBeanInfo.build(classFromMapping, classFromMapping, this.propertyNamingStrategy).creatorConstructor != null && z3) {
                        throw new JSONException(str4 + str);
                    }
                    if (!z3) {
                        if (str.endsWith("Exception")) {
