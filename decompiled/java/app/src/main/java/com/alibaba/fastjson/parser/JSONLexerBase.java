...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    public Collection<String> scanFieldStringArray(char[] cArr, Class<?> cls) {
        ...
        while (true) {
            if (cCharAt3 == '\"') {
                ...
                char cCharAt4 = charAt(this.bp + i4 + 3);
    ...
    /* JADX WARN: Code duplicated, block: B:52:0x00c4 A[ADDED_TO_REGION] */
        ...
        while (true) {
            ...
            if (cCharAt == ',') {
                ...
                if (cCharAt == ']') {
                    ...
                    if (cCharAt4 == '}') {
                        char cCharAt5 = charAt(this.bp + i13);
                        if (cCharAt5 == ',') {
                            this.token = 16;
                            this.bp += i + 1;
                            next();
    ...
    public final float[][] scanFieldFloatArray2(char[] cArr) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (cCharAt4 >= '0' && cCharAt4 <= '9') {
                    ...
                    int i16 = ((this.bp + i) - i12) - 1;
                    if (z2 || i16 >= 10) {
                        f = Float.parseFloat(subString(i12, i16));
                    } else {
                        f = i13 / i2;
                        if (z) {
                            f = -f;
                    ...
                    if (i10 >= fArr4.length) {
                        ...
                        System.arraycopy(fArr4, 0, fArr5, 0, i10);
                        fArr4 = fArr5;
                    }
                    i3 = i10 + 1;
                    fArr4[i10] = f;
            ...
            if (i3 != fArr4.length) {
                ...
                System.arraycopy(fArr4, 0, fArr6, 0, i3);
                fArr4 = fArr6;
            }
            if (i7 >= fArr3.length) {
                fArr3 = new float[(fArr3.length * 3) / 2][];
                System.arraycopy(fArr4, 0, fArr3, 0, i3);
            }
            int i18 = i7 + 1;
            fArr3[i7] = fArr4;
            if (cCharAt7 == ',') {
                cCharAt3 = charAt(this.bp + i17);
                i5 = i + 2;
            } else {
                if (cCharAt7 == ']') {
                    cCharAt3 = charAt(this.bp + i17);
        ...
        if (i7 != fArr3.length) {
            ...
            System.arraycopy(fArr3, 0, fArr7, 0, i7);
            fArr3 = fArr7;
        }
        if (cCharAt3 == ',') {
            this.bp += i5 - 1;
        ...
        if (cCharAt3 == '}') {
            char cCharAt8 = charAt(this.bp + i5);
            if (cCharAt8 == ',') {
                this.token = 16;
                this.bp += i5;
                next();
