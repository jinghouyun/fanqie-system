...
public class ASMDeserializerFactory implements Opcodes {
            ...
            if (cls == Byte.TYPE || cls == Short.TYPE || cls == Integer.TYPE) {
                ...
                if (cls == Byte.class) {
                    ...
                    if (Collection.class.isAssignableFrom(cls)) {
                        ...
                        _deserObject(context, methodWriter, fieldInfo, cls, i5);
                        i3 = i5;
                        methodWriter.visitVarInsn(25, context.var("lexer"));
    ...
    /* JADX WARN: Code duplicated, block: B:131:0x0ab8  */
    /* JADX WARN: Code duplicated, block: B:132:0x0acf  */
    private void _deserialze(ClassWriter classWriter, Context context) {
        ...
        String str7 = JSONLexerBase;
        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str7, BindingXConstants.KEY_TOKEN, "()I");
        ...
        if ((javaBeanInfo.parserFeatures & Feature.SupportArrayToBean.mask) == 0) {
            ...
            i = 4;
            methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str7, "isEnabled", "(II)Z");
        ...
        methodWriter2.visitMethodInsn(Opcodes.INVOKESPECIAL, context.className, "deserialzeArrayMapping", "(L" + str6 + ";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str7, "isEnabled", "(I)Z");
        Label label10 = new Label();
        ...
        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str7, "scanType", "(Ljava/lang/String;)I");
        ...
        methodWriter2.visitVarInsn(25, 1);
        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str6, "getContext", "()" + ASMUtils.desc((Class<?>) ParseContext.class));
        ...
        methodWriter2.visitVarInsn(25, 3);
        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str6, "setContext", Operators.BRACKET_START_STR + ASMUtils.desc((Class<?>) ParseContext.class) + "Ljava/lang/Object;Ljava/lang/Object;)" + ASMUtils.desc((Class<?>) ParseContext.class));
            ...
            if (cls3 == Boolean.TYPE) {
                ...
                if (cls3 == Byte.TYPE) {
                    ...
                    if (cls3 == Byte.class) {
                        ...
                        methodWriter2.visitFieldInsn(180, context.className, context.fieldName(fieldInfo3), "[C");
                        String str10 = JSONLexerBase;
                        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str10, "scanFieldInt", "([C)I");
                        ...
                        Label label19 = new Label();
                        methodWriter2.visitVarInsn(25, context.var("lexer"));
                        methodWriter2.visitFieldInsn(180, str10, str8, str9);
                        ...
                        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str11, "scanFieldInt", "([C)I");
                        methodWriter2.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Short", "valueOf", "(S)Ljava/lang/Short;");
                        methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                        Label label20 = new Label();
                        methodWriter2.visitVarInsn(25, context.var("lexer"));
                        methodWriter2.visitFieldInsn(180, str11, str8, str9);
                        methodWriter2.visitLdcInsn(5);
                        ...
                        Label label21 = new Label();
                        methodWriter2.visitVarInsn(25, context.var("lexer"));
                        methodWriter2.visitFieldInsn(180, str12, str8, str9);
                        methodWriter2.visitLdcInsn(5);
                        ...
                        methodWriter2.visitFieldInsn(180, context.className, context.fieldName(fieldInfo3), "[C");
                        String str13 = JSONLexerBase;
                        methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str13, "scanFieldLong", "([C)J");
                        methodWriter2.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Long", "valueOf", "(J)Ljava/lang/Long;");
                        methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                        Label label22 = new Label();
                        methodWriter2.visitVarInsn(25, context.var("lexer"));
                        methodWriter2.visitFieldInsn(180, str13, str8, str9);
                        methodWriter2.visitLdcInsn(5);
                        ...
                        if (cls3 == Float.class) {
                            ...
                            methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str14, "scanFieldFloat", "([C)F");
                            methodWriter2.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Float", "valueOf", "(F)Ljava/lang/Float;");
                            methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                            Label label23 = new Label();
                            methodWriter2.visitVarInsn(25, context.var("lexer"));
                            methodWriter2.visitFieldInsn(180, str14, str8, str9);
                            methodWriter2.visitLdcInsn(5);
                            ...
                            if (cls3 == Double.TYPE) {
                                ...
                                methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str15, "scanFieldDouble", "([C)D");
                                methodWriter2.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Double", "valueOf", "(D)Ljava/lang/Double;");
                                methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                                Label label24 = new Label();
                                methodWriter2.visitVarInsn(25, context.var("lexer"));
                                methodWriter2.visitFieldInsn(180, str15, str8, str9);
                                methodWriter2.visitLdcInsn(5);
                                ...
                                if (cls3 == String.class) {
                                    ...
                                    methodWriter2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "scanEnum", str5 + JSONLexerBase + ";[C" + ASMUtils.desc((Class<?>) ObjectDeserializer.class) + ")Ljava/lang/Enum;");
                                    ...
                                    if (collectionItemClass == String.class) {
                                        ...
                                        str3 = str5;
                                        label5 = label2;
                                        _deserialze_list_obj(context, methodWriter, label5, fieldInfo3, cls3, collectionItemClass, i7);
                                        i6 = i7;
                                        if (i6 == i2 - 1) {
                                            _deserialize_endCheck(context, methodWriter, label5);
                                        }
                                    }
                                } else {
                                    str = str8;
                                    ...
                                    label5 = label2;
                                    str3 = str5;
                                    _deserialze_obj(context, methodWriter, label5, fieldInfo3, cls3, i6);
                                    if (i6 == i2 - 1) {
                                        _deserialize_endCheck(context, methodWriter, label5);
                                    }
                                }
                                methodWriter2.visitVarInsn(25, context.var("lexer"));
                                str4 = JSONLexerBase;
                                methodWriter2.visitFieldInsn(180, str4, str8, str9);
                                ...
                                methodWriter2.visitVarInsn(54, context.var(str8));
                                methodWriter2.visitLdcInsn(-1);
                                label4 = label2;
        ...
        StringBuilder sb2 = new StringBuilder(str16);
        String str17 = DefaultJSONParser;
        sb2.append(str17);
        sb2.append(";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;I[I)Ljava/lang/Object;");
        methodWriter3.visitMethodInsn(Opcodes.INVOKEVIRTUAL, strType, "parseRest", sb2.toString());
        ...
        methodWriter3.visitVarInsn(25, 3);
        methodWriter3.visitVarInsn(21, 4);
        methodWriter3.visitMethodInsn(Opcodes.INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "deserialze", str16 + str17 + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        methodWriter3.visitInsn(176);
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int i) {
        ...
        Label label2 = new Label();
        String str3 = JSONLexerBase;
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str3, "matchField", "([C)Z");
        methodVisitor.visitJumpInsn(Opcodes.IFEQ, label2);
        _setFlag(methodVisitor, context, i);
        Label label3 = new Label();
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str3, BindingXConstants.KEY_TOKEN, "()I");
        methodVisitor.visitLdcInsn(8);
        methodVisitor.visitJumpInsn(Opcodes.IF_ICMPNE, label3);
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitLdcInsn(16);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str3, "nextToken", "(I)V");
        ...
        if (!zIsPrimitive2) {
            ...
            str = str3;
            str2 = "nextToken";
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str, str2, "(I)V");
        }
        methodVisitor.visitVarInsn(25, 1);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str4, "getContext", "()" + ASMUtils.desc((Class<?>) ParseContext.class));
        methodVisitor.visitVarInsn(58, context.var("listContext"));
        methodVisitor.visitVarInsn(25, 1);
        methodVisitor.visitVarInsn(25, context.var_asm(fieldInfo));
        methodVisitor.visitLdcInsn(fieldInfo.name);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str4, "setContext", "(Ljava/lang/Object;Ljava/lang/Object;)" + ASMUtils.desc((Class<?>) ParseContext.class));
        methodVisitor.visitInsn(87);
        Label label7 = new Label();
        Label label8 = new Label();
        methodVisitor.visitInsn(3);
        ...
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str, BindingXConstants.KEY_TOKEN, "()I");
        ...
        methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, ASMUtils.type(ObjectDeserializer.class), "deserialze", "(L" + str4 + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        methodVisitor.visitVarInsn(58, context.var("list_item_value"));
        ...
        methodVisitor.visitVarInsn(25, 1);
        methodVisitor.visitVarInsn(25, context.var_asm(fieldInfo));
        methodVisitor.visitMethodInsn(i2, str4, "checkListResolve", "(Ljava/util/Collection;)V");
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(i2, str, BindingXConstants.KEY_TOKEN, "()I");
        methodVisitor.visitLdcInsn(16);
        methodVisitor.visitJumpInsn(Opcodes.IF_ICMPNE, label7);
        if (zIsPrimitive2) {
            methodVisitor.visitVarInsn(25, context.var("lexer"));
            methodVisitor.visitVarInsn(21, context.var("fastMatchToken"));
            methodVisitor.visitMethodInsn(i2, str, str5, "(I)V");
        } else {
            _quickNextToken(context, methodVisitor, 12);
        }
        ...
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str4, "setContext", Operators.BRACKET_START_STR + ASMUtils.desc((Class<?>) ParseContext.class) + ")V");
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str, BindingXConstants.KEY_TOKEN, "()I");
        methodVisitor.visitLdcInsn(15);
        methodVisitor.visitJumpInsn(Opcodes.IF_ICMPNE, label);
