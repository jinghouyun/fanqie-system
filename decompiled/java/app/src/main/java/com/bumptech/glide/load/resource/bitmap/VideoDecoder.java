        ...
        try {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    UByte$$ExternalSyntheticBackport0.m((Object) mediaMetadataRetrieverBuild);
                } else {
            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < trackCount; i++) {
                        if (MediaFormatExtraConstants.MIMETYPE_VIDEO_VP8.equals(mediaExtractor2.getTrackFormat(i).getString("mime"))) {
