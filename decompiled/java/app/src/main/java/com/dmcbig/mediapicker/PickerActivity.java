...
public class PickerActivity extends FragmentActivity implements DataCallback, View.OnClickListener {
    ...
    public void m196lambda$done$2$comdmcbigmediapickerPickerActivity(final ArrayList<Media> arrayList) {
        final String str;
        ...
        if (next.extension.equalsIgnoreCase(".png") || next.extension.equalsIgnoreCase(".jpg") || next.extension.equalsIgnoreCase(".jpeg")) {
            String[] strArrSplit = next.path.split("/");
            String strCompressImage = CompressUtil.compressImage(next.path, this.docPath + "uniapp_temp/compressed/" + System.currentTimeMillis() + "_" + strArrSplit[strArrSplit.length - 1], next.extension.equalsIgnoreCase(".png"), this);
    ...
    /* JADX INFO: renamed from: lambda$fitAndroid16WindowInsets$0$com-dmcbig-mediapicker-PickerActivity, reason: not valid java name */
    ...
    /* JADX INFO: renamed from: lambda$permissionBar$1$com-dmcbig-mediapicker-PickerActivity, reason: not valid java name */
