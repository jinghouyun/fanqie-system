...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws ChecksumException, FormatException, NotFoundException {
        ...
        while (true) {
            ...
            DetectionResultRowIndicatorColumn rowIndicatorColumn2 = resultPoint != null ? getRowIndicatorColumn(bitMatrix, boundingBox2, resultPoint, true, i, i2) : detectionResultRowIndicatorColumn;
            ...
            if (i4 != 0 || detectionResultMerge.getBoundingBox() == null || (detectionResultMerge.getBoundingBox().getMinY() >= boundingBox.getMinY() && detectionResultMerge.getBoundingBox().getMaxY() <= boundingBox.getMaxY())) {
                ...
                detectionResultRowIndicatorColumn = rowIndicatorColumn2;
                break;
            }
        ...
        for (int i7 = 1; i7 <= barcodeColumnCount; i7++) {
            ...
            if (detectionResult.getDetectionResultColumn(i8) == null) {
                DetectionResultColumn detectionResultRowIndicatorColumn2 = (i8 == 0 || i8 == barcodeColumnCount) ? new DetectionResultRowIndicatorColumn(boundingBox, i8 == 0) : new DetectionResultColumn(boundingBox);
                detectionResult.setDetectionResultColumn(i8, detectionResultRowIndicatorColumn2);
                int i9 = -1;
                int iMin = i5;
                int iMax = i6;
                ...
                while (minY <= boundingBox.getMaxY()) {
                    ...
                    if (startColumn >= 0 && startColumn <= boundingBox.getMaxX()) {
                        ...
                        codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i3, minY, iMin, iMax);
