...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        int i12 = 1;
        int i13 = 1;
        return new Version[]{version, version2, version3, version4, version5, version6, version7, version8, version9, version10, version11, version12, version13, version14, new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(i9, 102))), new Version(16, 64, 64, 14, 14, new ECBlocks(i7, new ECB(i9, 140))), new Version(17, 72, 72, 16, 16, new ECBlocks(i5, new ECB(i10, 92))), new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(i10, 114))), new Version(19, 88, 88, 20, 20, new ECBlocks(i7, new ECB(i10, 144))), new Version(20, 96, 96, 22, 22, new ECBlocks(i8, new ECB(i10, 174))), new Version(21, LocationRequestCompat.QUALITY_LOW_POWER, LocationRequestCompat.QUALITY_LOW_POWER, 24, 24, new ECBlocks(i7, new ECB(i11, 136))), new Version(22, 120, 120, 18, 18, new ECBlocks(i8, new ECB(i11, 175))), new Version(23, 132, 132, 20, 20, new ECBlocks(i6, new ECB(i3, Opcodes.IF_ICMPGT))), new Version(24, 144, 144, 22, 22, new ECBlocks(i6, new ECB(i3, 156), new ECB(i9, 155))), new Version(25, 8, 18, 6, 16, new ECBlocks(7, new ECB(i12, 5))), new Version(26, 8, 32, 6, 14, new ECBlocks(11, new ECB(i12, 10))), new Version(27, 12, 26, 10, 24, new ECBlocks(14, new ECB(i13, 16))), new Version(28, 12, 36, 10, 16, new ECBlocks(18, new ECB(i13, 22))), new Version(29, 16, 36, 14, 16, new ECBlocks(24, new ECB(1, 32))), new Version(30, 16, 48, 14, 22, new ECBlocks(28, new ECB(1, 49)))};
    }
