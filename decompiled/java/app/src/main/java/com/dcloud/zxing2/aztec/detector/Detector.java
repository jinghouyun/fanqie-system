...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        this.compact = i == 5;
        ResultPoint[] resultPointArr = {new ResultPoint(point5.getX() + 0.5f, point5.getY() - 0.5f), new ResultPoint(point4.getX() + 0.5f, point4.getY() + 0.5f), new ResultPoint(point3.getX() - 0.5f, point3.getY() + 0.5f), new ResultPoint(point2.getX() - 0.5f, point2.getY() - 0.5f)};
