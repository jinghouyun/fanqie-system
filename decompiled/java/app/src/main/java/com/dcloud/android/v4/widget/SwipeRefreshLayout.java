    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet, boolean z) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: com.dcloud.android.v4.widget.SwipeRefreshLayout.7
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i + ((int) ((((int) fAbs) - i) * f))) - swipeRefreshLayout.mCircleView.getTop(), false);
            ...
            if (actionMasked != 0) {
                if (actionMasked == 1) {
                    ...
                    if (this.mIsBeingDragged) {
                        finishSpinner((y - this.mInitialMotionY) * 0.5f);
                        z = true;
                    } else {
                        z = false;
                    }
                    ...
                    if (f > this.mTouchSlop && !this.mIsBeingDragged && (Math.atan(Math.abs(x - this.mInitialDownX) / Math.abs(y2 - this.mInitialDownY)) * 180.0d) / 3.141592653589793d < 40.0d) {
                ...
                moveSpinner(this.mOriginalOffsetTop);
                this.mIsBeingDragged = false;
            } else {
