...
public class DCWXInput extends WXComponent<WXEditText> {
    ...
    /* JADX INFO: renamed from: com.taobao.weex.ui.component.DCWXInput$6, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-b4716a25f9920722ba6f2d7f7c6f40e43a654927e8ebe1c489894a7bc6a88ab4 */
        ...
        if (wXEditText != null && (wXEditText.getContext() instanceof Activity)) {
            getHostView().setkeyBoardHeightChangeListener(new DCEditText.OnKeyboardHeightChangeListener() { // from class: com.taobao.weex.ui.component.DCWXInput.14
                ...
                public void onChange(boolean z, int i) {
                    ...
                    DCWXInput dCWXInput = DCWXInput.this;
                    dCWXInput.keyboardHeight = (int) WXViewUtils.getWebPxByWidth(i, dCWXInput.getInstance().getInstanceViewPortWidthWithFloat());
    ...
    protected Object convertEmptyProperty(String str, Object obj) {
        ...
        return !str.equals(Constants.Name.FONT_SIZE) ? super.convertEmptyProperty(str, obj) : Integer.valueOf(getInstance().getDefaultFontSize());
    }
    ...
    public void setFontSize(String str) {
        ...
        HashMap map = new HashMap(1);
        map.put(Constants.Name.FONT_SIZE, str);
        getHostView().setTextSize(0, AbsStyle.getFontSize(map, getInstance().getDefaultFontSize(), getInstance().getInstanceViewPortWidthWithFloat()));
    }
        ...
        for (Map.Entry<String, Object> entry : this.placeholderStyle.entrySet()) {
            ...
            switch (key) {
                ...
                case "fontSize":
                    ...
                    if (strValueOf.endsWith("px")) {
                        strValueOf = strValueOf.replaceAll("px", "");
                    } else if (strValueOf.endsWith("wx")) {
                        strValueOf = strValueOf.replaceAll("wx", "");
                    }
                    HashMap map = new HashMap(1);
                    map.put(Constants.Name.FONT_SIZE, strValueOf);
                    absoluteSizeSpan = new AbsoluteSizeSpan(WXUtils.getInteger(Integer.valueOf(AbsStyle.getFontSize(map, getInstance().getDefaultFontSize(), getInstance().getInstanceViewPortWidthWithFloat())), Integer.valueOf(getInstance().getDefaultFontSize())).intValue());
                    break;
                case "textAlign":
                case "text-align":
