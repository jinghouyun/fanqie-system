            ...
            public void onKeyboardEvent(boolean z) {
                if (AbstractEditComponent.this.mListeningKeyboard) {
                    ...
                    if (z) {
                        ...
                        map.put("keyboardSize", Float.valueOf(WXViewUtils.getWebPxByWidth(WXViewUtils.getScreenHeight(context) - (rect.bottom - rect.top), AbstractEditComponent.this.getInstance().getInstanceViewPortWidthWithFloat())));
                    }
