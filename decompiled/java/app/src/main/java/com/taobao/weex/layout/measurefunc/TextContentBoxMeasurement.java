...
public class TextContentBoxMeasurement extends ContentBoxMeasurement {
    ...
    private void recalculateLayout(float f) {
        ...
        if (contentWidth > 0.0f) {
            ...
            Layout layoutCreateLayout = createLayout(contentWidth, this.layout);
            this.layout = layoutCreateLayout;
            this.previousWidth = layoutCreateLayout.getWidth();
        }
    }
    ...
    public void measureInternal(float f, float f2, int i, int i2) {
        ...
        if (textWidth <= 0.0f || this.spanned == null) {
            ...
            Layout layoutCreateLayout = createLayout(textWidth, null);
            this.layout = layoutCreateLayout;
            this.previousWidth = layoutCreateLayout.getWidth();
