        ...
        try {
            ...
            if (bArr != null) {
                if (sDKInstance2 == null || !(sDKInstance2.getRenderStrategy() == WXRenderStrategy.DATA_RENDER || sDKInstance2.getRenderStrategy() == WXRenderStrategy.DATA_RENDER_BINARY)) {
                    ...
                    try {
                        jSONArray2 = (JSONArray) JSON.parse(new String(bArr, "UTF-8"));
                    } catch (Exception unused) {
                        jSONArray2 = (JSONArray) WXWsonJSONSwitch.parseWsonOrJSON(bArr);
                    }
                }
            ...
            if (bArr2 == null) {
                if (jSONArray != null && (sDKInstance = WXSDKManager.getInstance().getSDKInstance(str)) != null && WXBridgeManager.BundType.Rax.equals(sDKInstance.bundleType)) {
                    ...
                    for (Object obj2 : jSONArray) {
                        if ((obj2 instanceof JSONObject) && ((JSONObject) obj2).containsKey("__weex_options__")) {
                            obj = ((JSONObject) obj2).get("__weex_options__");
                        }
                    }
                    if (obj instanceof JSONObject) {
                        jSONObject2 = (JSONObject) obj;
                    }
                    objCallNativeModule = WXBridgeManager.getInstance().callNativeModule(str, str2, str3, jSONArray, jSONObject);
                    if (sDKInstance2 != null) {
                        sDKInstance2.getApmForInstance().updateFSDiffStats(WXInstanceApm.KEY_PAGE_STATS_FS_CALL_NATIVE_NUM, 1.0d);
                        sDKInstance2.getApmForInstance().updateFSDiffStats(WXInstanceApm.KEY_PAGE_STATS_FS_CALL_NATIVE_TIME, WXUtils.getFixUnixTime() - fixUnixTime);
                    }
                    if (sDKInstance2 != null || (sDKInstance2.getRenderStrategy() != WXRenderStrategy.DATA_RENDER && sDKInstance2.getRenderStrategy() != WXRenderStrategy.DATA_RENDER_BINARY)) {
                        return WXWsonJSONSwitch.toWsonOrJsonWXJSObject(objCallNativeModule);
                    }
                    try {
                        if (objCallNativeModule == null) {
                            return new WXJSObject(null);
                        }
                        return objCallNativeModule.getClass() == WXJSObject.class ? (WXJSObject) objCallNativeModule : new WXJSObject(3, WXJsonUtils.fromObjectToJSONString(objCallNativeModule));
            ...
            jSONObject2 = (JSONObject) WXWsonJSONSwitch.parseWsonOrJSON(bArr2);
            jSONObject = jSONObject2;
            objCallNativeModule = WXBridgeManager.getInstance().callNativeModule(str, str2, str3, jSONArray, jSONObject);
            if (sDKInstance2 != null) {
                sDKInstance2.getApmForInstance().updateFSDiffStats(WXInstanceApm.KEY_PAGE_STATS_FS_CALL_NATIVE_NUM, 1.0d);
