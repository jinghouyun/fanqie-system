...
public class SimpleComponentHolder implements IFComponentHolder {
    ...
    public static class ClazzComponentCreator implements ComponentCreator {
        ...
        public WXComponent createInstance(WXSDKInstance wXSDKInstance, WXVContainer wXVContainer, BasicComponentData basicComponentData) {
            ...
            return length == 4 ? constructor.newInstance(wXSDKInstance, wXVContainer, Boolean.FALSE, basicComponentData) : constructor.newInstance(wXSDKInstance, wXVContainer, wXSDKInstance.getInstanceId(), Boolean.valueOf(wXVContainer.isLazy()));
        }
    }
