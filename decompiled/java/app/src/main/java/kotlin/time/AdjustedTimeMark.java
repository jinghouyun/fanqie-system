...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1922minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2042minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1921elapsedNowUwyO8pc() {
        return Duration.m1959minusLRDsOJo(this.mark.mo1921elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1924plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1960plusLRDsOJo(this.adjustment, duration), null);
    }
}
