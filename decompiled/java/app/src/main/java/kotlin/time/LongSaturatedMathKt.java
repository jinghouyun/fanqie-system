...
public final class LongSaturatedMathKt {
    ...
    public static final long m2034saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM1970toLongimpl = Duration.m1970toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2033checkInfiniteSumDefinedPjuGub4(j, j2, jM1970toLongimpl);
        }
        if (((jM1970toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2035saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM1970toLongimpl;
        if (((j ^ j3) & (jM1970toLongimpl ^ j3)) < 0) {
    ...
    private static final long m2033checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1956isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2035saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM1934divUwyO8pc = Duration.m1934divUwyO8pc(j2, 2);
        long jM1970toLongimpl = Duration.m1970toLongimpl(jM1934divUwyO8pc, durationUnit);
        return (1 | (jM1970toLongimpl - 1)) == Long.MAX_VALUE ? jM1970toLongimpl : m2034saturatingAddNuflL3o(m2034saturatingAddNuflL3o(j, durationUnit, jM1934divUwyO8pc), durationUnit, Duration.m1959minusLRDsOJo(j2, jM1934divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        Duration.Companion companion = Duration.INSTANCE;
        return j < 0 ? companion.m2021getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m2020getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1975unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m1960plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m1975unaryMinusUwyO8pc(infinityOfSign(j3));
        }
