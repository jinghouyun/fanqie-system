...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2029minusLRDsOJo(long duration) {
        return m2031plusLRDsOJo(Duration.m1975unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2030minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m1960plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2031plusLRDsOJo(long duration) {
        long jM1945getInWholeSecondsimpl = Duration.m1945getInWholeSecondsimpl(duration);
        int iM1947getNanosecondsComponentimpl = Duration.m1947getNanosecondsComponentimpl(duration);
        if (jM1945getInWholeSecondsimpl == 0 && iM1947getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM1945getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM1945getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM1947getNanosecondsComponentimpl);
        }
        return Duration.m1958isPositiveimpl(duration) ? MAX : MIN;
    }
}
