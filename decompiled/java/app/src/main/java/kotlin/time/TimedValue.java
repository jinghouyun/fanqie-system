...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2063copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2065copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m2065copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1936equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1952hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1971toStringimpl(this.duration)) + Operators.BRACKET_END;
    }
    ...
    public final long m2066getDurationUwyO8pc() {
        return this.duration;
    }
