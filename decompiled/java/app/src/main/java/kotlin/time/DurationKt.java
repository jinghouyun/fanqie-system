...
public final class DurationKt {
    ...
    private static final long m2028timesmvk6XK0(int i, long j) {
        return Duration.m1962timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2027timeskIfJnKk(double d, long j) {
        return Duration.m1961timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2022getZEROUwyO8pc = Duration.INSTANCE.m2022getZEROUwyO8pc();
        ...
        char c = Operators.CONDITION_IF_MIDDLE;
        char c2 = '0';
        if (cCharAt4 == 'P') {
            int i3 = length2 + 1;
            if (i3 == length) {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    int iIndexOf$default = StringsKt.indexOf$default((CharSequence) str2, Operators.DOT, 0, false, 6, (Object) null);
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1960plusLRDsOJo = Duration.m1960plusLRDsOJo(jM2022getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2022getZEROUwyO8pc = Duration.m1960plusLRDsOJo(jM1960plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2022getZEROUwyO8pc = Duration.m1960plusLRDsOJo(jM2022getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            char c3 = Operators.CONDITION_IF_MIDDLE;
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM2022getZEROUwyO8pc = Duration.INSTANCE.m2020getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str4, Operators.DOT, 0, false, 6, (Object) null);
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1960plusLRDsOJo2 = Duration.m1960plusLRDsOJo(jM2022getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2022getZEROUwyO8pc = Duration.m1960plusLRDsOJo(jM1960plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2022getZEROUwyO8pc = Duration.m1960plusLRDsOJo(jM2022getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m1975unaryMinusUwyO8pc(jM2022getZEROUwyO8pc) : jM2022getZEROUwyO8pc;
    }
    ...
    private static final long parseOverLongIsoComponent(String str) {
        ...
        return (!StringsKt.startsWith$default(str, Operators.PLUS, false, 2, (Object) null) || length <= 1 || '0' > (cCharAt = str.charAt(1)) || cCharAt >= ':') ? Long.parseLong(str) : Long.parseLong(StringsKt.drop(str, 1));
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1931constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1931constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1931constructorimpl((j << 1) + ((long) i));
    }
