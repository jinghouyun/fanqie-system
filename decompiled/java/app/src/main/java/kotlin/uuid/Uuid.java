...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m696boximpl(ULong.m702constructorimpl(getMostSignificantBits())), ULong.m696boximpl(ULong.m702constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2068toUByteArrayTcUX1vc() {
        return UByteArray.m599constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m702constructorimpl(j) ^ Long.MIN_VALUE, ULong.m702constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m702constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m702constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2070fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2069fromUByteArrayGBYM_sE(byte[] ubyteArray) {
