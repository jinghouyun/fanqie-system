...
public final class UNumbersKt {
    ...
    private static final byte m794takeHighestOneBit7apg3OU(byte b) {
        return UByte.m544constructorimpl((byte) Integer.highestOneBit(b & 255));
    }
    ...
    private static final byte m798takeLowestOneBit7apg3OU(byte b) {
        return UByte.m544constructorimpl((byte) Integer.lowestOneBit(b & 255));
    }
    ...
    private static final byte m787rotateLeftLxnNnR4(byte b, int i) {
        return UByte.m544constructorimpl(NumbersKt.rotateLeft(b, i));
    }
    ...
    private static final byte m791rotateRightLxnNnR4(byte b, int i) {
        return UByte.m544constructorimpl(NumbersKt.rotateRight(b, i));
    }
