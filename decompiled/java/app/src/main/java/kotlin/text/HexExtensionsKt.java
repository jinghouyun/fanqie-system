...
public final class HexExtensionsKt {
    ...
    private static final String toHexStringSlowPath(byte[] bArr, int i, int i2, HexFormat.BytesHexFormat bytesHexFormat, int[] iArr) {
        ...
        while (i6 < i2) {
            ...
            int byteAt2 = formatByteAt(bArr, i6, str2, byteSuffix, iArr, cArr, charArrayIfNotEmpty);
            i6++;
            i8 = i4 + 1;
            charArrayIfNotEmpty = byteAt2;
            bytePrefix = str2;
            i7 = i3 + 1;
        }
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m748toStringimpl(ULong.m702constructorimpl(j))));
    }
