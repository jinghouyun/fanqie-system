...
public final class UStringsKt {
    ...
    public static final String m1918toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1920toStringolVBNx4(short s, int i) {
    ...
    public static final String m1919toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT, CharsKt.checkRadix(i2));
    }

    /* JADX INFO: renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1917toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m623constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m538boximpl(UByte.m544constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m623constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM623constructorimpl = UInt.m623constructorimpl(i);
        int iM$3 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$3 ^ Integer.MIN_VALUE) > 0) {
                if (iM$3 == 119304647) {
                    iM$3 = UByte$$ExternalSyntheticBackport0.m$3(-1, iM623constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$3 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM623constructorimpl2 = UInt.m623constructorimpl(i3 * iM623constructorimpl);
            int iM623constructorimpl3 = UInt.m623constructorimpl(UInt.m623constructorimpl(iDigitOf) + iM623constructorimpl2);
            if (Integer.compare(iM623constructorimpl3 ^ Integer.MIN_VALUE, iM623constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM623constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM702constructorimpl = ULong.m702constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$4 ^ Long.MIN_VALUE) > 0) {
                if (jM$4 == 512409557603043100L) {
                    jM$4 = UByte$$ExternalSyntheticBackport0.m$4(-1L, jM702constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$4 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM702constructorimpl2 = ULong.m702constructorimpl(j * jM702constructorimpl);
            long jM702constructorimpl3 = ULong.m702constructorimpl(ULong.m702constructorimpl(((long) UInt.m623constructorimpl(iDigitOf)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + jM702constructorimpl2);
            if (Long.compare(jM702constructorimpl3 ^ Long.MIN_VALUE, jM702constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM702constructorimpl3;
        }
