...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(g4$$ExternalSyntheticApiModelOutline0.m455m(obj2), g4$$ExternalSyntheticApiModelOutline0.m455m(obj3), (Exception) obj4);
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            StreamsKt$$ExternalSyntheticApiModelOutline0.m1880m();
            throw StreamsKt$$ExternalSyntheticApiModelOutline0.m1862m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    g4$$ExternalSyntheticApiModelOutline0.m$5();
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function4, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                ...
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, g4$$ExternalSyntheticApiModelOutline0.m455m(objLast));
            }
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        FileSystemException fileSystemExceptionM = g4$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
        ...
        if (fileName != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    ...
                    if (g4$$ExternalSyntheticApiModelOutline0.m464m((Object) directoryStreamM)) {
                        exceptionsCollector.setPath(parent);
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(g4$$ExternalSyntheticApiModelOutline0.m457m((Object) directoryStreamM), fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (secureDirectoryStreamNewDirectoryStream != null) {
            ...
            try {
                SecureDirectoryStream secureDirectoryStreamM457m = g4$$ExternalSyntheticApiModelOutline0.m457m((Object) secureDirectoryStream2);
                Iterator it = secureDirectoryStreamM457m.iterator();
                Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
                while (it.hasNext()) {
                    Path fileName = g4$$ExternalSyntheticApiModelOutline0.m455m(it.next()).getFileName();
                    Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                    handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM457m, fileName, exceptionsCollector.getPath(), exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(g4$$ExternalSyntheticApiModelOutline0.m459m((Object) secureDirectoryStream.getFileAttributeView(path, g4$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (directoryStreamNewDirectoryStream != null) {
            ...
            try {
                ...
                Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
                while (it.hasNext()) {
                    Path pathM455m = g4$$ExternalSyntheticApiModelOutline0.m455m(it.next());
                    Intrinsics.checkNotNull(pathM455m);
                    insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM455m, path, exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
                CloseableKt.closeFinally(directoryStream, null);
            } catch (Throwable th) {
