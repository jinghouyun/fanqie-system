...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo1820getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = mo1820getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo1820getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo1820getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = mo1820getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor2 = typeConstructor.mo1820getDeclarationDescriptor();
        if (classifierDescriptorMo1820getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo1820getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo1820getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo1820getDeclarationDescriptor2);
        }
        return false;
    }
