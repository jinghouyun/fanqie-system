...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ...
        if (classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(classifierDescriptorMo1820getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) classifierDescriptorMo1820getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor2 = kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo1820getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo1820getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo1820getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo1820getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo1820getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters$lambda$13(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = it.getConstructor().mo1820getDeclarationDescriptor();
        if (classifierDescriptorMo1820getDeclarationDescriptor != null) {
            return isTypeAliasParameter(classifierDescriptorMo1820getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean requiresTypeAliasExpansion$lambda$16(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = it.getConstructor().mo1820getDeclarationDescriptor();
        if (classifierDescriptorMo1820getDeclarationDescriptor != null) {
            return (classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeAliasDescriptor) || (classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor);
        }
        return false;
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo1820getDeclarationDescriptor();
            ClassDescriptor classDescriptor = classifierDescriptorMo1820getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1820getDeclarationDescriptor : null;
