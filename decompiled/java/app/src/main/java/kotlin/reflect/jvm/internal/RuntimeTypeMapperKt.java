...
public final class RuntimeTypeMapperKt {
    ...
    public static final String getSignature(Method method) {
        ...
        sb.append(ArraysKt.joinToString$default(parameterTypes, "", Operators.BRACKET_START_STR, Operators.BRACKET_END_STR, 0, (CharSequence) null, new Function1() { // from class: kotlin.reflect.jvm.internal.RuntimeTypeMapperKt$$Lambda$0
