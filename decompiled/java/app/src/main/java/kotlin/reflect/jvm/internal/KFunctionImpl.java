...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public static final Caller caller_delegate$lambda$4(KFunctionImpl kFunctionImpl) {
        ...
        if (constructorFindMethodBySignature instanceof Constructor) {
            ...
            } else if (kFunctionImpl.getDescriptor().getAnnotations().mo1811findAnnotation(UtilKt.getJVM_STATIC()) != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:47:0x0195  */
    public static final Caller defaultCaller_delegate$lambda$10(KFunctionImpl kFunctionImpl) {
        ...
        if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
            ...
            if (functionWithDefaultParametersForValueClassOverride != null) {
                ...
                Member memberMo1808getMember = kFunctionImpl.getCaller().mo1808getMember();
                Intrinsics.checkNotNull(memberMo1808getMember);
                constructorFindDefaultConstructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(memberMo1808getMember.getModifiers()));
            }
    ...
    private final FunctionDescriptor getFunctionWithDefaultParametersForValueClassOverride(FunctionDescriptor descriptor) {
        ...
        if ((list2 instanceof Collection) && list2.isEmpty()) {
            ...
            if (InlineClassesUtilsKt.isValueClass(containingDeclaration)) {
                memberMo1808getMember = getCaller().mo1808getMember();
                Intrinsics.checkNotNull(memberMo1808getMember);
                if (Modifier.isStatic(memberMo1808getMember.getModifiers())) {
