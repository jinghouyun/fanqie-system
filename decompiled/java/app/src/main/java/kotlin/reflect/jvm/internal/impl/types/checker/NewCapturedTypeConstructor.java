...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo1821getSupertypes() {
    ...
    public static final List refine$lambda$6$lambda$5(NewCapturedTypeConstructor newCapturedTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
        List<UnwrappedType> listMo1821getSupertypes = newCapturedTypeConstructor.mo1821getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo1821getSupertypes, 10));
        Iterator<T> it = listMo1821getSupertypes.iterator();
        while (it.hasNext()) {
