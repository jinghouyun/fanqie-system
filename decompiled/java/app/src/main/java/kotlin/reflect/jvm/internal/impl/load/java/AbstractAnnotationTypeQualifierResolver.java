...
public abstract class AbstractAnnotationTypeQualifierResolver<TAnnotation> {
    ...
    */
    private final NullabilityQualifierWithMigrationStatus knownNullability(TAnnotation tannotation, boolean z) {
        ...
        ReportLevel reportLevelInvoke2 = this.javaTypeEnhancementState.getGetReportLevelForAnnotation().invoke2(fqName);
        if (reportLevelInvoke2.isIgnore()) {
            return null;
        }
        ...
        return new NullabilityQualifierWithMigrationStatus(nullabilityQualifier, reportLevelInvoke2.isWarning() || z);
    }
