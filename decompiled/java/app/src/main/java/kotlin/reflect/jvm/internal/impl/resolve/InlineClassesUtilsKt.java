...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1820getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo1820getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        if (classifierDescriptorMo1820getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo1820getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        return (classifierDescriptorMo1820getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo1820getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
