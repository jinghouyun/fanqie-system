    ...
    public static final boolean isAccessible(KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KFunction) {
            ...
            if (javaMethod3 != null ? javaMethod3.isAccessible() : true) {
                ...
                Member memberMo1808getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo1808getMember();
                AccessibleObject accessibleObject = memberMo1808getMember instanceof AccessibleObject ? (AccessibleObject) memberMo1808getMember : null;
