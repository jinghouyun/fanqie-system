...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1822getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo1822getContributedClassifier = this.javaScope.mo1822getContributedClassifier(name, location);
        if (classDescriptorMo1822getContributedClassifier != null) {
            return classDescriptorMo1822getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1822getContributedClassifier(name, location);
