...
public final class ReadUtilsKt {
    ...
    public static final KmAnnotationArgument readAnnotationArgument(ProtoBuf.Annotation.Argument.Value value, NameResolver strings) {
        ...
        if (Flags.IS_UNSIGNED.get(value.getFlags()).booleanValue()) {
            ...
            if (i == 1) {
                return new KmAnnotationArgument.UByteValue(UByte.m544constructorimpl((byte) value.getIntValue()), null);
            }
            if (i == 2) {
                return new KmAnnotationArgument.UShortValue(UShort.m809constructorimpl((short) value.getIntValue()), null);
            }
            if (i == 3) {
                return new KmAnnotationArgument.UIntValue(UInt.m623constructorimpl((int) value.getIntValue()), null);
            }
            if (i == 4) {
                return new KmAnnotationArgument.ULongValue(ULong.m702constructorimpl(value.getIntValue()), null);
            }
