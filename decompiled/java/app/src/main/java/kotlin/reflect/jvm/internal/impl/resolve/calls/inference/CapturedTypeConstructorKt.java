...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            public TypeProjection mo1825get(KotlinType key) {
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection typeProjectionMo1825get = super.mo1825get(key);
                if (typeProjectionMo1825get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = key.getConstructor().mo1820getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo1825get, classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo1820getDeclarationDescriptor : null);
            }
        };
    }
