...
public final class SignatureBuildingComponents {
    ...
    public final String jvmDescriptor(String name, List<String> parameters, String ret) {
        ...
        return name + Operators.BRACKET_START + CollectionsKt.joinToString$default(parameters, "", null, null, 0, null, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.SignatureBuildingComponents$$Lambda$0
