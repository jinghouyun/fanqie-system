...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = moduleDescriptor.getPackage(topLevelClassFqName.parent()).getMemberScope().mo1822getContributedClassifier(topLevelClassFqName.shortName(), location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo1821getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo1820getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo1820getDeclarationDescriptor();
