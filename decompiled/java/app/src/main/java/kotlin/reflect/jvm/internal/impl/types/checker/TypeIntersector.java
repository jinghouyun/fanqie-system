    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo1821getSupertypes = simpleType.getConstructor().mo1821getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1821getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo1821getSupertypes;
