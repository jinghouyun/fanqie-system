...
public final class ValueClassAwareCallerKt {
    ...
    private static final List<String> getMfvcUnboxMethods$getUnboxMethodNameSuffixes(SimpleType simpleType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = simpleType.getConstructor().mo1820getDeclarationDescriptor();
        ...
        MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) classifierDescriptorMo1820getDeclarationDescriptor);
    ...
    public static final List<Method> getMfvcUnboxMethods(SimpleType type) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = type.getConstructor().mo1820getDeclarationDescriptor();
        Intrinsics.checkNotNull(classifierDescriptorMo1820getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        ...
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo1820getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
