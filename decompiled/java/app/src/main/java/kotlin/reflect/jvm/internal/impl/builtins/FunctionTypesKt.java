...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1820getDeclarationDescriptor != null) {
            return getFunctionTypeKind(classifierDescriptorMo1820getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        return classifierDescriptorMo1820getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo1820getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo1811findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo1811findAnnotation = kotlinType.getAnnotations().mo1811findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo1811findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo1811findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo1811findAnnotation = kotlinType.getAnnotations().mo1811findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo1811findAnnotation == null) {
            return null;
        }
        Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo1811findAnnotation.getAllValueArguments().values());
