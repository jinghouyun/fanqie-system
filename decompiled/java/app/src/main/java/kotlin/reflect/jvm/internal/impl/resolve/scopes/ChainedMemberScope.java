...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1822getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor classifierDescriptorMo1822getContributedClassifier = memberScope.mo1822getContributedClassifier(name, location);
            if (classifierDescriptorMo1822getContributedClassifier != null) {
                if (!(classifierDescriptorMo1822getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) classifierDescriptorMo1822getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo1822getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = classifierDescriptorMo1822getContributedClassifier;
                }
            }
        }
    ...
    public void mo1826recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo1826recordLookup(name, location);
        }
    }
