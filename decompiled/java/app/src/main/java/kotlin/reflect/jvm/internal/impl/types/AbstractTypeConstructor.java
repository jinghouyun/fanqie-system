...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    public List<KotlinType> mo1821getSupertypes() {
    ...
    final class ModuleViewTypeConstructor implements TypeConstructor {
        ...
        public static final List refinedSupertypes_delegate$lambda$0(ModuleViewTypeConstructor moduleViewTypeConstructor, AbstractTypeConstructor abstractTypeConstructor) {
            return KotlinTypeRefinerKt.refineTypes(moduleViewTypeConstructor.kotlinTypeRefiner, abstractTypeConstructor.mo1821getSupertypes());
        }
        ...
        public ClassifierDescriptor mo1820getDeclarationDescriptor() {
            return this.this$0.mo1820getDeclarationDescriptor();
        }
    ...
    private final Collection<KotlinType> computeNeighbours(TypeConstructor typeConstructor, boolean z) {
        ...
        Collection<KotlinType> collectionMo1821getSupertypes = typeConstructor.mo1821getSupertypes();
