    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1821getSupertypes = capturedTypeConstructorImpl.mo1821getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1821getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1821getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1821getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1821getSupertypes2, 10));
            Iterator<T> it2 = collectionMo1821getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1821getSupertypes3 = intersectionTypeConstructor.mo1821getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1821getSupertypes3, 10));
        Iterator<T> it3 = collectionMo1821getSupertypes3.iterator();
        while (it3.hasNext()) {
