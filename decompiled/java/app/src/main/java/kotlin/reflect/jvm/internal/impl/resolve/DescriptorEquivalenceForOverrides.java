...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = c1.mo1820getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor2 = c2.mo1820getDeclarationDescriptor();
        if ((classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo1820getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo1820getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo1820getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3
