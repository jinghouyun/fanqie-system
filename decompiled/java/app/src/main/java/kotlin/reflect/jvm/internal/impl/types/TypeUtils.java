...
public class TypeUtils {
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> collectionMo1821getSupertypes = kotlinType.getConstructor().mo1821getSupertypes();
        ArrayList arrayList = new ArrayList(collectionMo1821getSupertypes.size());
        Iterator<KotlinType> it = collectionMo1821getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo1821getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1820getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static ClassDescriptor getClassDescriptor(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1820getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) classifierDescriptorMo1820getDeclarationDescriptor;
        }
        return null;
    }
    ...
    private static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        if (noExpectedType(kotlinType)) {
            return function1.invoke2(unwrappedTypeUnwrap).booleanValue();
        }
        if (smartSet != null && smartSet.contains(kotlinType)) {
            return false;
        }
        if (function1.invoke2(unwrappedTypeUnwrap).booleanValue()) {
            return true;
        }
        if (smartSet == null) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo1821getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1820getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo1820getDeclarationDescriptor();
        }
        return null;
    }
}
