...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo1821getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = typeConstructor.mo1820getDeclarationDescriptor(); classifierDescriptorMo1820getDeclarationDescriptor != null; classifierDescriptorMo1820getDeclarationDescriptor = classifierDescriptorMo1820getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo1820getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo1820getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
        return sb.toString();
    }
