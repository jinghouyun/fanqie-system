...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo1822getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo1826recordLookup(Name name, LookupLocation lookupLocation);
