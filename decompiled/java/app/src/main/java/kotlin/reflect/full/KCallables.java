...
public final class KCallables {
    ...
    /* JADX INFO: compiled from: KCallables.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    static final class C01191<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    public static final <R> Object callSuspendBy(KCallable<? extends R> kCallable, Map<KParameter, ? extends Object> map, Continuation<? super R> continuation) throws IllegalCallableAccessException {
        ...
        Object objCallDefaultMethod$kotlin_reflection = c01191.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01191.label;
        if (i == 0) {
            ...
            c01191.L$0 = kCallable;
            c01191.L$1 = map;
            c01191.L$2 = kCallableImplAsKCallableImpl;
            c01191.label = 1;
            C01191 c01192 = c01191;
            objCallDefaultMethod$kotlin_reflection = kCallableImplAsKCallableImpl.callDefaultMethod$kotlin_reflection(map, c01192);
            if (objCallDefaultMethod$kotlin_reflection == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(c01192);
            }
            ...
            kCallable = (KCallable) c01191.L$0;
            ResultKt.throwOnFailure(objCallDefaultMethod$kotlin_reflection);
        }
        KFunction kFunction = (KFunction) kCallable;
