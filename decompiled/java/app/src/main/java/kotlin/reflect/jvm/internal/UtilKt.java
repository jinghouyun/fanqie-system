...
public final class UtilKt {
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof KClassValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1820getDeclarationDescriptor();
    ...
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = type2.getConstructor().mo1820getDeclarationDescriptor();
                ClassDescriptor classDescriptor = classifierDescriptorMo1820getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1820getDeclarationDescriptor : null;
                if (classDescriptor == null) {
