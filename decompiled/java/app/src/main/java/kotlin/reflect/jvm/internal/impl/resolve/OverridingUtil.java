...
public class OverridingUtil {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case LocationRequestCompat.QUALITY_LOW_POWER /* 104 */:
                objArr[0] = Constants.Name.STRATEGY;
                break;
    ...
    public static <H> H selectMostSpecificMember(Collection<H> collection, Function1<H, CallableDescriptor> function1) {
        ...
        do {
            ...
            h = (H) it.next();
        } while (FlexibleTypesKt.isFlexible(function1.invoke2(h).getReturnType()));
        if (h != null) {
            if (h == null) {
                $$$reportNull$$$0(81);
            }
