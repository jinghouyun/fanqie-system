...
public final class FindClassInModuleKt {
    ...
    public static final ClassifierDescriptor findClassifierAcrossModuleDependencies(ModuleDescriptor moduleDescriptor, ClassId classId) {
        ...
        if (resolutionAnchorIfAny == null) {
            ...
            ClassDescriptor contributedClassifier = packageViewDescriptor.getMemberScope().mo1822getContributedClassifier((Name) CollectionsKt.first((List) listPathSegments), NoLookupLocation.FROM_DESERIALIZATION);
            ...
            for (Name name : listPathSegments.subList(1, listPathSegments.size())) {
                ...
                ClassifierDescriptor contributedClassifier2 = ((ClassDescriptor) contributedClassifier).getUnsubstitutedInnerClassesScope().mo1822getContributedClassifier(name, NoLookupLocation.FROM_DESERIALIZATION);
        ...
        ClassDescriptor contributedClassifier3 = packageViewDescriptor2.getMemberScope().mo1822getContributedClassifier((Name) CollectionsKt.first((List) listPathSegments2), NoLookupLocation.FROM_DESERIALIZATION);
        ...
        for (Name name2 : listPathSegments2.subList(1, listPathSegments2.size())) {
            if (contributedClassifier3 instanceof ClassDescriptor) {
                ClassifierDescriptor contributedClassifier4 = ((ClassDescriptor) contributedClassifier3).getUnsubstitutedInnerClassesScope().mo1822getContributedClassifier(name2, NoLookupLocation.FROM_DESERIALIZATION);
        ...
        ClassDescriptor contributedClassifier5 = packageViewDescriptor3.getMemberScope().mo1822getContributedClassifier((Name) CollectionsKt.first((List) listPathSegments3), NoLookupLocation.FROM_DESERIALIZATION);
        ...
        for (Name name3 : listPathSegments3.subList(1, listPathSegments3.size())) {
            ...
            ClassifierDescriptor contributedClassifier6 = ((ClassDescriptor) contributedClassifier5).getUnsubstitutedInnerClassesScope().mo1822getContributedClassifier(name3, NoLookupLocation.FROM_DESERIALIZATION);
