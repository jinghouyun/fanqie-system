...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = getConstructor().mo1820getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo1820getDeclarationDescriptor()).toString());
        }
