...
public final class ValueClassAwareCaller<M extends Member> implements Caller<M> {
    ...
    public ValueClassAwareCaller(CallableMemberDescriptor descriptor, Caller<? extends M> oldCaller, boolean z) {
                        ...
                        while (true) {
                            if (it2.hasNext()) {
                                if (((ValueParameterDescriptor) it2.next()).declaresDefaultValue()) {
                                    ...
                                    oldCaller = new CallerImpl.Method.BoundStaticMultiFieldValueClass(((CallerImpl.Method) oldCaller).mo1808getMember(), arrayList.toArray(new Object[0]));
                                }
                            }
                        }
                    }
        ...
        this.member = (M) oldCaller.mo1808getMember();
        ...
        if (InlineClassesUtilsKt.isGetterOfUnderlyingPropertyOfValueClass(descriptor)) {
            ...
            List listMakeKotlinParameterTypes = ValueClassAwareCallerKt.makeKotlinParameterTypes(descriptor, this.caller.mo1808getMember(), new Function1() { // from class: kotlin.reflect.jvm.internal.calls.ValueClassAwareCaller$$Lambda$0
    ...
    public static final class MultiFieldValueClassPrimaryConstructorCaller implements Caller {
        ...
        public MultiFieldValueClassPrimaryConstructorCaller(FunctionDescriptor descriptor, KDeclarationContainerImpl container, String constructorDesc, List<? extends ParameterDescriptor> originalParameters) {
            ...
            for (Object obj : list) {
                ...
                ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = ((ParameterDescriptor) obj).getType().getConstructor().mo1820getDeclarationDescriptor();
        ...
        @Override // kotlin.reflect.jvm.internal.calls.Caller
        /* JADX INFO: renamed from: getMember */
        public /* bridge */ /* synthetic */ Member mo1808getMember() {
        ...
        public Object call(Object[] args) throws IllegalAccessException, InvocationTargetException {
            ...
            for (Pair pair : listZip) {
                ...
                if (list != null) {
                    ...
                    while (it.hasNext()) {
                        arrayList2.add(((Method) it.next()).invoke(objComponent1, null));
                    }
