...
public final class JvmProtoBuf {
    ...
    public static final GeneratedMessageLite.GeneratedExtension<ProtoBuf.Function, Integer> lambdaClassOriginName = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Function.getDefaultInstance(), 0, null, null, PickerConfig.PICKER_IMAGE_VIDEO, WireFormat.FieldType.INT32, Integer.class);
    ...
    public static final GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, Integer> flags = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Property.getDefaultInstance(), 0, null, null, PickerConfig.PICKER_IMAGE_VIDEO, WireFormat.FieldType.INT32, Integer.class);
    ...
    public static final GeneratedMessageLite.GeneratedExtension<ProtoBuf.Type, Boolean> isRaw = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Type.getDefaultInstance(), false, null, null, PickerConfig.PICKER_IMAGE_VIDEO, WireFormat.FieldType.BOOL, Boolean.class);
    ...
    public static final GeneratedMessageLite.GeneratedExtension<ProtoBuf.Class, Integer> classModuleName = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Class.getDefaultInstance(), 0, null, null, PickerConfig.PICKER_IMAGE_VIDEO, WireFormat.FieldType.INT32, Integer.class);
    ...
    public static final GeneratedMessageLite.GeneratedExtension<ProtoBuf.Package, Integer> packageModuleName = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Package.getDefaultInstance(), 0, null, null, PickerConfig.PICKER_IMAGE_VIDEO, WireFormat.FieldType.INT32, Integer.class);
