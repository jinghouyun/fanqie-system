...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo1820getDeclarationDescriptor() {
                return this.this$0;
            }
            ...
            public Collection<KotlinType> mo1821getSupertypes() {
                Collection<KotlinType> collectionMo1821getSupertypes = mo1820getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1821getSupertypes();
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1820getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo1820getDeclarationDescriptor().getName().asString() + Operators.ARRAY_END;
            }
    ...
    public static final Boolean isInner$lambda$2(AbstractTypeAliasDescriptor abstractTypeAliasDescriptor, UnwrappedType unwrappedType) {
        ...
        if (KotlinTypeKt.isError(unwrappedType)) {
            ...
            if (!(classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor) || Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo1820getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                z = false;
            } else {
                z = true;
            }
