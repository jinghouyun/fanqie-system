...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public String renderType(KotlinType type) {
        ...
        renderNormalizedType(sb, getTypeNormalizer().invoke2(type));
        return sb.toString();
    }
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1820getDeclarationDescriptor = typeConstructor.mo1820getDeclarationDescriptor();
        if ((classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeParameterDescriptor) || (classifierDescriptorMo1820getDeclarationDescriptor instanceof ClassDescriptor) || (classifierDescriptorMo1820getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(classifierDescriptorMo1820getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo1820getDeclarationDescriptor.getClass()).toString());
    }
    ...
    private final void renderAnnotations(StringBuilder sb, Annotated annotated, AnnotationUseSiteTarget annotationUseSiteTarget) {
        if (getModifiers().contains(DescriptorRendererModifier.ANNOTATIONS)) {
            ...
            for (AnnotationDescriptor annotationDescriptor : annotated.getAnnotations()) {
                if (!CollectionsKt.contains(excludedTypeAnnotationClasses, annotationDescriptor.getFqName()) && !isParameterName(annotationDescriptor) && (annotationFilter == null || annotationFilter.invoke2(annotationDescriptor).booleanValue())) {
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || !listRenderAndSortAnnotationArguments.isEmpty()) {
                CollectionsKt.joinTo(listRenderAndSortAnnotationArguments, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : Operators.BRACKET_START_STR, (112 & 8) != 0 ? "" : Operators.BRACKET_END_STR, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1820getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor = annotationClass.mo1810getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    private final String renderConstant(ConstantValue<?> constantValue) {
        ...
        if (propertyConstantRenderer != null) {
            return propertyConstantRenderer.invoke2(constantValue);
        }
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", Operators.BLOCK_START_STR, Operators.BLOCK_END_STR, 0, null, null, 56, null);
    }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo1810getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor.getValueParameters();
            ...
            if (!arrayList2.isEmpty()) {
                ...
                sb.append(CollectionsKt.joinToString$default(arrayList2, ", ", Operators.BRACKET_START_STR, Operators.BRACKET_END_STR, 0, null, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$3
                    @Override // kotlin.jvm.functions.Function1
                    /* JADX INFO: renamed from: invoke */
    ...
    public final void renderValueParameter(ValueParameterDescriptor valueParameterDescriptor, boolean z, StringBuilder sb, boolean z2) {
        ...
        if (getDefaultParameterValueRenderer() != null) {
            if (getDebugMode() ? valueParameterDescriptor.declaresDefaultValue() : DescriptorUtilsKt.declaresOrInheritsDefaultValue(valueParameterDescriptor)) {
                ...
                sb2.append(defaultParameterValueRenderer.invoke2(valueParameterDescriptor));
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1812getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo1812getCompileTimeInitializer = variableDescriptor.mo1812getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo1812getCompileTimeInitializer)) == null) {
            return;
        }
        sb.append(" = ");
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor = classDescriptor.mo1810getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(Operators.SPACE_STR);
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo1810getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo1821getSupertypes = classDescriptor.getTypeConstructor().mo1821getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1821getSupertypes, "getSupertypes(...)");
        if (collectionMo1821getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1821getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1821getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(collectionMo1821getSupertypes, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$4
            private final DescriptorRendererImpl arg$0;
