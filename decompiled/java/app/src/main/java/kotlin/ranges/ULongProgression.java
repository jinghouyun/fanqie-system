...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1742getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM702constructorimpl = ((int) ULong.m702constructorimpl(j ^ ULong.m702constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM702constructorimpl2 = (iM702constructorimpl + ((int) ULong.m702constructorimpl(j2 ^ ULong.m702constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM702constructorimpl2 + ((int) (j3 ^ (j3 >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m748toStringimpl(this.first));
            sb.append(PdrUtil.FILE_PATH_ENTRY_BACK);
            sb.append((Object) ULong.m748toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1770fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
