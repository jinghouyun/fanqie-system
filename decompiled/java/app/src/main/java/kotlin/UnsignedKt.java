...
public final class UnsignedKt {
    ...
    public static final int m880uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m623constructorimpl((int) ((((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT) % (((long) i2) & InternalZipConstants.ZIP_64_SIZE_LIMIT)));
    }
    ...
    public static final long m881ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m702constructorimpl(0L) : ULong.m702constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m702constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m702constructorimpl(j3 + ((long) (Long.compare(ULong.m702constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m702constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }
    ...
    public static final long m882ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m702constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m702constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m702constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m702constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.m623constructorimpl(UInt.m623constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m623constructorimpl(Integer.MAX_VALUE));
    }
    ...
    private static final String uintToString(int i, int i2) {
        return ulongToString(((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT, i2);
    }
