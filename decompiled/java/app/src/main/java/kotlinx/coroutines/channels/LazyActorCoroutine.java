...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> {
    ...
    public Object mo2084trySendJP2dKIU(E element) {
        start();
        return super.mo2084trySendJP2dKIU(element);
    }
