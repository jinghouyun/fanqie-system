...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2112trySendImplMj0NB7M = conflatedBufferedChannel.m2112trySendImplMj0NB7M(e, true);
        if (objM2112trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2099exceptionOrNullimpl(objM2112trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2112trySendImplMj0NB7M = conflatedBufferedChannel.m2112trySendImplMj0NB7M(e, true);
        if (!(objM2112trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2084trySendJP2dKIU(E element) {
        return m2112trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2112trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2111trySendDropLatestMj0NB7M(element, isSendOp) : m2090trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2111trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2084trySendJP2dKIU = super.mo2084trySendJP2dKIU(element);
        if (ChannelResult.m2105isSuccessimpl(objMo2084trySendJP2dKIU) || ChannelResult.m2103isClosedimpl(objMo2084trySendJP2dKIU)) {
            return objMo2084trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2084trySendJP2dKIU = mo2084trySendJP2dKIU(element);
        if (!(objMo2084trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2084trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2099exceptionOrNullimpl(objMo2084trySendJP2dKIU);
