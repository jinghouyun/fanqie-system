    ...
    */
    public static final Object fixedPeriodTicker(long j, long j2, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) {
        ...
        if (i == 0) {
            ...
            c01821.L$0 = sendChannel2;
            j3 = j;
            c01821.J$0 = j3;
            c01821.J$1 = jNanoTime2;
            c01821.label = 1;
            if (DelayKt.delay(j2, c01821) != coroutine_suspended) {
                j4 = jNanoTime2;
            }
        ...
        if (i == 1) {
            j4 = c01821.J$1;
            long j8 = c01821.J$0;
            SendChannel sendChannel4 = (SendChannel) c01821.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (i == 2) {
                j6 = c01821.J$1;
                j5 = c01821.J$0;
                sendChannel3 = (SendChannel) c01821.L$0;
                ResultKt.throwOnFailure(obj);
                ...
                if (jCoerceAtLeast != 0 && j6 != 0) {
                    long j9 = j6 - ((jNanoTime - j5) % j6);
                    j5 = jNanoTime + j9;
                    long jDelayNanosToMillis = EventLoop_commonKt.delayNanosToMillis(j9);
                    c01821.L$0 = sendChannel3;
                    c01821.J$0 = j5;
                    c01821.J$1 = j6;
                    c01821.label = 3;
                } else {
        ...
        c01821.L$0 = sendChannel2;
        c01821.J$0 = j7;
        c01821.J$1 = jDelayToNanos;
        c01821.label = 2;
        if (sendChannel2.send(unit, c01821) != coroutine_suspended) {
