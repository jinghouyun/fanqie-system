...
public class MutexImpl extends SemaphoreImpl implements Mutex {
    ...
    public String toString() {
        return "Mutex@" + DebugStringsKt.getHexAddress(this) + "[isLocked=" + isLocked() + ",owner=" + owner$volatile$FU.get(this) + Operators.ARRAY_END;
    }
