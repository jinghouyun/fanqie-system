...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01913<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01921<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01971<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02011<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c01982 = new C01982<>(objectRef2, function3);
            c01971.L$0 = objectRef2;
            c01971.label = 1;
            if (flow.collect(c01982, c01971) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c01971.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    static final class C01982<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C01982(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) {
        ...
        if (i == 0) {
            ...
            c01921.L$0 = objectRef2;
            c01921.label = 1;
            if (flow.collect(anonymousClass2, c01921) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01921.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c01991.L$0 = objectRef2;
            c01991.label = 1;
            if (flow.collect(flowCollector, c01991) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01991.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c02011.L$0 = objectRef2;
                c02011.L$1 = flowCollector2;
                c02011.label = 1;
                if (flow.collect(flowCollector2, c02011) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c02011.L$1;
            objectRef = (Ref.ObjectRef) c02011.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c01901.L$0 = objectRef2;
                c01901.L$1 = flowCollector2;
                c01901.label = 1;
                if (flow.collect(flowCollector2, c01901) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c01901.L$1;
            objectRef = (Ref.ObjectRef) c01901.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C01913) {
            c01913 = (C01913) continuation;
            if ((c01913.label & Integer.MIN_VALUE) != 0) {
                c01913.label -= Integer.MIN_VALUE;
            } else {
                c01913 = new C01913(continuation);
            }
        } else {
            c01913 = new C01913(continuation);
        }
        Object obj = c01913.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01913.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c01913.L$0 = objectRef2;
                c01913.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c01913.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c01913) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c01913.L$1;
            objectRef = (Ref.ObjectRef) c01913.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c01931.L$0 = objectRef2;
            c01931.label = 1;
            if (flow.collect(flowCollector, c01931) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01931.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c01951.L$0 = objectRef2;
            c01951.label = 1;
            if (flow.collect(flowCollector, c01951) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01951.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
