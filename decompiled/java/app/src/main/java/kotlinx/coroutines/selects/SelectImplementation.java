...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C02041 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02041(SelectImplementation<R> selectImplementation, Continuation<? super C02041> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C02041 c02041;
        if (continuation instanceof C02041) {
            c02041 = (C02041) continuation;
            if ((c02041.label & Integer.MIN_VALUE) != 0) {
                c02041.label -= Integer.MIN_VALUE;
            } else {
                c02041 = new C02041(this, continuation);
            }
        } else {
            c02041 = new C02041(this, continuation);
        }
        Object obj2 = c02041.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02041.label;
        try {
            if (i != 0) {
            ...
            c02041.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c02041);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c02041 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c02041);
            }
            throw th;
        }
    }
    ...
    public final class ClauseData {
        ...
        public final Object invokeBlock(Object obj, Continuation<? super R> continuation) {
            ...
            if (this.param == SelectKt.getPARAM_CLAUSE_0()) {
                ...
                return ((Function1) obj2).invoke2(continuation);
            }
