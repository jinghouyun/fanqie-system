...
public interface SendChannel<E> {
    ...
    Object mo2084trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2105isSuccessimpl(objMo2084trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2099exceptionOrNullimpl = ChannelResult.m2099exceptionOrNullimpl(objMo2084trySendJP2dKIU);
