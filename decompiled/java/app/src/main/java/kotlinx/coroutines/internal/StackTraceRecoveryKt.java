...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM526constructorimpl = Result.m526constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m529exceptionOrNullimpl(objM526constructorimpl) == null) {
            obj2 = objM526constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM526constructorimpl2 = Result.m526constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM526constructorimpl2 = Result.m526constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m529exceptionOrNullimpl(objM526constructorimpl2) == null) {
            obj = objM526constructorimpl2;
        }
