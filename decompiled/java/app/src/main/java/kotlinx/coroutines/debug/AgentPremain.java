...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM526constructorimpl = Result.m526constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m532isFailureimpl(objM526constructorimpl) ? null : objM526constructorimpl);
