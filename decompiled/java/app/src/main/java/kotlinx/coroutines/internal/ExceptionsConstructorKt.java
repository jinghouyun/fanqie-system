...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM526constructorimpl = Result.m526constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM526constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM526constructorimpl = Result.m526constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m532isFailureimpl(objM526constructorimpl) ? null : objM526constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM526constructorimpl = Result.m526constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m532isFailureimpl(objM526constructorimpl)) {
            objM526constructorimpl = numValueOf;
        }
        return ((Number) objM526constructorimpl).intValue();
    }
