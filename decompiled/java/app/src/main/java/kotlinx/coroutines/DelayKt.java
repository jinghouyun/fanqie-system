...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2141scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2072delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2073toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2073toDelayMillisLRDsOJo(long j) {
        boolean zM1958isPositiveimpl = Duration.m1958isPositiveimpl(j);
        if (zM1958isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1942getInWholeMillisecondsimpl(Duration.m1960plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1958isPositiveimpl) {
