...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2088receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2088receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2089tryReceivePtdJZtk() {
        return this._channel.mo2089tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2084trySendJP2dKIU(E element) {
        return this._channel.mo2084trySendJP2dKIU(element);
    }
