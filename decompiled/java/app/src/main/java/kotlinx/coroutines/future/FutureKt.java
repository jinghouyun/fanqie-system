...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM1876m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1876m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM1876m);
        completableFutureM1876m.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1878m((Object) completableFutureCoroutine));
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM1876m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM1876m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1876m();
        setupCancellation(deferred, completableFutureM1876m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM1876m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM1876m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM1876m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM1876m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1876m();
        setupCancellation(job, completableFutureM1876m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM1876m.complete(Unit.INSTANCE);
                } else {
                    completableFutureM1876m.completeExceptionally(th);
                }
            }
        });
        return completableFutureM1876m;
            ...
            public final Object invoke(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM1877m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1883m((Object) th2) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m1877m((Object) th2) : null;
                        if (completionExceptionM1877m != null && (cause2 = completionExceptionM1877m.getCause()) != null) {
                            th2 = cause2;
                        }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1878m((Object) continuationHandler));
