...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m526constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM1877m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1883m((Object) exception) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m1877m((Object) exception) : null;
        if (completionExceptionM1877m != null && (cause = completionExceptionM1877m.getCause()) != null) {
            exception = cause;
        }
