...
public final class ProduceKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.ProduceKt", f = "Produce.kt", i = {0, 0}, l = {150}, m = "awaitClose", n = {"$this$awaitClose", AbsoluteConst.JSON_VALUE_BLOCK}, s = {"L$0", "L$1"})
            ...
            if (i == 0) {
                ...
                producerScope.invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1
                    ...
                    public final void invoke2(Throwable th) {
                        ...
                        cancellableContinuation.resumeWith(Result.m526constructorimpl(Unit.INSTANCE));
                    }
                });
