...
public interface ReceiveChannel<E> {
    ...
    Object mo2088receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2089tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2089tryReceivePtdJZtk = receiveChannel.mo2089tryReceivePtdJZtk();
            if (ChannelResult.m2105isSuccessimpl(objMo2089tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2101getOrThrowimpl(objMo2089tryReceivePtdJZtk);
            }
            Throwable thM2099exceptionOrNullimpl = ChannelResult.m2099exceptionOrNullimpl(objMo2089tryReceivePtdJZtk);
            if (thM2099exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2099exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            if (i == 0) {
                ...
                objMo2088receiveCatchingJP2dKIU = receiveChannel.mo2088receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2100getOrNullimpl(objMo2088receiveCatchingJP2dKIU);
        }
