...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM526constructorimpl = Result.m526constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th));
        }
        return (Function1) (Result.m532isFailureimpl(objM526constructorimpl) ? null : objM526constructorimpl);
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        return new Object[]{Operators.ARRAY_START_STR + CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null) + Operators.ARRAY_END, arrayList.toArray(new Thread[0]), arrayList2.toArray(new CoroutineStackFrame[0]), listDumpCoroutinesInfo.toArray(new DebugCoroutineInfo[0])};
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                Result.Companion companion = Result.INSTANCE;
                DebugProbesImpl debugProbesImpl = this;
                objM526constructorimpl = Result.m526constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM526constructorimpl = Result.m526constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m532isFailureimpl(objM526constructorimpl)) {
                objM526constructorimpl = null;
            }
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM526constructorimpl;
