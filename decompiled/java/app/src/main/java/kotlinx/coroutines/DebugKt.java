...
public final class DebugKt {
    ...
    static {
        ...
        if (strSystemProp == null) {
            ...
            if (iHashCode != 0) {
                ...
                throw new IllegalStateException(("System property 'kotlinx.coroutines.debug' has unrecognized value '" + strSystemProp + Operators.SINGLE_QUOTE).toString());
            }
        }
        DEBUG = z;
    ...
    private static final void m2071assert(Function0<Boolean> function0) {
