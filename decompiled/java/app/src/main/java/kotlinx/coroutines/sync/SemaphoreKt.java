...
public final class SemaphoreKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {IMgr.WindowEvent.OBTAIN_APP_TOP_PAGE_DIRECT}, m = "withPermit", n = {"$this$withPermit", "action"}, s = {"L$0", "L$1"})
