...
final /* synthetic */ class ChannelsKt__DeprecatedKt {
    ...
    public static final <E> java.lang.Object consumeEach(kotlinx.coroutines.channels.BroadcastChannel<E> r6, kotlin.jvm.functions.Function1<? super E, kotlin.Unit> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            ...
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$consumeEach$1 r0 = (kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt.C01451) r0
            int r1 = r0.label
    ...
    public static final /* synthetic */ Object first(ReceiveChannel receiveChannel, Continuation continuation) {
        ...
        if (i != 0) {
            ...
            channelIterator = (ChannelIterator) c01601.L$1;
            receiveChannel2 = (ReceiveChannel) c01601.L$0;
            try {
        ...
        try {
            ...
            c01601.L$0 = receiveChannel;
            c01601.L$1 = it;
            c01601.label = 1;
            Object objHasNext = it.hasNext(c01601);
    ...
    public static final /* synthetic */ Object firstOrNull(ReceiveChannel receiveChannel, Continuation continuation) {
        ...
        if (i == 0) {
            ...
            try {
                ChannelIterator it = receiveChannel.iterator();
                c01611.L$0 = receiveChannel;
                c01611.L$1 = it;
                c01611.label = 1;
                Object objHasNext = it.hasNext(c01611);
                if (objHasNext == coroutine_suspended) {
                    return coroutine_suspended;
                }
                receiveChannel2 = receiveChannel;
            ...
            channelIterator = (ChannelIterator) c01611.L$1;
            receiveChannel2 = (ReceiveChannel) c01611.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (Throwable th3) {
                th = th3;
    ...
    public static final /* synthetic */ Object single(ReceiveChannel receiveChannel, Continuation continuation) {
        ...
        if (i == 0) {
            ...
            try {
                ChannelIterator it = receiveChannel.iterator();
                c01731.L$0 = receiveChannel;
                c01731.L$1 = it;
                c01731.label = 1;
                Object objHasNext2 = it.hasNext(c01731);
                if (objHasNext2 != coroutine_suspended) {
                    ...
                    c01731.L$0 = receiveChannel2;
                    c01731.L$1 = next;
                    c01731.label = 2;
                    objHasNext = channelIterator.hasNext(c01731);
                    if (objHasNext != coroutine_suspended) {
                        obj2 = objHasNext;
                        obj = next;
        ...
        if (i != 1) {
            ...
            obj = c01731.L$1;
            receiveChannel3 = (ReceiveChannel) c01731.L$0;
            try {
                ResultKt.throwOnFailure(obj2);
                if (((Boolean) obj2).booleanValue()) {
                    throw new IllegalArgumentException("ReceiveChannel has more than one element.");
        ...
        channelIterator = (ChannelIterator) c01731.L$1;
        receiveChannel2 = (ReceiveChannel) c01731.L$0;
        try {
            ResultKt.throwOnFailure(obj2);
            if (((Boolean) obj2).booleanValue()) {
                throw new NoSuchElementException("ReceiveChannel is empty.");
    ...
    public static final /* synthetic */ Object singleOrNull(ReceiveChannel receiveChannel, Continuation continuation) {
        ...
        if (i == 0) {
            ...
            try {
                ChannelIterator it = receiveChannel.iterator();
                c01741.L$0 = receiveChannel;
                c01741.L$1 = it;
                c01741.label = 1;
                Object objHasNext = it.hasNext(c01741);
                if (objHasNext != coroutine_suspended) {
                    receiveChannel2 = receiveChannel;
                    channelIterator = it;
                    obj2 = objHasNext;
        ...
        if (i != 1) {
            ...
            obj = c01741.L$1;
            receiveChannel3 = (ReceiveChannel) c01741.L$0;
            try {
                ResultKt.throwOnFailure(obj2);
                if (((Boolean) obj2).booleanValue()) {
                    ChannelsKt.cancelConsumed(receiveChannel3, null);
        ...
        channelIterator = (ChannelIterator) c01741.L$1;
        receiveChannel2 = (ReceiveChannel) c01741.L$0;
        try {
            ResultKt.throwOnFailure(obj2);
        } catch (Throwable th5) {
            th = th5;
        ...
        if (((Boolean) obj2).booleanValue()) {
            Object next = channelIterator.next();
            c01741.L$0 = receiveChannel2;
            c01741.L$1 = next;
            c01741.label = 2;
            Object objHasNext2 = channelIterator.hasNext(c01741);
            if (objHasNext2 != coroutine_suspended) {
                obj2 = objHasNext2;
                obj = next;
                receiveChannel3 = receiveChannel2;
  ...
  0x0063: PHI (r10v9 java.lang.Object) = (r10v17 java.lang.Object), (r10v0 java.lang.Object) binds: [B:14:0x0060, B:11:0x0037] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    static final class C01561<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:16:0x006e A[PHI: r1 r6 r7 r12
  0x006e: PHI (r1v5 int) = (r1v9 int), (r1v10 int) binds: [B:14:0x006b, B:11:0x003b] A[DONT_GENERATE, DONT_INLINE]
  0x006e: PHI (r6v3 kotlinx.coroutines.channels.ChannelIterator<E>) = (r6v4 kotlinx.coroutines.channels.ChannelIterator<E>), (r6v6 kotlinx.coroutines.channels.ChannelIterator<E>) binds: [B:14:0x006b, B:11:0x003b] A[DONT_GENERATE, DONT_INLINE]
  0x006e: PHI (r7v4 ??) = (r7v14 ??), (r7v15 ??) binds: [B:14:0x006b, B:11:0x003b] A[DONT_GENERATE, DONT_INLINE]
  0x006e: PHI (r12v9 java.lang.Object) = (r12v17 java.lang.Object), (r12v0 java.lang.Object) binds: [B:14:0x006b, B:11:0x003b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final <E, C extends SendChannel<? super E>> Object toChannel(ReceiveChannel<? extends E> receiveChannel, C c, Continuation<? super C> continuation) {
        ...
        try {
            if (i != 0) {
                if (i == 1) {
                    channelIterator = (ChannelIterator) c01771.L$2;
                    boolean z = (C) ((ReceiveChannel) c01771.L$1);
                    SendChannel sendChannel = (SendChannel) c01771.L$0;
                    ResultKt.throwOnFailure(obj);
                    r2 = sendChannel;
                    c = z;
                    if (((Boolean) obj).booleanValue()) {
                ...
                channelIterator = (ChannelIterator) c01771.L$2;
                boolean z2 = (C) ((ReceiveChannel) c01771.L$1);
                SendChannel sendChannel2 = (SendChannel) c01771.L$0;
                ResultKt.throwOnFailure(obj);
                r3 = sendChannel2;
                r9 = z2;
                r3 = r2;
    ...
    public static final /* synthetic */ java.lang.Object maxWith(kotlinx.coroutines.channels.ReceiveChannel r8, java.util.Comparator r9, kotlin.coroutines.Continuation r10) {
        /*
            ...
            if (r0 == 0) goto L14
            r0 = r10
            kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$maxWith$1 r0 = (kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt.C01691) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public static final /* synthetic */ java.lang.Object minWith(kotlinx.coroutines.channels.ReceiveChannel r8, java.util.Comparator r9, kotlin.coroutines.Continuation r10) {
        /*
            boolean r0 = r10 instanceof kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt.C01701
            if (r0 == 0) goto L14
            r0 = r10
            kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$minWith$1 r0 = (kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt.C01701) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public static final /* synthetic */ Object none(ReceiveChannel receiveChannel, Continuation continuation) {
        ...
        Object objHasNext = c01711.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01711.label;
        try {
            if (i == 0) {
                ...
                receiveChannel = (ReceiveChannel) c01711.L$0;
                ResultKt.throwOnFailure(objHasNext);
            }
    ...
    static final class C01812<V> extends SuspendLambda implements Function2<ProducerScope<? super V>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01812(ReceiveChannel<? extends R> receiveChannel, ReceiveChannel<? extends E> receiveChannel2, Function2<? super E, ? super R, ? extends V> function2, Continuation<? super C01812> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01812 c01812 = new C01812(this.$other, this.$this_zip, this.$transform, continuation);
            c01812.L$0 = obj;
            return c01812;
        }
        ...
        public final Object invoke(ProducerScope<? super V> producerScope, Continuation<? super Unit> continuation) {
            return ((C01812) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r14) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt.C01812.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public static final <E, R, V> ReceiveChannel<V> zip(ReceiveChannel<? extends E> receiveChannel, ReceiveChannel<? extends R> receiveChannel2, CoroutineContext coroutineContext, Function2<? super E, ? super R, ? extends V> function2) {
        return ProduceKt.produce$default(GlobalScope.INSTANCE, coroutineContext, 0, null, ChannelsKt.consumesAll(receiveChannel, receiveChannel2), new C01812(receiveChannel2, receiveChannel, function2, null), 6, null);
    }
