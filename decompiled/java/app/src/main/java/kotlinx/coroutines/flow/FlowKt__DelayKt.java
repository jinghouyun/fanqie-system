...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2117debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2073toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            /* JADX INFO: renamed from: invoke */
            public final Long invoke2(T t) {
                return Long.valueOf(DelayKt.m2073toDelayMillisLRDsOJo(function1.invoke2(t).getRawValue()));
            }
        });
    }
    ...
    static final class C01842<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01842(long j, Flow<? extends T> flow, Continuation<? super C01842> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C01842 c01842 = new C01842(this.$periodMillis, this.$this_sample, continuation);
            c01842.L$0 = coroutineScope;
            c01842.L$1 = flowCollector;
            return c01842.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C01842(j, flow, null));
    }
 ...
 binds: [B:13:0x003f, B:19:0x0063, B:11:0x0022] A[DONT_GENERATE, DONT_INLINE]] */
  ...
  0x0056: PHI (r1v4 kotlinx.coroutines.channels.ProducerScope) = (r1v3 kotlinx.coroutines.channels.ProducerScope), (r1v8 kotlinx.coroutines.channels.ProducerScope) binds: [B:16:0x0053, B:10:0x001a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static final <T> Flow<T> m2118sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2073toDelayMillisLRDsOJo(j));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m2119timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2120timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m2120timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
